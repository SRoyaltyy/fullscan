...
Last learn_cycle: **2026-09-22**. Promoted: 1. Retired: 10. Active lessons: 203. Human digest: `03_scoreboard/LEARNINGS.md`.

## Accuracy by topic (graded window)

- **general**: 60% (9/15)
- **sector:Basic Materials**: 27% (4/15)
...
Last change: general.B3_FEDPATH: 0.5 -> 0.0 (n=29, hit=0.448); Basic Materials.S2_BREADTH: 1.0 -> 0.5 (n=13, hit=0.538); Healthcare.S4_ETF_TAPE: 1.25 -> 1.0 (n=14, hit=0.643); Industrials.S2_BREADTH: 0.5 -> 0.0 (n=16, hit=0.438); Real Estate.S4_ETF_TAPE: 0.5 -> 1.0 (n=16, hit=0.562); Utilities.S4_ETF_TAPE: 1.0 -> 1.25 (n=15, hit=0.667)
...
- **loss 2026-09-22:** [general] When score sign conflicts with sector ETF tape / breadth, cut conviction; prefer flat/mild.

### scope `news` — wins=0 losses=1
- **loss news:** [news] Only emit actions with |net| above a higher floor.

### scope `sector_basic_materials` — wins=4 losses=11
...
- **loss 2026-09-22:** [sector_basic_materials] When score sign conflicts with sector ETF tape / breadth, cut conviction; prefer flat/mild.
...
- **loss 2026-09-22:** [sector_communication_services] When score sign conflicts with sector ETF tape / breadth, cut conviction; prefer flat/mild.
...
- **loss 2026-09-22:** [sector_consumer_cyclical] When score sign conflicts with sector ETF tape / breadth, cut conviction; prefer flat/mild.
...
- **win 2026-09-22:** [sector_energy] Keep direction; shrink confidence on modest |score| when magnitude historically misses.
...
- **win 2026-09-22:** [sector_financial] Keep direction; shrink confidence on modest |score| when magnitude historically misses.
...
- **loss 2026-09-22:** [sector_healthcare] When score sign conflicts with sector ETF tape / breadth, cut conviction; prefer flat/mild.
...
- **loss 2026-09-22:** [sector_industrials] When score sign conflicts with sector ETF tape / breadth, cut conviction; prefer flat/mild.
...
- **win 2026-09-22:** [sector_real_estate] Keep direction; shrink confidence on modest |score| when magnitude historically misses.
...
- **loss 2026-09-22:** [sector_technology] When score sign conflicts with sector ETF tape / breadth, cut conviction; prefer flat/mild.
...
- **win 2026-09-22:** [sector_utilities] Keep direction; shrink confidence on modest |score| when magnitude historically misses.
...
- 2026-09-22: `a-mega-cap-duration-heavy-consumer-cyclical-etf-xly-like-amz.md` (sector:Consumer Cyclical) — topic hit 71% → 0% after activation; retired.
- 2026-09-22: `a-utilities-xlu-call-is-built-after-a-stretch-of-risk-on-gro.md` (sector:Utilities) — topic hit 80% → 14% after activation; retired.
- 2026-09-22: `a-sector-call-has-a-scheduled-8-30-et-macro-release-pending.md` (sector:Financial) — topic hit 75% → 14% after activation; retired.
- 2026-09-22: `in-a-utilities-xlu-call-a-second-soft-inflation-print-has-al.md` (sector:Utilities) — topic hit 75% → 14% after activation; retired.
- 2026-09-22: `a-consumer-cyclical-down-call-is-driven-by-a-genuinely-negat.md` (sector:Consumer Cyclical) — topic hit 86% → 29% after activation; retired.
- 2026-09-22: `when-the-pre-fetched-commodity-tape-conflicts-with-live-sour.md` (sector:Energy) — topic hit 71% → 14% after activation; retired.
- 2026-09-22: `a-sector-call-has-a-decisively-negative-fundamental-spine-fr.md` (sector:Consumer Cyclical) — topic hit 83% → 29% after activation; retired.
- 2026-09-22: `a-utility-defensive-sector-call-is-built-on-a-carried-defens.md` (sector:Utilities) — topic hit 67% → 14% after activation; retired.
- 2026-09-22: `sector-prediction-made-when-the-sector-s-dominant-commodity.md` (sector:Energy) — topic hit 67% → 14% after activation; retired.
- 2026-09-22: `a-sector-call-has-a-scheduled-8-30-et-high-impact-macro-rele.md` (sector:Financial) — topic hit 60% → 14% after activation; retired.
