...
**4. Breadth / leadership.** XLRE is a **relative laggard on every horizon** (1d rel −0.73%, 3d −2.92%, 1w −2.34%, 1m −6.06%). The sector is being sold on the hawkish Fed repricing. Data-center/senior-housing large-caps (EQIX/DLR/WELL) are not carrying the ETF today — the basket is lagging broadly. That is **sector-wide lag / large-cap inability to offset duration**, not breadth expansion. WELL cannot set the call.

**5. Flows / positioning.** XLRE has been in near-term outflow (5d/1m negative in prior runs) into a −6% 1m relative laggard. No same-day volume spike. Not a crowded long on 1m (still deeply lagging). Neutral-to-negative.

**6. Earnings / policy.** No fresh REIT print this morning. Dominant event is the **post-Warsh hawkish repricing** (already delivered Aug 28) plus **Jobs Week** ahead (NFP Friday). Oil/Hormuz is a live risk-off overlay. No 8:30 high-impact print today (Monday, Labor Day weekend context — actually today is a trading day).

### Self-audit
- Lens: duration/rates for a bond-proxy, not SPX beta.
- Band: factors net negative; **do not emit notable** off yesterday's −1.6% rel smash or off Warsh — but today the rate spine is genuinely negative (rising 10Y, hawkish repricing, oil up). The 08-17 lesson says a live long-end shock can justify down; but today's move is a repricing, not a fresh 30Y-at-19-year-high smash with ES −0.6%. Cap at mild.
- Skew: hawkish Warsh + oil-up + USD-up = one-way down for REITs, but magnitude should stay mild absent a fresh 08-18-style long-end shock.
- Same-shock: the rising-yield/hawkish-Fed theme is counted once as the spine negative, not again in S1 as a separate HIT.
- Single-ticker: EQIX/DLR/WELL are dispersion, not the ETF call.

### Divergence
Leading (S0+S1+S2+S3) = **negative**. Tape S4 = **negative** (every horizon a laggard). **No divergence** — factors and tape agree on down. Trust the convergence.

**Call implication for the pipeline:** Σ = −4 × 0.9 = **−3.6 → down / mild**. The rate spine is genuinely negative (rising 10Y, hawkish Warsh repricing, oil-up inflation overlay), and the tape confirms on every horizon. But magnitude stays mild — this is a repricing, not a fresh 08-18-style long-end shock with sharply negative futures. Confidence moderate.
...
HIT_GRID_BEGIN
Rates rising / REIT selloff|HIT|0.80|2026-08-31|Warsh hawkish Jackson Hole, Sep hike odds ~55-57%, 10Y rising to ~4.73%
Real yields rising|MISS|0.60|2026-08-31|DFII10 1d flat, 1w/1m slightly lower; nominal long-end rise dominates
Risk-off tape / flight to safety|HIT|0.60|2026-08-31|Oil up on Iran Hormuz terms, ES -0.45%, gold fading
USD strengthening|HIT|0.55|2026-08-31|DXY +0.27% 1d
Sector rotation out of real estate|HIT|0.60|2026-08-31|XLRE laggard on every horizon (1d -0.73%, 3d -2.92%, 1w -2.34%, 1m -6.06% rel)
Data-center REIT demand / rent upside|HIT|0.70|2026-08-31|Stale structural positive, not a same-day up vote
Industrial REIT occupancy / rent growth|HIT|0.65|2026-08-31|Stale structural positive, not a same-day up vote
Office vacancy / mark-to-market stress|HIT|0.60|2026-08-31|Small sleeve (~1% of XLRE)
Refinancing wall stress|HIT|0.60|2026-08-31|Structural, 2026-28 CRE maturity wall
Rates falling / REIT duration relief|MISS|0.70|2026-08-31|Live curve rising, not falling
HIT_GRID_END
