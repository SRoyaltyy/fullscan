...
- **Risk state:** MIXED (general predict up score +1.1, conf 0.55)
- **Yields:** falling | **Dollar/oil:** strong | **VIX:** unknown
...
| Label | Weather | Conf | Why |
|---|---|---|---|
| beta:high | ⛅ neutral | low | risk-mixed, VIX unknown |
| beta:low | ⛅ neutral | low | risk-mixed, VIX unknown |
