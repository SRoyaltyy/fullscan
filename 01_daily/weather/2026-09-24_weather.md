...
- **Risk state:** UNKNOWN
- **Yields:** flat (fred_dgs10) | **Dollar:** flat (dxy) | **Oil:** rising | **VIX:** calm (ratio 0.90 via vix/vix3m) spot 16.37
...
| sector:Technology | ⛅ neutral | medium | finviz sector median week +0.48% [tape] |
