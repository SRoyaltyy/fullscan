...
- **Risk state:** OFF (general predict down score -7.7, conf 0.806)
- **Yields:** flat (fred_dgs10) | **Dollar:** flat (dxy) | **Oil:** rising | **VIX:** falling (ratio 0.90 via vix/vix3m) spot 16.27
- **Fear & Greed:** n/a | **Yield/SPX 5d corr:** -0.83
- **High-impact events:** 4 bullish vs 2 bearish

## Sectors

| Label | Weather | Conf | Why |
|---|---|---|---|
| sector:Basic Materials | ⛅ neutral | high | sector predict score -2.9 dir down conf 0.615 [sector board] |
| sector:Communication Services | 🌧️ hostile | high | sector predict score -11.3 dir down conf 0.85 [sector board] |
| sector:Consumer Cyclical | 🌧️ hostile | high | sector predict score -8.5 dir down conf 0.839 [sector board] |
| sector:Consumer Defensive | ⛅ neutral | medium | finviz sector median week -0.01% [tape] |
| sector:Energy | 🌤️ favorable | high | sector predict score +6.8 dir up conf 0.771 [sector board] |
| sector:Financial | 🌧️ hostile | high | sector predict score -4.9 dir down conf 0.696 [sector board] |
| sector:Healthcare | 🌤️ favorable | medium | news_judge SECTOR Healthcare [bullish] |
| sector:Industrials | 🌧️ hostile | high | sector predict score -4.3 dir down conf 0.672 [sector board] |
| sector:Real Estate | 🌧️ hostile | high | sector predict score -10.0 dir down conf 0.85 [sector board] |
| sector:Technology | 🌤️ favorable | medium | news_judge SECTOR Technology [bullish] |
| sector:Utilities | 🌧️ hostile | high | sector predict score -5.8 dir down conf 0.633 [sector board] |
