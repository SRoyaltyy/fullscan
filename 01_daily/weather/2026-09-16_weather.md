...
- **Risk state:** UNKNOWN
- **Yields:** flat (fred_dgs10) | **Dollar:** flat (dxy) | **Oil:** falling | **VIX:** falling (ratio 0.88 via vix/vix3m) spot 16.99
...
| sector:Communication Services | ⛅ neutral | medium | finviz sector median week -0.38% [tape] |
| sector:Consumer Cyclical | 🌧️ hostile | medium | finviz sector median week -3.55% [tape] |
| sector:Consumer Defensive | 🌧️ hostile | medium | finviz sector median week -2.46% [tape] |
...
| sector:Healthcare | 🌧️ hostile | medium | finviz sector median week -4.44% [tape] |
...
| sector:Utilities | 🌧️ hostile | medium | finviz sector median week -4.01% [tape] |
