...
- **Yields:** flat (fred_dgs10) | **Dollar:** flat (dxy) | **Oil:** falling | **VIX:** falling (ratio 0.87 via vix/vix3m) spot 16.77
...
|---|---|---|---|
| sector:Basic Materials | 🌤️ favorable | high | sector predict score +9.7 dir flat conf 0.55 [sector board] |
| sector:Communication Services | 🌤️ favorable | high | sector predict score +9.2 dir up conf 0.65 [sector board] |
| sector:Consumer Cyclical | ⛅ neutral | high | sector predict score +2.7 dir flat conf 0.508 [sector board] |
| sector:Consumer Defensive | ⛅ neutral | high | sector predict score -0.4 dir flat conf 0.417 [sector board] |
| sector:Energy | ⛅ neutral | high | sector predict score -2.9 dir down conf 0.615 [sector board] |
| sector:Financial | ⛅ neutral | high | sector predict score +3.0 dir flat conf 0.55 [sector board] |
| sector:Healthcare | ⛅ neutral | high | sector predict score +3.0 dir up conf 0.52 [sector board] |
| sector:Industrials | 🌤️ favorable | high | sector predict score +7.3 dir flat conf 0.55 [sector board] |
| sector:Real Estate | ⛅ neutral | high | sector predict score +2.5 dir flat conf 0.55 [sector board] |
| sector:Technology | 🌤️ favorable | medium | news_judge SECTOR Technology [bullish] |
| sector:Utilities | ⛅ neutral | high | sector predict score -0.5 dir down conf 0.419 [sector board] |
