...
- **Risk state:** UNKNOWN
- **Yields:** flat (fred_dgs10) | **Dollar:** flat (dxy) | **Oil:** falling | **VIX:** falling (ratio 0.81 via vix/vix3m) spot 15.12
...
|---|---|---|---|
| sector:Basic Materials | ⛅ neutral | medium | finviz sector median week -1.27% [tape] |
...
| sector:Energy | 🌧️ hostile | medium | finviz sector median week -2.59% [tape] |
| sector:Financial | ⛅ neutral | medium | finviz sector median week +0.07% [tape] |
