...
- **Risk state:** UNKNOWN
- **Yields:** rising (fred_dgs10) | **Dollar:** flat (dxy) | **Oil:** falling | **VIX:** falling (ratio 1.02 via vix/ma20) spot 15.84
...
| sector:Real Estate | 🌧️ hostile | medium | finviz sector median week -2.77% [tape] |
| sector:Technology | 🌤️ favorable | medium | news_judge SECTOR Technology [bullish] |
| sector:Utilities | 🌧️ hostile | medium | finviz sector median week -1.83% [tape] |
