...
- **Risk state:** UNKNOWN
- **Yields:** unknown (llm_factor_fallback) | **Dollar:** unknown (missing_dxy) | **Oil:** unknown | **VIX:** unknown
- **Fear & Greed:** n/a | **Yield/SPX 5d corr:** n/a
- **High-impact events:** 4 bullish vs 8 bearish | China: bull
- ⚠️ **Data gaps:** general predict run, general predict factor scoreboard, channel 1 predict json

## Sectors

| Label | Weather | Conf | Why |
|---|---|---|---|
| sector:Basic Materials | ⛅ neutral | medium | finviz sector median week +0.74% [tape] |
| sector:Communication Services | ⛅ neutral | medium | finviz sector median week -1.31% [tape] |
| sector:Consumer Cyclical | ⛅ neutral | medium | finviz sector median week -0.73% [tape] |
| sector:Consumer Defensive | 🌧️ hostile | medium | finviz sector median week -1.94% [tape] |
| sector:Energy | ⛅ neutral | medium | finviz sector median week +1.10% [tape] |
...
| sector:Industrials | ⛅ neutral | medium | finviz sector median week +0.60% [tape] |
| sector:Real Estate | 🌧️ hostile | medium | news_judge SECTOR Real Estate [bearish] |
| sector:Technology | ⛅ neutral | medium | finviz sector median week +0.14% [tape] |
| sector:Utilities | ⛅ neutral | medium | finviz sector median week +1.32% [tape] |
