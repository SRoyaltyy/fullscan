...
- **Risk state:** UNKNOWN
- **Yields:** unknown (llm_factor_fallback) | **Dollar:** flat (dxy) | **Oil:** flat | **VIX:** calm (ratio 0.95 via vix/ma20) spot 14.51
...
|---|---|---|---|
| sector:Basic Materials | 🌤️ favorable | medium | finviz sector median week +2.60% [tape] |
| sector:Communication Services | ⛅ neutral | medium | finviz sector median week -0.47% [tape] |
| sector:Consumer Cyclical | ⛅ neutral | medium | finviz sector median week -1.10% [tape] |
| sector:Consumer Defensive | ⛅ neutral | medium | finviz sector median week -0.27% [tape] |
| sector:Energy | ⛅ neutral | medium | finviz sector median week -0.45% [tape] |
| sector:Financial | ⛅ neutral | medium | finviz sector median week +0.45% [tape] |
| sector:Healthcare | 🌧️ hostile | medium | news_judge SECTOR Healthcare [bearish] |
| sector:Industrials | ⛅ neutral | medium | finviz sector median week -0.16% [tape] |
| sector:Real Estate | ⛅ neutral | medium | finviz sector median week -0.90% [tape] |
| sector:Technology | 🌤️ favorable | medium | finviz sector median week +1.66% [tape] |
| sector:Utilities | ⛅ neutral | medium | finviz sector median week -0.90% [tape] |
