...
- **Risk state:** UNKNOWN
- **Yields:** unknown (llm_factor_fallback) | **Dollar:** flat (dxy) | **Oil:** rising | **VIX:** calm (ratio 0.91 via vix/vix3m) spot 16.42
...
| sector:Technology | ⛅ neutral | medium | finviz sector median week +0.40% [tape] |
