...
- **Risk state:** OFF (general predict down score -13.3, conf 0.65)
...
- **High-impact events:** 0 bullish vs 6 bearish

## Sectors

| Label | Weather | Conf | Why |
|---|---|---|---|
| sector:Basic Materials | 🌧️ hostile | high | sector predict score -9.0 dir down conf 0.58 [sector board] |
| sector:Communication Services | 🌧️ hostile | high | sector predict score -3.6 dir down conf 0.55 [sector board] |
...
| sector:Utilities | 🌧️ hostile | high | sector predict score -4.7 dir down conf 0.55 [sector board] |
