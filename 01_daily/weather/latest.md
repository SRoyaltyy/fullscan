...
- **Risk state:** UNKNOWN
- **Yields:** flat (fred_dgs10) | **Dollar:** soft (dxy) | **Oil:** rising | **VIX:** calm (ratio 1.04 via vix/ma20) spot 15.67
- **Fear & Greed:** 58 (Greed) | **Yield/SPX 5d corr:** -0.97
- **High-impact events:** 0 bullish vs 0 bearish
- ⚠️ **Data gaps:** general predict run, general predict factor scoreboard, event scanner output
...
| sector:Communication Services | ⛅ neutral | medium | finviz sector median week -0.92% [tape] |
| sector:Consumer Cyclical | ⛅ neutral | medium | finviz sector median week -0.29% [tape] |
| sector:Consumer Defensive | ⛅ neutral | medium | finviz sector median week -1.33% [tape] |
| sector:Energy | 🌤️ favorable | medium | finviz sector median week +1.66% [tape] |
...
| sector:Industrials | ⛅ neutral | medium | finviz sector median week -0.07% [tape] |
