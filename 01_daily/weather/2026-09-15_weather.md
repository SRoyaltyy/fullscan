...
- **Risk state:** OFF (general predict down score -3.6, conf 0.546)
- **Yields:** flat (fred_dgs10) | **Dollar:** strong (dxy) | **Oil:** rising | **VIX:** falling (ratio 0.90 via vix/vix3m) spot 17.56
- **Fear & Greed:** n/a | **Yield/SPX 5d corr:** -0.18
- **High-impact events:** 8 bullish vs 26 bearish
...
| sector:Communication Services | 🌧️ hostile | high | sector predict score -3.8 dir flat conf 0.55 [sector board] |
| sector:Consumer Cyclical | 🌧️ hostile | high | sector predict score -3.3 dir down conf 0.633 [sector board] |
| sector:Consumer Defensive | 🌧️ hostile | high | sector predict score -5.0 dir flat conf 0.55 [sector board] |
| sector:Energy | 🌤️ favorable | high | sector predict score +6.8 dir up conf 0.65 [sector board] |
| sector:Financial | 🌧️ hostile | medium | news_judge SECTOR Financial [bearish] |
| sector:Healthcare | ⛅ neutral | high | sector predict score -2.9 dir down conf 0.518 [sector board] |
| sector:Industrials | ⛅ neutral | high | sector predict score -0.5 dir down conf 0.422 [sector board] |
| sector:Real Estate | 🌧️ hostile | high | sector predict score -6.3 dir down conf 0.65 [sector board] |
| sector:Technology | ⛅ neutral | high | sector predict score -1.1 dir down conf 0.444 [sector board] |
| sector:Utilities | 🌧️ hostile | high | sector predict score -6.5 dir down conf 0.65 [sector board] |
