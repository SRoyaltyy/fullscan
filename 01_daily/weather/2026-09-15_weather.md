...
- **Risk state:** OFF (general predict down score -2.9, conf 0.515)
- **Yields:** flat (fred_dgs10) | **Dollar:** flat (dxy) | **Oil:** flat | **VIX:** calm (ratio 1.08 via vix/ma20) spot 16.89
- **Fear & Greed:** n/a | **Yield/SPX 5d corr:** -0.17
- **High-impact events:** 4 bullish vs 18 bearish
...
|---|---|---|---|
| sector:Basic Materials | 🌧️ hostile | high | sector predict score -3.7 dir down conf 0.549 [sector board] |
| sector:Communication Services | ⛅ neutral | high | sector predict score -2.7 dir flat conf 0.55 [sector board] |
| sector:Consumer Cyclical | ⛅ neutral | high | sector predict score -2.3 dir down conf 0.491 [sector board] |
| sector:Consumer Defensive | 🌧️ hostile | medium | finviz sector median week -2.10% [tape] |
...
| sector:Healthcare | 🌧️ hostile | high | sector predict score -3.3 dir down conf 0.531 [sector board] |
| sector:Industrials | 🌧️ hostile | high | sector predict score -3.3 dir down conf 0.533 [sector board] |
| sector:Real Estate | 🌧️ hostile | high | sector predict score -4.5 dir down conf 0.582 [sector board] |
| sector:Technology | 🌧️ hostile | high | sector predict score -7.5 dir down conf 0.65 [sector board] |
| sector:Utilities | 🌧️ hostile | high | sector predict score -6.1 dir down conf 0.644 [sector board] |
