...
- **Risk state:** OFF (general predict down score -4.4, conf 0.65)
- **Yields:** flat (fred_dgs10) | **Dollar:** strong (dxy) | **Oil:** rising | **VIX:** falling (ratio 0.90 via vix/vix3m) spot 17.62
- **Fear & Greed:** n/a | **Yield/SPX 5d corr:** -0.14
- **High-impact events:** 6 bullish vs 21 bearish

## Sectors

| Label | Weather | Conf | Why |
|---|---|---|---|
| sector:Basic Materials | 🌧️ hostile | high | sector predict score -5.9 dir down conf 0.636 [sector board] |
| sector:Communication Services | 🌧️ hostile | high | sector predict score -4.1 dir flat conf 0.55 [sector board] |
| sector:Consumer Cyclical | 🌧️ hostile | high | sector predict score -4.9 dir down conf 0.65 [sector board] |
| sector:Consumer Defensive | 🌧️ hostile | high | sector predict score -4.8 dir flat conf 0.55 [sector board] |
| sector:Energy | 🌤️ favorable | medium | news_judge SECTOR Energy [bullish] |
| sector:Financial | 🌧️ hostile | high | sector predict score -3.4 dir down conf 0.537 [sector board] |
| sector:Healthcare | ⛅ neutral | high | sector predict score -1.5 dir down conf 0.46 [sector board] |
| sector:Industrials | ⛅ neutral | high | sector predict score -0.8 dir down conf 0.433 [sector board] |
| sector:Real Estate | 🌧️ hostile | high | sector predict score -4.9 dir down conf 0.65 [sector board] |
| sector:Technology | ⛅ neutral | high | sector predict score -2.0 dir down conf 0.48 [sector board] |
| sector:Utilities | 🌧️ hostile | high | sector predict score -6.7 dir down conf 0.65 [sector board] |
