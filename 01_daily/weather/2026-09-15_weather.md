...
- **Risk state:** OFF (general predict down score -3.8, conf 0.553)
- **Yields:** flat (fred_dgs10) | **Dollar:** strong (dxy) | **Oil:** rising | **VIX:** falling (ratio 0.89 via vix/vix3m) spot 17.22
- **Fear & Greed:** n/a | **Yield/SPX 5d corr:** -0.15
- **High-impact events:** 10 bullish vs 29 bearish
...
|---|---|---|---|
| sector:Basic Materials | 🌧️ hostile | high | sector predict score -5.7 dir down conf 0.629 [sector board] |
| sector:Communication Services | 🌧️ hostile | high | sector predict score -4.6 dir flat conf 0.55 [sector board] |
| sector:Consumer Cyclical | 🌧️ hostile | high | sector predict score -7.2 dir down conf 0.65 [sector board] |
| sector:Consumer Defensive | 🌧️ hostile | high | sector predict score -5.8 dir flat conf 0.55 [sector board] |
| sector:Energy | 🌤️ favorable | medium | news_judge SECTOR Energy [bullish] |
| sector:Financial | 🌧️ hostile | high | sector predict score -4.1 dir down conf 0.565 [sector board] |
| sector:Healthcare | 🌧️ hostile | high | sector predict score -4.1 dir down conf 0.565 [sector board] |
| sector:Industrials | ⛅ neutral | high | sector predict score -0.6 dir down conf 0.425 [sector board] |
| sector:Real Estate | 🌧️ hostile | high | sector predict score -7.3 dir down conf 0.65 [sector board] |
| sector:Technology | 🌧️ hostile | medium | news_judge SECTOR Technology [bearish] |
| sector:Utilities | 🌧️ hostile | high | sector predict score -6.6 dir down conf 0.65 [sector board] |
