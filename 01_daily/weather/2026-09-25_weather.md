...
- **Yields:** rising (fred_dgs10) | **Dollar:** soft (dxy) | **Oil:** falling | **VIX:** falling (ratio 0.83 via vix/vix3m) spot 15.37
...
|---|---|---|---|
| sector:Basic Materials | ⛅ neutral | high | sector predict score +1.4 dir flat conf 0.455 [sector board] |
| sector:Communication Services | ⛅ neutral | high | sector predict score -0.4 dir flat conf 0.415 [sector board] |
| sector:Consumer Cyclical | 🌧️ hostile | high | sector predict score -3.2 dir down conf 0.528 [sector board] |
| sector:Consumer Defensive | ⛅ neutral | high | sector predict score +3.0 dir up conf 0.519 [sector board] |
| sector:Energy | 🌧️ hostile | high | sector predict score -9.6 dir down conf 0.65 [sector board] |
| sector:Financial | ⛅ neutral | high | sector predict score -0.1 dir flat conf 0.403 [sector board] |
| sector:Healthcare | ⛅ neutral | high | sector predict score +0.9 dir up conf 0.537 [sector board] |
| sector:Industrials | 🌧️ hostile | high | sector predict score -6.0 dir down conf 0.65 [sector board] |
| sector:Real Estate | 🌧️ hostile | high | sector predict score -4.6 dir down conf 0.585 [sector board] |
| sector:Technology | 🌤️ favorable | medium | news_judge SECTOR Technology [bullish] |
| sector:Utilities | 🌧️ hostile | high | sector predict score -3.2 dir down conf 0.53 [sector board] |
