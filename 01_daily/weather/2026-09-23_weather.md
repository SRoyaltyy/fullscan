...
- **Risk state:** UNKNOWN
- **Yields:** falling (fred_dgs10) | **Dollar:** strong (dxy) | **Oil:** falling | **VIX:** falling (ratio 0.78 via vix/vix3m) spot 14.17
...
| sector:Communication Services | ⛅ neutral | medium | finviz sector median week -0.77% [tape] |
| sector:Consumer Cyclical | ⛅ neutral | medium | finviz sector median week +0.83% [tape] |
...
| sector:Financial | ⛅ neutral | medium | finviz sector median week +0.62% [tape] |
| sector:Healthcare | 🌧️ hostile | medium | news_judge SECTOR Healthcare [bearish] |
| sector:Industrials | ⛅ neutral | medium | finviz sector median week +1.12% [tape] |
| sector:Real Estate | ⛅ neutral | medium | finviz sector median week -0.56% [tape] |
| sector:Technology | 🌤️ favorable | medium | finviz sector median week +2.67% [tape] |
| sector:Utilities | ⛅ neutral | medium | finviz sector median week -0.64% [tape] |
