# Learnings report — 2026-08-18

Generated: **2026-08-18T17:48:29.099001-04:00** by `src/learn_cycle.py`.
...
| Item | Value |
|------|-------|
| Graded runs mined | 79 |
| Hypotheses written | 80 (wins=47, losses=33) |
| News hypotheses | 1 |
| Lessons promoted to active | 11 |
| Active lesson files now | 65 |
...
|-------|----------------|--------|------|
| general | 69% | 9/13 | ok |
| sector:Basic Materials | 50% | 3/6 | weak — priority |
| sector:Communication Services | 33% | 2/6 | weak — priority |
| sector:Consumer Cyclical | 83% | 5/6 | ok |
| sector:Consumer Defensive | 50% | 3/6 | weak — priority |
| sector:Energy | 67% | 4/6 | ok |
| sector:Financial | 50% | 3/6 | weak — priority |
| sector:Healthcare | 67% | 4/6 | ok |
| sector:Industrials | 33% | 2/6 | weak — priority |
| sector:Real Estate | 67% | 4/6 | ok |
| sector:Technology | 50% | 3/6 | weak — priority |
| sector:Utilities | 67% | 4/6 | ok |
...
#### WIN — news
- **When:** [news] summary={"n_suggestions": 188, "ever_profitable": {"n": 188, "wins": 187, "win_rate": 99.5}, "close_1d": {"n": 170, "wins": 105, "win_rate": 61.8, "avg": 0.55}, "close_3d": {"n": 123, "wins": 87, "win_rate": 70.7, "avg": 1.27}, "close_5d": {"n": 47, "wins": 36, "win_rate": 76.6, "avg": 3.47}, "close_10d": n
...
### `sector_basic_materials` — 3 wins, 3 losses
...
### `sector_communication_services` — 2 wins, 4 losses
...
### `sector_consumer_cyclical` — 5 wins, 1 losses
...
### `sector_consumer_defensive` — 3 wins, 3 losses
...
### `sector_financial` — 3 wins, 3 losses
...
### `sector_healthcare` — 4 wins, 2 losses
...
### `sector_industrials` — 2 wins, 4 losses
...
### `sector_real_estate` — 4 wins, 2 losses
...
### `sector_technology` — 3 wins, 3 losses
...
### `sector_utilities` — 4 wins, 2 losses
...
| `01_daily/2026-08-18_learnings.md` | Dated copy |
