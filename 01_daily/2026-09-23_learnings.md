# Learnings report — 2026-09-23

Generated: **2026-09-23T16:59:28.111193-04:00** by `src/learn_cycle.py`.
...
#### LOSS — news
- **When:** [news] Global 1d close win rate 51.7% (n=1441).
...
- `a-cyclical-industrials-etf-xli-like-posts-an-all-zero-s0-s4.md` (sector:Industrials): 71% → 25% (-46%) → `02_lessons/retired/`
...
| `01_daily/2026-09-23_learnings.md` | Dated copy |
