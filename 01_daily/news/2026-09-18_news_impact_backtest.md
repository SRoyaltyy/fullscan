...
articles=123  pipeline=news_impact_v1
...
- [print_vs_priced] Salesforce issues FY27 revenue guidance of $46.4B, sets FY30 revenue target above $63B at Investor Day → ['CRM:not_determined']
- [capital_return] Strong H1 profits, guidance upgrade and Â£1bn buyback drive BCS 6.48% surge → ['BCS:up']
...
- [print_vs_priced] Barronâs reports that Cardinal Health CEO Jason Hollar recently sold about $29 million of company stock following the post-earnings share surge to record levels. → ['CAH:up']
...
- [capital_return] Eni lifts 2026 hydrocarbon output growth target to ~5% and boosts 2026 buyback to â¬3.4B on stronger Q2 results → ['E:up']
...
- [print_vs_priced] ING Groep NV ADR reports fiscal Q2 2026 results with non-GAAP EPS $0.77 (+21% YoY) and revenue $7.2B (+10% YoY), beats EPS and revenue estimates → ['ING:up']
- [print_vs_priced] Mizuho Financial Group Inc ADR reports fiscal quarterly results with non-GAAP EPS $0.14 (-10% YoY) and revenue $15.4B (+198% YoY), misses EPS but beats revenue estimates → ['listed expression unknown:not_determined']
- [gate] Motorola Solutions wins $139 million 10-year public safety technology contract from State of Louisiana → ['listed expression unknown:not_determined']
- [corporate_action_mna] NextEra and Dominion Sweeten Merger Deal With Bill Credits and New Jobs → ['D:mixed', 'NEE:mixed']
