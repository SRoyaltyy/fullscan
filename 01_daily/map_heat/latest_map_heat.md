...
Econ (importance ≥ 2):
- 08:15 ET  ADP Employment Change Weekly  actual —  cons —  surprise —  prev 16.25K
...
- 20:00 ET  UN General Assembly  actual —  cons —  surprise —  prev —
- 04:10 ET  Fed Williams Speech  actual —  cons —  surprise —  prev —
- 08:00 ET  Fed Barkin Speech  actual —  cons —  surprise —  prev —
- 08:30 ET  Current Account  actual —  cons -$255B  surprise —  prev -$226.8B
- 08:30 ET  Initial Jobless Claims  actual —  cons 203K  surprise —  prev 196K
- 08:50 ET  Fed Hammack Speech  actual —  cons —  surprise —  prev —
- 10:00 ET  New Home Sales  actual —  cons 0.62M  surprise —  prev 0.607M
- 10:00 ET  New Home Sales MoM  actual —  cons 3.2%  surprise —  prev -10.5%
- 10:10 ET  Fed Paulson Speech  actual —  cons —  surprise —  prev —
- 20:00 ET  UN General Assembly  actual —  cons —  surprise —  prev —
- 05:15 ET  Fed Williams Speech  actual —  cons —  surprise —  prev —
- 08:30 ET  Durable Goods Orders MoM  actual —  cons -0.3%  surprise —  prev 1.1%
- 08:30 ET  Durable Goods Orders Ex Transp MoM  actual —  cons 0.6%  surprise —  prev 0.4%
- 10:00 ET  Michigan Consumer Sentiment Final  actual —  cons 47.5  surprise —  prev 51.7
- 14:00 ET  Fed Hammack Speech  actual —  cons —  surprise —  prev —
- 10:30 ET  Dallas Fed Manufacturing Index  actual —  cons —  surprise —  prev 11.6
- 09:00 ET  S&P/Case-Shiller Home Price YoY  actual —  cons —  surprise —  prev 2.1%
- 10:00 ET  JOLTs Job Openings  actual —  cons 7.2M  surprise —  prev 7.271M
- 10:00 ET  CB Consumer Confidence  actual —  cons —  surprise —  prev 89.4
...
- 08:15 ET  ADP Employment Change  actual —  cons 75K  surprise —  prev 38K
- 08:30 ET  Core PCE Price Index MoM  actual —  cons —  surprise —  prev 0.2%
...
- AMC **NKE**  EPS est 0.4401  (Nike Inc)
- BMO **AZO**  EPS est 53.6472  (Autozone Inc)
- BMO **PAYX**  EPS est 1.3191  (Paychex Inc)
- BMO **JBL**  EPS est 4.0593  (Jabil Inc)
- BMO **CCL**  EPS est 1.3578  (Carnival Corp Ltd)
- BMO **DRI**  EPS est 2.0532  (Darden Restaurants Inc)
- BMO **SNX**  EPS est 4.7019  (TD Synnex Corp)
- AMC **STZ**  EPS est 3.5772  (Constellation Brands Inc)
...
- BMO **FDS**  EPS est 4.3539  (Factset Research Systems Inc)

Options event-vol flags (NOT direction):
- **MU** exp 2026-09-23 ATM IV 0.002 implied move +0.0% put/call OI —
- **COST** exp 2026-09-25 ATM IV 0.002 implied move +0.0% put/call OI —
...
- **CTAS** exp 2026-09-25 ATM IV 0.0039 implied move +0.0% put/call OI —
- **NKE** exp 2026-09-25 ATM IV 0.0039 implied move +0.0% put/call OI —
- **AZO** exp 2026-10-16 ATM IV 0.0005 implied move +0.0% put/call OI —
- **PAYX** exp 2026-10-16 ATM IV 0.0001 implied move 0.0% put/call OI —
...
- 6 min **META** Stock market today: Nasdaq, Dow and S&P 500 little changed as AI trade powers market (Yahoo Finance)
- 10 min **HGTY** ULTRA-RARE MCA CENTENAIRE, MONACO'S FIRST SUPERCAR, OFFERED AT BROAD ARROW'S 2026 ZOUTE CONCOURS AUCTION (GlobeNewswire)
- 12 min **BABA** Alibaba Group Holding Limited Sued for Securities Law Violations - Contact the DJS Law Group to Discuss Your Rights - BABA (PR Newswire)
- 13 min **BBY** Best Buy Canada Selects RELEX to Optimize Forecasting and Replenishment (PR Newswire)
- 13 min **ACIW** ACI Worldwide Extends ACI Connetic to Support Payments Orchestrated Through Swift's Ledger (Business Wire)
- 40 min **MRNA** Moderna Stock Jumped 12% Yesterday. An ESMO Presidential Slot Explains Why. (TIKR)
- 44 min **META** Stock Market Today: Dow, S&P 500 and Nasdaq set for steady start as oil prices rise and chipmakers ease after rally (MarketWatch)
- 44 min **META** S&P 500 futures steady after powerful rally on Monday (MarketWatch)
- 46 min **JPM** JPMorgan CEO Sees Hyperscaler Spending Hitting $1 Trillion Next Year And Still Growing  Investors Are Shrugging It Off For Now (Stocktwits)
- 53 min **BZ** KANZHUN LIMITED Declares Annual Cash Dividend and Shareholder Return Plan (GlobeNewswire)
- 1 hour **FSLY** Fastly Stock Jumped 15% Yesterday on an AI Security Launch. Insiders Sold Millions First. (TIKR)
- 1 hour **ABAT** American Battery Technology Co (ABAT) (Q4 2026) Earnings Call Highlights: Record Revenue Growth ... (GuruFocus.com)
...
- 2 hours **DLR** Digital Realty Survey Finds More Than Half of Asia Pacific Enterprises Plan to Increase AI Investment by More Than 25% (GlobeNewswire)
- 2 hours **TTE** TotalEnergies SE: Disclosure of Transactions in Own Shares (Business Wire)
- 2 hours **SMTC** Semtech's LoRa Plus LR2021 Transceiver Wins 2026 EDGE Award (Business Wire)
- 2 hours **TTE** TotalEnergies SE UK Regulatory Announcement: Transaction in Own Shares (Business Wire)
- 2 hours **TDY** Teledyne e2v Introduces Nexora, Its Next-Generation Family of Backside-Illuminated Global Shutter CMOS Image Sensors (Business Wire)
- 2 hours **BB** Coretura Selects Alloy Kore to Advance a Unique Software-Defined Vehicle Platform for Its Commercial Vehicle Customers (ACCESSWIRE)
