...
**Step 0 — Setup.** Loaded the rubric, standing lessons, and Channel 1 data (10,571 characters of input). Model: `deepseek-chat`. Web search is ENABLED; the model must research current events before judging.
