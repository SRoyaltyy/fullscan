...
Per input, `REBUILD_MATCH` is `exact`, `mismatch` (count and first differing day), or `not-rebuildable` (AI or Finviz snapshot). No price feature, AB price rule, candidate list, peer RS, or VIX series is exact on every tested day from 2026-09-09 on. RSI on the panel is the Finviz print. DGS10 was not recomputed: the live FRED pull timed out. HOT4 and holdup still have no day on which every component is available-proven or rebuildable-verified. `PANEL_ROW_PREOPEN` is no on all 31 sessions. The pre-open `panel.json` on 09-09, 09-10, and 09-11 matches Excel PR #353 (latest sessions 09-08, 09-09, and 09-09, with zero rows for that morning), and the same zero holds for every session through 09-25. Each of those candidate lists first appears after 09:30 ET, so the HOT4 and holdup replay that excludes them still has no session, with GLND kept or removed. The table is in Per-input availability.
...
| Day | digest | map_heat | export | join | catalyst | baseline | weather | predict | actions | judge | events | research | ab file | A1-A15 | sector | excel | price pin | price feat. | ohlc_hot | yday_gainer | yday_mover | overnight | probable | earn_react | alarm | flatten | mover_buy | PANEL_ROW_PREOPEN |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 08-13 | missing | missing | available-proven | available-proven | missing | missing | available-proven | missing | missing | missing | missing | missing | missing | missing | missing | missing | missing | missing | missing | missing | missing | missing | missing | missing | missing | missing | missing | no |
| 08-14 | missing | missing | available-proven | available-proven | missing | missing | available-proven | missing | missing | missing | missing | missing | missing | missing | missing | missing | missing | missing | missing | missing | missing | missing | missing | missing | missing | missing | missing | no |
| 08-17 | missing | missing | available-proven | available-proven | missing | missing | available-proven | missing | missing | missing | missing | missing | missing | missing | missing | missing | missing | missing | missing | missing | missing | missing | missing | missing | missing | missing | missing | no |
| 08-18 | missing | missing | missing | missing | missing | missing | missing | missing | missing | missing | missing | missing | missing | missing | missing | missing | missing | missing | missing | missing | missing | missing | missing | missing | missing | missing | missing | no |
| 08-19 | missing | missing | missing | missing | missing | missing | missing | missing | missing | missing | missing | missing | missing | missing | missing | missing | missing | missing | missing | missing | missing | missing | missing | missing | missing | missing | missing | no |
| 08-20 | available-proven | missing | missing | missing | missing | missing | missing | missing | missing | missing | missing | missing | missing | missing | missing | missing | missing | missing | missing | missing | missing | missing | missing | missing | missing | missing | missing | no |
| 08-21 | available-proven | missing | missing | missing | missing | missing | missing | missing | missing | available-proven | missing | missing | missing | missing | missing | missing | missing | missing | missing | missing | missing | missing | missing | missing | missing | missing | missing | no |
| 08-24 | available-proven | missing | missing | missing | missing | missing | missing | missing | missing | available-proven | missing | missing | available-proven | available-proven | missing | missing | missing | missing | missing | missing | missing | missing | missing | missing | missing | missing | missing | no |
| 08-25 | missing | missing | missing | missing | missing | missing | missing | missing | missing | missing | missing | missing | available-proven | available-proven | missing | missing | missing | missing | missing | missing | missing | missing | missing | missing | missing | missing | missing | no |
| 08-26 | available-proven | missing | missing | missing | missing | missing | missing | missing | missing | available-proven | missing | missing | missing | missing | missing | missing | missing | missing | missing | missing | missing | missing | missing | missing | missing | missing | missing | no |
| 08-27 | available-proven | missing | missing | available-proven | missing | missing | available-proven | missing | missing | available-proven | missing | missing | missing | available-proven | missing | missing | missing | missing | missing | missing | missing | missing | missing | missing | missing | missing | missing | no |
| 08-28 | missing | missing | available-proven | available-proven | missing | missing | available-proven | missing | missing | available-proven | missing | missing | available-proven | available-proven | missing | missing | missing | missing | missing | missing | missing | missing | missing | missing | missing | missing | missing | no |
| 08-31 | available-proven | available-proven | available-proven | available-proven | available-proven | available-proven | available-proven | missing | missing | missing | missing | missing | available-proven | available-proven | missing | missing | missing | missing | missing | missing | missing | missing | missing | missing | missing | missing | missing | no |
| 09-01 | available-proven | available-proven | available-proven | missing | available-proven | missing | missing | missing | missing | available-proven | missing | missing | available-proven | available-proven | missing | missing | missing | missing | missing | missing | missing | missing | missing | missing | missing | missing | missing | no |
| 09-02 | available-proven | available-proven | available-proven | missing | missing | available-proven | missing | missing | missing | missing | missing | missing | missing | missing | missing | missing | missing | missing | missing | missing | missing | missing | missing | missing | missing | missing | missing | no |
| 09-03 | missing | missing | missing | missing | missing | available-proven | missing | missing | missing | missing | missing | missing | available-proven | available-proven | missing | available-proven | missing | missing | missing | missing | missing | missing | missing | missing | missing | missing | missing | no |
| 09-04 | missing | available-proven | missing | available-proven | available-proven | available-proven | available-proven | missing | missing | available-proven | available-proven | available-proven | available-proven | available-proven | missing | available-proven | missing | missing | missing | missing | missing | missing | missing | missing | missing | missing | missing | no |
| 09-08 | available-proven | missing | available-proven | available-proven | missing | available-proven | available-proven | missing | missing | available-proven | missing | missing | missing | missing | missing | available-proven | missing | missing | missing | missing | missing | missing | missing | missing | missing | missing | missing | no |
| 09-09 | missing | missing | missing | missing | missing | missing | available-proven | missing | missing | missing | missing | missing | missing | missing | missing | available-proven | missing | missing | missing | missing | missing | missing | missing | missing | missing | missing | missing | no |
| 09-10 | missing | missing | missing | missing | missing | available-proven | missing | missing | available-proven | available-proven | missing | missing | missing | missing | missing | available-proven | missing | missing | missing | missing | missing | missing | missing | missing | missing | missing | missing | no |
| 09-11 | missing | missing | missing | available-proven | missing | available-proven | available-proven | available-proven | available-proven | missing | missing | missing | missing | missing | missing | available-proven | missing | missing | missing | missing | missing | missing | missing | missing | missing | missing | missing | no |
| 09-14 | missing | missing | available-proven | available-proven | missing | available-proven | available-proven | missing | available-proven | missing | missing | missing | missing | missing | missing | available-proven | missing | missing | missing | missing | missing | missing | missing | missing | missing | missing | missing | no |
| 09-15 | available-proven | missing | available-proven | available-proven | missing | missing | available-proven | missing | available-proven | missing | available-proven | missing | missing | missing | missing | available-proven | missing | missing | missing | missing | missing | missing | missing | missing | missing | missing | missing | no |
| 09-16 | missing | missing | missing | missing | missing | available-proven | missing | missing | missing | missing | missing | missing | missing | missing | missing | available-proven | missing | missing | missing | missing | missing | missing | missing | missing | missing | missing | missing | no |
| 09-17 | missing | missing | missing | available-proven | missing | missing | available-proven | missing | available-proven | missing | missing | missing | missing | missing | missing | available-proven | missing | missing | missing | missing | missing | missing | missing | missing | missing | missing | missing | no |
...
`PANEL_ROW_PREOPEN` is yes only when a pre-open copy of `data/factor_mine/panel.json` already contains a row dated that morning. The pre-open commit is the latest first-parent commit on `main` that is the head of a GitHub Actions run whose `run_started_at` is strictly before 09:30 ET (13:30 UTC). That is the clock in Excel PR #353. The job-log pre-open commit, the latest main commit with a harvested `[safe-push]` line at or before 13:30 UTC, was read as well. Committer time is not used. The per-day candidate file the sequential walk opens is `data/factor_mine/snapshots/{date}.json`.

Excel's three pins match the GitHub API and the blob contents. On 09-09 the pre-open commit is `c1167245934f`, Actions `run_started_at` 2026-09-09T13:29:07Z (runs [34357360638](https://github.com/SRoyaltyy/fullscan/actions/runs/34357360638) Pages and [34357360667](https://github.com/SRoyaltyy/fullscan/actions/runs/34357360667) Stock Book, same timestamp). That tree's panel ends on 2026-09-08 (1,408 rows) and has 0 rows for 09-09. On 09-10 the commit is `a714ba9c0622`, run [34481132123](https://github.com/SRoyaltyy/fullscan/actions/runs/34481132123) started 2026-09-10T13:11:49Z; the panel ends on 2026-09-09 (1,492 rows, 84 of them dated 09-09) and has 0 rows for 09-10. On 09-11 the commit is `ae97009391d2`, run [34595911068](https://github.com/SRoyaltyy/fullscan/actions/runs/34595911068) started 2026-09-11T11:49:49Z; the panel blob is the same as 09-10 and has 0 rows for 09-11. The job-log pre-open commit on each of those mornings also has 0 rows for that morning.

The same two clocks agree on 09-14 through 09-25: the pre-open panel's latest session is the previous trading day, and the row count for that morning is 0. `snapshots/{date}.json` and `lineups/{date}.json` are absent from every one of those trees. `PANEL_ROW_PREOPEN` is no for all 13 mornings, and no for the 18 earlier sessions, whose pre-open trees do not contain `panel.json`.

The first server time below is the earliest harvested push-log line of the commit that introduced that morning's rows, or, when that commit is in no push range, the first Actions `run_started_at` whose head is that commit. A push-triggered Pages or ticket workflow that checks out an already-pushed head is an observation of the tree, not a push range.

| Day | Pre-open commit | Actions run_started_at | Latest session | Rows that morning | PANEL_ROW_PREOPEN | Snapshot in that tree | First server time of that morning's rows | Rows in that first blob | Clock |
| --- | --- | --- | --- | --- | ---: | --- | --- | ---: | --- |
| 09-09 | `c1167245934f` | 2026-09-09T13:29:07Z | 2026-09-08 | 0 | no | no | 2026-09-10T06:36:15Z | 84 | Actions checkout of `2c16dee4671e` (Pages run 34445947142) |
| 09-10 | `a714ba9c0622` | 2026-09-10T13:11:49Z | 2026-09-09 | 0 | no | no | 2026-09-12T03:04:50Z | 78 | Actions checkout of `1c7a450b893d` (Pages run 34669397044) |
| 09-11 | `ae97009391d2` | 2026-09-11T11:49:49Z | 2026-09-09 | 0 | no | no | 2026-09-12T03:04:50Z | 80 | Actions checkout of `1c7a450b893d` (Pages run 34669397044) |
| 09-14 | `3a376a61ec72` | 2026-09-14T12:16:29Z | 2026-09-11 | 0 | no | no | 2026-09-14T20:47:05Z | 64 | job log, Factor strategy mine run 34891196921 pushed `eef0854ca59c` |
| 09-15 | `5f42ee95a77e` | 2026-09-15T13:25:37Z | 2026-09-14 | 0 | no | no | 2026-09-15T21:22:19Z | 66 | job log, run 35021410565 pushed `284ca0e3a187` |
| 09-16 | `74eb31ad415a` | 2026-09-16T13:28:17Z | 2026-09-15 | 0 | no | no | 2026-09-16T17:55:55Z | 4 | Actions checkout of `5ae9d19c83e5` (Pages run 35131213960) |
| 09-17 | `e6d36a24fa19` | 2026-09-17T11:28:53Z | 2026-09-16 | 0 | no | no | 2026-09-17T13:59:13Z | 6 | job log, run 35229444306 pushed `2208918b2fac` |
| 09-18 | `36af7fd6e075` | 2026-09-18T11:34:18Z | 2026-09-17 | 0 | no | no | 2026-09-18T13:55:52Z | 4 | job log, run 35352149845 pushed `77a6a92c5857` |
| 09-21 | `bbfeebd23010` | 2026-09-21T12:03:49Z | 2026-09-18 | 0 | no | no | 2026-09-21T21:51:30Z | 62 | job log, run 35654612834 pushed `087d5fda408d` |
| 09-22 | `5501160f1880` | 2026-09-22T12:56:47Z | 2026-09-21 | 0 | no | no | 2026-09-23T00:04:52Z | 66 | job log, run 35795403177 pushed `41bcc47fe169` |
| 09-23 | `d250dba75cce` | 2026-09-23T12:34:56Z | 2026-09-22 | 0 | no | no | 2026-09-23T21:16:22Z | 73 | job log, run 35913441732 pushed `0d3fdf111048` |
| 09-24 | `baa8015db6d3` | 2026-09-24T12:13:31Z | 2026-09-23 | 0 | no | no | 2026-09-24T21:44:54Z | 77 | job log, run 36056466718 pushed `0eab5298326f` |
| 09-25 | `1e72b442c6c5` | 2026-09-25T13:28:59Z | 2026-09-24 | 0 | no | no | 2026-09-25T13:41:52Z | 67 | job log, run 36141227990 pushed `b5946b1d71bf` |

09-16, 09-17, and 09-18 first appear as 4, 6, and 4 rows. The filled lists (69, 66, and 58 rows) land in `75ff1cd1b5b0`, first observed 2026-09-19T11:27:36Z, which is still after each of those opens. On 09-17 the publishing run [35229444306](https://github.com/SRoyaltyy/fullscan/actions/runs/35229444306) started at 2026-09-17T13:48:37Z and the log line is 13:59:13Z, both after 13:30 UTC. On 09-25 the publishing run [36141227990](https://github.com/SRoyaltyy/fullscan/actions/runs/36141227990) started at 2026-09-25T13:28:59Z, ninety seconds before the cutoff, with head `1e72b442c6c5` (latest session 2026-09-24, zero rows for 09-25). The log line that pushed `b5946b1d71bf` is 2026-09-25T13:41:52Z, eleven minutes after 09:30 ET. Those 67 rows are not a pre-open copy.

`snapshots/2026-09-09.json` through `snapshots/2026-09-24.json` first appear in merge `5f13a4415ea0`. That commit is in no harvested push range. The first Actions run on that head is [36156731817](https://github.com/SRoyaltyy/fullscan/actions/runs/36156731817), `run_started_at` 2026-09-25T15:49:10Z, a push-triggered checkout of the merge. `snapshots/2026-09-25.json` first appears in `77db2793d6a2`, job log 2026-09-25T22:30:02Z. Both times are after every open in this window. Counts and run ids are in `research/audit/PANEL_ROW_PREOPEN.csv`.

### HOT4 and holdup components

HOT4 (`union_hot_n4_h1`) and holdup (`union_hot_n4_holdup`) use the same union: yday_gainer, yday_mover, ohlc_hot, overnight, probable, earn_react, plus price features for the hot_score rank, plus the alarm gate, plus flatten and mover_buy. Holdup adds a carry rule, not a new file. A component can run when its cell is `available-proven` or `rebuildable-verified`. The recipe is scored only on days where every one of those components can run. A day whose candidate list first appeared after 09:30 ET is left out of that set.

Days where every component can run: none. Days whose candidate list first appeared after 09:30 ET: all 31 sessions. The intersection is empty.
...
**HOT4 and holdup after dropping days whose candidate list first appeared after 09:30 ET, GLND kept.**
Every session from 2026-08-13 through 2026-09-25 has `PANEL_ROW_PREOPEN` no, and `snapshots/{date}.json` first appears after that morning's open. The replay set is empty, so there is no return and no ending equity.

**HOT4 and holdup after dropping days whose candidate list first appeared after 09:30 ET, GLND removed.**
The replay set is the same empty set. There is no return and no ending equity.
