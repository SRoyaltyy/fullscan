"""Locked rules for factor_mine_score_search_v2.

The grid is the same 34 formulas as v1. The pick is not v1's compound
rank. Luck N counts v1's 34 and these 34 again. No window score lives
here. A formula is not added or dropped after a result.
"""
...
ALLOW_PREFIXES = (
    "research/factor_mine_score_search_v2/",
    ".github/workflows/factor_mine_score_search_v2.yml",
)

# v1's grid was 34. This study tries those 34 ids again under a new rule.
V1_GRID_N = 34
LUCK_N = 68
MIN_TRADES = 30
RATIO_HI = 3.0
...
NON_RED = (
    ...
    "2026-08-25", "2026-08-26", "2026-08-28", "2026-09-03", "2026-09-04",
    "2026-09-11",
)
RANK_STARTS = (
...
def required_cells() -> tuple[tuple[str, int], ...]:
    ...
    X=2 never can (11 non-red sessions times 2 is 22). X=4 can only from
    2026-08-20 (8 times 4 is 32). X=8 can from each rank start.
    """
    cells = []
