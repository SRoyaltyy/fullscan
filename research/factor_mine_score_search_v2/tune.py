...
from research.factor_mine_score_search_v2.protocol import window_stats  # noqa: E402
...
def main() -> None:
    ...
    inputs = load_inputs()
    names = board_tickers(inputs, TUNE[-1])
    ...
    yahoo_jumps = jump_flags(yahoo_tape, names, TUNE[-1], dropped)
    yahoo = {
    ...
    days = prepare_days(inputs, clean_tape, TUNE)
