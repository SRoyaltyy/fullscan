...
_Generated 2026-09-08 · tip `d57799a6` / `JOIN_POST_813.md` · **research cards only** · live frozen._
...
`JOIN_POST_813.md` tip `d57799a6` · PR #153. Gate: `OPEN_SAME_ROW_LABELS.md` / `CLOCK_MAP.md`. Research only. Live frozen.
