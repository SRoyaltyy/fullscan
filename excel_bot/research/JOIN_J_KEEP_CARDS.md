...
**Fire** = a morning the rule changes the book (ticker set ≠ no-rule set). **Win** = that day’s rule-book mean after-fee H beats the same-day no-rule book. Ties do not beat. **CLEAR** needs win-rate >55% and ≥8 fires. A thin print (>55% but n_fires<8) is shown as PRINT, not a clear. Separately: % of the rule’s name-days with after-fee H>0 and I>0. Live = wired into the cash/paper bot — docs are not live. Live stays frozen.
...
| join top-8 | discovery | `avoid_J_ge0` | **CLEAR** | 87.5% (7/8 fires) | 64.1% n=64 | 59.4% n=64 | +0.72 pp |
| join top-8 | discovery | `elev_cap2_J_le-1` | **CLEAR** | 75.0% (6/8 fires) | 51.6% n=64 | 54.7% n=64 | +0.36 pp |
| join top-8 | pooled_sessions | `avoid_J_ge0` | **CLEAR** | 68.8% (11/16 fires) | 56.2% n=128 | 53.1% n=128 | +0.38 pp |
| join top-8 | pooled_sessions | `elev_cap2_J_le-1` | **CLEAR** | 62.5% (10/16 fires, 1 tie) | 51.6% n=128 | 55.5% n=128 | +0.26 pp |
...
| union_coil_green_h1 | prove | `avoid_J_ge0` | **PRINT** | 75.0% (3/4 fires) | 58.3% n=12 | 58.3% n=12 | +1.82 pp |
| union_coil_green_h1 | prove | `elev_cap2_J_le-1` | **PRINT** | 75.0% (3/4 fires) | 57.9% n=19 | 63.2% n=19 | +0.83 pp |
| union_e_fresh_h1 | prove | `avoid_J_ge0` | **PRINT** | 100.0% (3/3 fires) | 50.0% n=10 | 70.0% n=10 | +0.57 pp |
| union_e_fresh_h1 | prove | `elev_cap2_J_le-1` | **PRINT** | 66.7% (2/3 fires) | 50.0% n=18 | 61.1% n=18 | +0.02 pp |
| union_e_green_h3 | prove | `avoid_J_ge0` | **PRINT** | 100.0% (3/3 fires) | 55.6% n=9 | 55.6% n=9 | -0.27 pp |
| union_e_green_h3 | prove | `elev_cap2_J_le-1` | **PRINT** | 66.7% (2/3 fires) | 64.3% n=14 | 64.3% n=14 | -0.08 pp |
| union_h1 | prove | `avoid_J_ge0` | **PRINT** | 100.0% (2/2 fires) | 80.0% n=5 | 80.0% n=5 | +6.20 pp |
| union_h1 | prove | `elev_cap2_J_le-1` | **PRINT** | 75.0% (3/4 fires) | 75.0% n=16 | 81.2% n=16 | +1.01 pp |
| union_h1_cut | prove | `avoid_J_ge0` | **PRINT** | 100.0% (2/2 fires) | 80.0% n=5 | 80.0% n=5 | +6.20 pp |
| union_h1_cut | prove | `elev_cap2_J_le-1` | **PRINT** | 75.0% (3/4 fires) | 75.0% n=16 | 81.2% n=16 | +1.01 pp |
| union_h1_half | prove | `avoid_J_ge0` | **PRINT** | 100.0% (2/2 fires) | 80.0% n=5 | 80.0% n=5 | +6.13 pp |
| union_h1_half | prove | `elev_cap2_J_le-1` | **PRINT** | 75.0% (3/4 fires) | 73.3% n=15 | 80.0% n=15 | +1.12 pp |
| union_h1_rankw | prove | `avoid_J_ge0` | **PRINT** | 100.0% (2/2 fires) | 80.0% n=5 | 80.0% n=5 | +6.13 pp |
| union_h1_rankw | prove | `elev_cap2_J_le-1` | **PRINT** | 75.0% (3/4 fires) | 73.3% n=15 | 80.0% n=15 | +1.12 pp |
| union_h1_sboost | prove | `avoid_J_ge0` | **PRINT** | 100.0% (2/2 fires) | 80.0% n=5 | 80.0% n=5 | +6.20 pp |
| union_h1_sboost | prove | `elev_cap2_J_le-1` | **PRINT** | 75.0% (3/4 fires) | 75.0% n=16 | 81.2% n=16 | +1.01 pp |
| union_h1_sizeup | prove | `avoid_J_ge0` | **PRINT** | 100.0% (2/2 fires) | 80.0% n=5 | 80.0% n=5 | +6.20 pp |
| union_h1_sizeup | prove | `elev_cap2_J_le-1` | **PRINT** | 75.0% (3/4 fires) | 75.0% n=16 | 81.2% n=16 | +1.01 pp |
| union_h1_time | prove | `avoid_J_ge0` | **PRINT** | 66.7% (2/3 fires) | 66.7% n=6 | 66.7% n=6 | +6.11 pp |
| union_h1_time | prove | `elev_cap2_J_le-1` | **PRINT** | 75.0% (3/4 fires) | 62.5% n=24 | 66.7% n=24 | +1.01 pp |
| union_h1_topheavy | prove | `avoid_J_ge0` | **PRINT** | 100.0% (2/2 fires) | 80.0% n=5 | 80.0% n=5 | +6.13 pp |
| union_h1_topheavy | prove | `elev_cap2_J_le-1` | **PRINT** | 75.0% (3/4 fires) | 73.3% n=15 | 80.0% n=15 | +1.12 pp |
| union_h1_trail | prove | `avoid_J_ge0` | **PRINT** | 100.0% (2/2 fires) | 80.0% n=5 | 80.0% n=5 | +6.20 pp |
| union_h1_trail | prove | `elev_cap2_J_le-1` | **PRINT** | 75.0% (3/4 fires) | 75.0% n=16 | 81.2% n=16 | +1.01 pp |
| union_h3_half | prove | `avoid_J_ge0` | **PRINT** | 100.0% (2/2 fires) | 80.0% n=5 | 80.0% n=5 | +6.13 pp |
| union_h3_half | prove | `elev_cap2_J_le-1` | **PRINT** | 75.0% (3/4 fires) | 73.3% n=15 | 80.0% n=15 | +1.12 pp |
| union_h3_time | prove | `avoid_J_ge0` | **PRINT** | 66.7% (2/3 fires) | 60.0% n=5 | 60.0% n=5 | +5.36 pp |
| union_h3_time | prove | `elev_cap2_J_le-1` | **PRINT** | 75.0% (3/4 fires) | 66.7% n=12 | 66.7% n=12 | +1.24 pp |
| union_hot_n12_h1 | prove | `avoid_J_ge0` | **PRINT** | 100.0% (3/3 fires) | 76.5% n=17 | 64.7% n=17 | +1.30 pp |
| union_hot_n12_h1 | prove | `elev_cap2_J_le-1` | **PRINT** | 75.0% (3/4 fires) | 61.3% n=31 | 58.1% n=31 | +0.58 pp |
| union_hot_score_h1 | prove | `avoid_J_ge0` | **PRINT** | 100.0% (3/3 fires) | 81.8% n=11 | 72.7% n=11 | +1.75 pp |
| union_hot_score_h1 | prove | `elev_cap2_J_le-1` | **PRINT** | 75.0% (3/4 fires) | 68.4% n=19 | 68.4% n=19 | +0.85 pp |
| union_join_present_h1 | prove | `avoid_J_ge0` | **PRINT** | 100.0% (2/2 fires) | 80.0% n=5 | 80.0% n=5 | +6.20 pp |
| union_join_present_h1 | prove | `elev_cap2_J_le-1` | **PRINT** | 75.0% (3/4 fires) | 75.0% n=16 | 81.2% n=16 | +1.01 pp |
| union_news_present_h1 | prove | `avoid_J_ge0` | **PRINT** | 66.7% (2/3 fires) | 42.9% n=7 | 42.9% n=7 | +3.29 pp |
| union_news_present_h1 | prove | `elev_cap2_J_le-1` | **PRINT** | 75.0% (3/4 fires) | 66.7% n=18 | 66.7% n=18 | +0.85 pp |
| union_ret_5_h1 | prove | `avoid_J_ge0` | **FAIL** | 33.3% (1/3 fires) | 75.0% n=12 | 66.7% n=12 | +0.39 pp |
| union_ret_5_h1 | prove | `elev_cap2_J_le-1` | **PRINT** | 75.0% (3/4 fires) | 65.0% n=20 | 65.0% n=20 | +1.02 pp |
| union_ret_5_h3 | prove | `avoid_J_ge0` | **FAIL** | 33.3% (1/3 fires) | 75.0% n=12 | 66.7% n=12 | +0.36 pp |
| union_ret_5_h3 | prove | `elev_cap2_J_le-1` | **PRINT** | 75.0% (3/4 fires) | 66.7% n=18 | 61.1% n=18 | +1.14 pp |
| union_w_hot_candle_h1 | prove | `avoid_J_ge0` | **PRINT** | 100.0% (3/3 fires) | 81.8% n=11 | 72.7% n=11 | +2.17 pp |
| union_w_hot_candle_h1 | prove | `elev_cap2_J_le-1` | **PRINT** | 75.0% (3/4 fires) | 63.2% n=19 | 63.2% n=19 | +0.83 pp |
| union_w_hot_candle_h3 | prove | `avoid_J_ge0` | **PRINT** | 100.0% (3/3 fires) | 81.8% n=11 | 72.7% n=11 | +1.57 pp |
| union_w_hot_candle_h3 | prove | `elev_cap2_J_le-1` | **PRINT** | 66.7% (2/3 fires) | 58.8% n=17 | 58.8% n=17 | +0.12 pp |
| union_w_hot_cond_h1 | prove | `avoid_J_ge0` | **PRINT** | 100.0% (3/3 fires) | 85.7% n=7 | 71.4% n=7 | +2.29 pp |
| union_w_hot_cond_h1 | prove | `elev_cap2_J_le-1` | **PRINT** | 75.0% (3/4 fires) | 61.9% n=21 | 66.7% n=21 | +0.93 pp |
...
| green_pile_prior | prove | `elev_cap2_J_le-1` | **CLEAR** | 62.5% (5/8 fires) | 42.6% n=61 | 41.0% n=61 | +0.14 pp |
| weighted_book_1d_prior | prove | `avoid_J_ge0` | **CLEAR** | 75.0% (6/8 fires) | 51.4% n=37 | 45.9% n=37 | +0.49 pp |
| weighted_book_1d_prior | prove | `elev_cap2_J_le-1` | **PRINT** | 66.7% (2/3 fires) | 37.5% n=64 | 48.4% n=64 | +0.06 pp |
...
| 1d_size | prove | `avoid_J_ge0` | **PRINT** | 100.0% (2/2 fires) | 75.0% n=8 | 87.5% n=8 | +1.95 pp |
| 1d_size | prove | `elev_cap2_J_le-1` | **PRINT** | 100.0% (6/6 fires) | 73.7% n=19 | 84.2% n=19 | +0.72 pp |
| 1d_top | prove | `avoid_J_ge0` | **PRINT** | 100.0% (3/3 fires) | 75.0% n=12 | 50.0% n=12 | +0.81 pp |
| 1d_top | prove | `elev_cap2_J_le-1` | **FAIL** | 50.0% (3/6 fires) | 68.4% n=38 | 71.1% n=38 | +0.17 pp |
| 3d_size | prove | `avoid_J_ge0` | **PRINT** | 100.0% (3/3 fires) | 100.0% n=9 | 100.0% n=9 | +2.31 pp |
| 3d_size | prove | `elev_cap2_J_le-1` | **FAIL** | 33.3% (2/6 fires) | 68.0% n=25 | 88.0% n=25 | -0.07 pp |
| 3d_top | prove | `avoid_J_ge0` | **PRINT** | 66.7% (2/3 fires) | 100.0% n=9 | 77.8% n=9 | +1.32 pp |
...
| `green_pile_prior` | stock book | **KILL** | 50 | +0.20 pp | 50.0% (4/8 fires) FAIL | +0.14 pp | 62.5% (5/8 fires) CLEAR | 44.0% n=50 | 36.0% n=50 |
| `weighted_book_1d_prior` | stock book | **CONDITIONAL** | 37 | +0.49 pp | 75.0% (6/8 fires) CLEAR | +0.06 pp | 66.7% (2/3 fires) PRINT | 51.4% n=37 | 45.9% n=37 |
...
|---|---|---|---:|---:|---|---:|---|---|---|
| `flatten_robust` | sleeve merge | **KILL** | 11 | -0.59 pp | 50.0% (2/4 fires) FAIL | +0.19 pp | 50.0% (2/4 fires) FAIL | 45.5% n=11 | 54.5% n=11 |
| `coil_h3_exit_alarm` | factor mine | **CONDITIONAL** | 4 | +5.43 pp | 50.0% (1/2 fires) FAIL | +0.77 pp | 66.7% (2/3 fires) PRINT | 50.0% n=4 | 50.0% n=4 |
...
| `flatten_h3_topheavy` | factor mine | **KILL** | 13 | -0.92 pp | 57.1% (4/7 fires) PRINT | -0.06 pp | 42.9% (3/7 fires) FAIL | 38.5% n=13 | 46.2% n=13 |
...
| `flatten_h5_rankw` | factor mine | **KILL** | 9 | -0.85 pp | 57.1% (4/7 fires) PRINT | -0.02 pp | 37.5% (3/8 fires) FAIL | 55.6% n=9 | 66.7% n=9 |
...
| `ohlc_hot_coil_h1` | factor mine | **null** | 2 | +0.08 pp | 100.0% (1/1 fires) PRINT | -0.47 pp | 25.0% (1/4 fires) FAIL | 50.0% n=2 | 50.0% n=2 |
| `ohlc_hot_h1` | factor mine | **KILL** | 8 | +0.94 pp | 66.7% (2/3 fires) PRINT | +0.16 pp | 42.9% (3/7 fires) FAIL | 75.0% n=8 | 50.0% n=8 |
| `ohlc_hot_h3` | factor mine | **KILL** | 5 | +0.31 pp | 50.0% (1/2 fires) FAIL | -0.08 pp | 33.3% (2/6 fires) FAIL | 60.0% n=5 | 20.0% n=5 |
| `ohlc_hot_h5` | factor mine | **KILL** | 4 | +0.58 pp | 66.7% (2/3 fires) PRINT | -0.43 pp | 33.3% (2/6 fires) FAIL | 50.0% n=4 | 25.0% n=4 |
| `probable_h1` | factor mine | **CONDITIONAL** | 2 | +17.66 pp | 100.0% (1/1 fires) PRINT | +1.25 pp | 100.0% (3/3 fires) PRINT | 50.0% n=2 | 50.0% n=2 |
| `probable_h3` | factor mine | **CONDITIONAL** | 6 | +6.14 pp | 50.0% (2/4 fires) FAIL | +0.94 pp | 100.0% (7/7 fires) PRINT | 50.0% n=6 | 50.0% n=6 |
| `probable_h5` | factor mine | **CONDITIONAL** | 2 | +17.87 pp | 100.0% (1/1 fires) PRINT | +1.33 pp | 100.0% (3/3 fires) PRINT | 50.0% n=2 | 50.0% n=2 |
| `probable_probable_ok_h1` | factor mine | **CONDITIONAL** | 2 | +17.66 pp | 100.0% (1/1 fires) PRINT | +1.05 pp | 75.0% (6/8 fires) CLEAR | 50.0% n=2 | 50.0% n=2 |
| `probable_probable_ok_h3` | factor mine | **CONDITIONAL** | 2 | +17.75 pp | 100.0% (1/1 fires) PRINT | +1.62 pp | 85.7% (6/7 fires) PRINT | 50.0% n=2 | 50.0% n=2 |
...
| `union_ab_g_h1` | factor mine | **CONDITIONAL** | 4 | +0.60 pp | 50.0% (1/2 fires) FAIL | +0.20 pp | 75.0% (3/4 fires) PRINT | 75.0% n=4 | 75.0% n=4 |
| `union_ab_g_h3` | factor mine | **KILL** | 3 | +0.57 pp | 50.0% (1/2 fires) FAIL | +0.02 pp | 50.0% (2/4 fires) FAIL | 66.7% n=3 | 66.7% n=3 |
| `union_blue_coil_h1` | factor mine | **CONDITIONAL** | 3 | +3.24 pp | 50.0% (1/2 fires) FAIL | +1.22 pp | 100.0% (4/4 fires) PRINT | 66.7% n=3 | 66.7% n=3 |
| `union_blue_coil_h3` | factor mine | **CONDITIONAL** | 2 | +2.44 pp | 0.0% (0/1 fires) FAIL | +1.47 pp | 100.0% (3/3 fires) PRINT | 50.0% n=2 | 50.0% n=2 |
| `union_blue_h1` | factor mine | **CONDITIONAL** | 3 | +2.64 pp | 50.0% (1/2 fires) FAIL | +1.33 pp | 100.0% (4/4 fires) PRINT | 66.7% n=3 | 66.7% n=3 |
| `union_blue_h3` | factor mine | **CONDITIONAL** | 2 | +1.74 pp | 0.0% (0/1 fires) FAIL | +1.42 pp | 100.0% (3/3 fires) PRINT | 50.0% n=2 | 50.0% n=2 |
| `union_blue_vol_h1` | factor mine | **KILL** | 2 | +3.38 pp | 100.0% (1/1 fires) PRINT | +0.81 pp | 33.3% (1/3 fires) FAIL | 50.0% n=2 | 50.0% n=2 |
| `union_blue_vol_h3` | factor mine | **KILL** | 2 | +3.77 pp | 100.0% (1/1 fires) PRINT | +0.75 pp | 33.3% (1/3 fires) FAIL | 50.0% n=2 | 50.0% n=2 |
| `union_break10_h1` | factor mine | **CONDITIONAL** | 6 | +1.08 pp | 50.0% (1/2 fires) FAIL | +0.57 pp | 100.0% (3/3 fires) PRINT | 83.3% n=6 | 66.7% n=6 |
| `union_break10_h3` | factor mine | **CONDITIONAL** | 10 | -0.03 pp | 75.0% (3/4 fires) PRINT | +0.61 pp | 80.0% (4/5 fires) PRINT | 60.0% n=10 | 50.0% n=10 |
| `union_candle_h1` | factor mine | **CONDITIONAL** | 6 | +2.70 pp | 50.0% (1/2 fires) FAIL | +0.91 pp | 75.0% (3/4 fires) PRINT | 83.3% n=6 | 83.3% n=6 |
| `union_candle_h3` | factor mine | **CONDITIONAL** | 5 | +2.10 pp | 50.0% (1/2 fires) FAIL | +1.31 pp | 75.0% (3/4 fires) PRINT | 80.0% n=5 | 80.0% n=5 |
| `union_candle_score_h1` | factor mine | **CONDITIONAL** | 10 | +0.80 pp | 75.0% (3/4 fires) PRINT | +0.55 pp | 75.0% (3/4 fires) PRINT | 70.0% n=10 | 70.0% n=10 |
| `union_candle_score_h3` | factor mine | **CONDITIONAL** | 9 | +0.81 pp | 66.7% (2/3 fires) PRINT | +0.65 pp | 66.7% (2/3 fires) PRINT | 66.7% n=9 | 66.7% n=9 |
...
| `union_coil_green_h1` | factor mine | **CONDITIONAL** | 12 | +1.82 pp | 75.0% (3/4 fires) PRINT | +0.83 pp | 75.0% (3/4 fires) PRINT | 58.3% n=12 | 58.3% n=12 |
| `union_coil_green_h3` | factor mine | **CONDITIONAL** | 11 | +0.77 pp | 66.7% (2/3 fires) PRINT | +0.31 pp | 50.0% (2/4 fires) FAIL | 27.3% n=11 | 36.4% n=11 |
| `union_coil_off_h1` | factor mine | **KILL** | 9 | +2.21 pp | 50.0% (2/4 fires) FAIL | +0.16 pp | 50.0% (2/4 fires) FAIL | 55.6% n=9 | 55.6% n=9 |
| `union_coil_off_h3` | factor mine | **CONDITIONAL** | 8 | +2.95 pp | 50.0% (2/4 fires) FAIL | +0.37 pp | 66.7% (4/6 fires) PRINT | 37.5% n=8 | 50.0% n=8 |
| `union_coil_off_h5` | factor mine | **CONDITIONAL** | 8 | +2.66 pp | 50.0% (2/4 fires) FAIL | +0.26 pp | 50.0% (2/4 fires) FAIL | 62.5% n=8 | 62.5% n=8 |
| `union_cond_h1` | factor mine | **CONDITIONAL** | 2 | +5.41 pp | 100.0% (2/2 fires) PRINT | +0.64 pp | 100.0% (4/4 fires) PRINT | 100.0% n=2 | 100.0% n=2 |
| `union_cond_h3` | factor mine | **CONDITIONAL** | 1 | +4.63 pp | 100.0% (1/1 fires) PRINT | +0.88 pp | 100.0% (3/3 fires) PRINT | 100.0% n=1 | 100.0% n=1 |
| `union_cond_n4_h3` | factor mine | **null** | 6 | -1.30 pp | 50.0% (1/2 fires) FAIL | +0.46 pp | 50.0% (2/4 fires) FAIL | 50.0% n=6 | 33.3% n=6 |
| `union_e_fresh_h1` | factor mine | **CONDITIONAL** | 10 | +0.57 pp | 100.0% (3/3 fires) PRINT | +0.02 pp | 66.7% (2/3 fires) PRINT | 50.0% n=10 | 70.0% n=10 |
| `union_e_fresh_h3` | factor mine | **KILL** | 7 | +0.65 pp | 100.0% (3/3 fires) PRINT | -0.17 pp | 66.7% (2/3 fires) PRINT | 42.9% n=7 | 71.4% n=7 |
| `union_e_green_h1` | factor mine | **KILL** | 11 | -0.31 pp | 100.0% (3/3 fires) PRINT | -0.06 pp | 66.7% (2/3 fires) PRINT | 54.5% n=11 | 54.5% n=11 |
| `union_e_green_h3` | factor mine | **CONDITIONAL** | 9 | -0.27 pp | 100.0% (3/3 fires) PRINT | -0.08 pp | 66.7% (2/3 fires) PRINT | 55.6% n=9 | 55.6% n=9 |
| `union_earn_react_h1` | factor mine | **KILL** | 10 | +0.57 pp | 100.0% (3/3 fires) PRINT | +0.02 pp | 66.7% (2/3 fires) PRINT | 50.0% n=10 | 70.0% n=10 |
| `union_earn_react_h3` | factor mine | **KILL** | 9 | +0.49 pp | 100.0% (3/3 fires) PRINT | -0.03 pp | 66.7% (2/3 fires) PRINT | 44.4% n=9 | 66.7% n=9 |
| `union_h1` | factor mine | **CONDITIONAL** | 5 | +6.20 pp | 100.0% (2/2 fires) PRINT | +1.01 pp | 75.0% (3/4 fires) PRINT | 80.0% n=5 | 80.0% n=5 |
| `union_h1_cut` | factor mine | **CONDITIONAL** | 5 | +6.20 pp | 100.0% (2/2 fires) PRINT | +1.01 pp | 75.0% (3/4 fires) PRINT | 80.0% n=5 | 80.0% n=5 |
| `union_h1_half` | factor mine | **CONDITIONAL** | 5 | +6.13 pp | 100.0% (2/2 fires) PRINT | +1.12 pp | 75.0% (3/4 fires) PRINT | 80.0% n=5 | 80.0% n=5 |
| `union_h1_rankw` | factor mine | **CONDITIONAL** | 5 | +6.13 pp | 100.0% (2/2 fires) PRINT | +1.12 pp | 75.0% (3/4 fires) PRINT | 80.0% n=5 | 80.0% n=5 |
| `union_h1_sboost` | factor mine | **CONDITIONAL** | 5 | +6.20 pp | 100.0% (2/2 fires) PRINT | +1.01 pp | 75.0% (3/4 fires) PRINT | 80.0% n=5 | 80.0% n=5 |
| `union_h1_sizeup` | factor mine | **CONDITIONAL** | 5 | +6.20 pp | 100.0% (2/2 fires) PRINT | +1.01 pp | 75.0% (3/4 fires) PRINT | 80.0% n=5 | 80.0% n=5 |
| `union_h1_time` | factor mine | **CONDITIONAL** | 6 | +6.11 pp | 66.7% (2/3 fires) PRINT | +1.01 pp | 75.0% (3/4 fires) PRINT | 66.7% n=6 | 66.7% n=6 |
| `union_h1_topheavy` | factor mine | **CONDITIONAL** | 5 | +6.13 pp | 100.0% (2/2 fires) PRINT | +1.12 pp | 75.0% (3/4 fires) PRINT | 80.0% n=5 | 80.0% n=5 |
| `union_h1_trail` | factor mine | **CONDITIONAL** | 5 | +6.20 pp | 100.0% (2/2 fires) PRINT | +1.01 pp | 75.0% (3/4 fires) PRINT | 80.0% n=5 | 80.0% n=5 |
| `union_h3` | factor mine | **KILL** | 14 | +0.70 pp | 66.7% (4/6 fires) PRINT | -0.12 pp | 50.0% (4/8 fires) FAIL | 35.7% n=14 | 42.9% n=14 |
| `union_h3_cut` | factor mine | **KILL** | 14 | +0.70 pp | 66.7% (4/6 fires) PRINT | -0.12 pp | 50.0% (4/8 fires) FAIL | 35.7% n=14 | 42.9% n=14 |
| `union_h3_exit_alarm` | factor mine | **KILL** | 14 | +1.08 pp | 57.1% (4/7 fires) PRINT | -0.12 pp | 44.4% (4/9 fires) FAIL | 42.9% n=14 | 50.0% n=14 |
| `union_h3_exit_news_r` | factor mine | **KILL** | 13 | +1.04 pp | 71.4% (5/7 fires) PRINT | +0.04 pp | 55.6% (5/9 fires) CLEAR | 38.5% n=13 | 46.2% n=13 |
| `union_h3_exit_red` | factor mine | **CONDITIONAL** | 7 | +4.73 pp | 66.7% (2/3 fires) PRINT | +1.35 pp | 66.7% (4/6 fires) PRINT | 42.9% n=7 | 42.9% n=7 |
| `union_h3_half` | factor mine | **CONDITIONAL** | 5 | +6.13 pp | 100.0% (2/2 fires) PRINT | +1.12 pp | 75.0% (3/4 fires) PRINT | 80.0% n=5 | 80.0% n=5 |
| `union_h3_rankw` | factor mine | **KILL** | 13 | +0.72 pp | 57.1% (4/7 fires) PRINT | -0.19 pp | 37.5% (3/8 fires) FAIL | 38.5% n=13 | 46.2% n=13 |
| `union_h3_sboost` | factor mine | **KILL** | 14 | +0.78 pp | 57.1% (4/7 fires) PRINT | -0.08 pp | 44.4% (4/9 fires) FAIL | 35.7% n=14 | 42.9% n=14 |
| `union_h3_sizeup` | factor mine | **KILL** | 14 | +0.70 pp | 66.7% (4/6 fires) PRINT | -0.12 pp | 50.0% (4/8 fires) FAIL | 35.7% n=14 | 42.9% n=14 |
| `union_h3_time` | factor mine | **CONDITIONAL** | 5 | +5.36 pp | 66.7% (2/3 fires) PRINT | +1.24 pp | 75.0% (3/4 fires) PRINT | 60.0% n=5 | 60.0% n=5 |
| `union_h3_topheavy` | factor mine | **CONDITIONAL** | 14 | +0.92 pp | 71.4% (5/7 fires) PRINT | +0.53 pp | 50.0% (4/8 fires) FAIL | 35.7% n=14 | 42.9% n=14 |
| `union_h3_trail` | factor mine | **KILL** | 14 | +0.70 pp | 66.7% (4/6 fires) PRINT | -0.12 pp | 50.0% (4/8 fires) FAIL | 35.7% n=14 | 42.9% n=14 |
| `union_h5` | factor mine | **CONDITIONAL** | 4 | +8.85 pp | 100.0% (2/2 fires) PRINT | +0.98 pp | 75.0% (3/4 fires) PRINT | 100.0% n=4 | 100.0% n=4 |
| `union_h5_cut` | factor mine | **CONDITIONAL** | 4 | +8.85 pp | 100.0% (2/2 fires) PRINT | +0.98 pp | 75.0% (3/4 fires) PRINT | 100.0% n=4 | 100.0% n=4 |
| `union_h5_exit_alarm` | factor mine | **KILL** | 4 | +8.48 pp | 100.0% (2/2 fires) PRINT | +1.33 pp | 75.0% (3/4 fires) PRINT | 100.0% n=4 | 100.0% n=4 |
| `union_h5_half` | factor mine | **CONDITIONAL** | 4 | +8.51 pp | 100.0% (2/2 fires) PRINT | +1.31 pp | 75.0% (3/4 fires) PRINT | 100.0% n=4 | 100.0% n=4 |
| `union_h5_rankw` | factor mine | **CONDITIONAL** | 4 | +8.78 pp | 100.0% (2/2 fires) PRINT | +1.08 pp | 75.0% (3/4 fires) PRINT | 100.0% n=4 | 100.0% n=4 |
| `union_h5_sboost` | factor mine | **CONDITIONAL** | 4 | +8.85 pp | 100.0% (2/2 fires) PRINT | +0.98 pp | 75.0% (3/4 fires) PRINT | 100.0% n=4 | 100.0% n=4 |
| `union_h5_sizeup` | factor mine | **CONDITIONAL** | 4 | +8.85 pp | 100.0% (2/2 fires) PRINT | +0.98 pp | 75.0% (3/4 fires) PRINT | 100.0% n=4 | 100.0% n=4 |
| `union_h5_time` | factor mine | **CONDITIONAL** | 5 | +6.38 pp | 100.0% (2/2 fires) PRINT | +0.92 pp | 75.0% (3/4 fires) PRINT | 80.0% n=5 | 80.0% n=5 |
| `union_h5_topheavy` | factor mine | **KILL** | 4 | +8.48 pp | 100.0% (2/2 fires) PRINT | +1.33 pp | 75.0% (3/4 fires) PRINT | 100.0% n=4 | 100.0% n=4 |
| `union_h5_trail` | factor mine | **CONDITIONAL** | 4 | +8.85 pp | 100.0% (2/2 fires) PRINT | +0.98 pp | 75.0% (3/4 fires) PRINT | 100.0% n=4 | 100.0% n=4 |
| `union_hot_n12_h1` | factor mine | **CONDITIONAL** | 17 | +1.30 pp | 100.0% (3/3 fires) PRINT | +0.58 pp | 75.0% (3/4 fires) PRINT | 76.5% n=17 | 64.7% n=17 |
| `union_hot_n4_h1` | factor mine | **KILL** | 11 | +1.46 pp | 100.0% (7/7 fires) PRINT | +0.83 pp | 77.8% (7/9 fires) CLEAR | 72.7% n=11 | 54.5% n=11 |
| `union_hot_score_h1` | factor mine | **CONDITIONAL** | 11 | +1.75 pp | 100.0% (3/3 fires) PRINT | +0.85 pp | 75.0% (3/4 fires) PRINT | 81.8% n=11 | 72.7% n=11 |
| `union_hot_score_h3` | factor mine | **CONDITIONAL** | 10 | +1.91 pp | 100.0% (3/3 fires) PRINT | +0.87 pp | 75.0% (3/4 fires) PRINT | 80.0% n=10 | 70.0% n=10 |
| `union_join_g_h1` | factor mine | **KILL** | 4 | +0.90 pp | 50.0% (1/2 fires) FAIL | +0.17 pp | 75.0% (3/4 fires) PRINT | 75.0% n=4 | 75.0% n=4 |
| `union_join_g_h3` | factor mine | **KILL** | 3 | +1.14 pp | 50.0% (1/2 fires) FAIL | +0.38 pp | 75.0% (3/4 fires) PRINT | 66.7% n=3 | 66.7% n=3 |
| `union_join_present_h1` | factor mine | **CONDITIONAL** | 5 | +6.20 pp | 100.0% (2/2 fires) PRINT | +1.01 pp | 75.0% (3/4 fires) PRINT | 80.0% n=5 | 80.0% n=5 |
| `union_join_present_h3` | factor mine | **KILL** | 13 | +1.04 pp | 71.4% (5/7 fires) PRINT | +0.04 pp | 55.6% (5/9 fires) CLEAR | 38.5% n=13 | 46.2% n=13 |
...
| `union_last_green_h1` | factor mine | **CONDITIONAL** | 7 | +4.86 pp | 100.0% (2/2 fires) PRINT | +1.36 pp | 75.0% (3/4 fires) PRINT | 85.7% n=7 | 85.7% n=7 |
| `union_last_green_h3` | factor mine | **CONDITIONAL** | 7 | +4.73 pp | 66.7% (2/3 fires) PRINT | +1.35 pp | 66.7% (4/6 fires) PRINT | 42.9% n=7 | 42.9% n=7 |
| `union_last_green_h5` | factor mine | **CONDITIONAL** | 6 | +6.41 pp | 100.0% (2/2 fires) PRINT | +1.40 pp | 75.0% (3/4 fires) PRINT | 100.0% n=6 | 100.0% n=6 |
| `union_last_red_h1` | factor mine | **CONDITIONAL** | 3 | -0.40 pp | 33.3% (1/3 fires) FAIL | +0.27 pp | 75.0% (3/4 fires) PRINT | 33.3% n=3 | 0.0% n=3 |
| `union_last_red_h3` | factor mine | **KILL** | 1 | +0.85 pp | 0.0% (0/1 fires) FAIL | +0.50 pp | 100.0% (3/3 fires) PRINT | 100.0% n=1 | 0.0% n=1 |
| `union_news_g_h1` | factor mine | **CONDITIONAL** | 5 | +1.07 pp | 100.0% (2/2 fires) PRINT | +0.23 pp | 33.3% (1/3 fires) FAIL | 80.0% n=5 | 80.0% n=5 |
| `union_news_g_h3` | factor mine | **CONDITIONAL** | 10 | +1.76 pp | 75.0% (3/4 fires) PRINT | +0.58 pp | 42.9% (3/7 fires) FAIL | 80.0% n=10 | 90.0% n=10 |
| `union_news_g_h5` | factor mine | **CONDITIONAL** | 9 | +1.74 pp | 50.0% (2/4 fires) FAIL | +0.32 pp | 28.6% (2/7 fires) FAIL | 77.8% n=9 | 88.9% n=9 |
| `union_news_missing_h1` | factor mine | **null** | 2 | +3.76 pp | 100.0% (1/1 fires) PRINT | +0.55 pp | 100.0% (1/1 fires) PRINT | 100.0% n=2 | 100.0% n=2 |
| `union_news_missing_h3` | factor mine | **null** | 2 | +3.76 pp | 100.0% (1/1 fires) PRINT | +0.55 pp | 100.0% (1/1 fires) PRINT | 100.0% n=2 | 100.0% n=2 |
| `union_news_present_h1` | factor mine | **CONDITIONAL** | 7 | +3.29 pp | 66.7% (2/3 fires) PRINT | +0.85 pp | 75.0% (3/4 fires) PRINT | 42.9% n=7 | 42.9% n=7 |
| `union_news_present_h3` | factor mine | **CONDITIONAL** | 4 | +7.14 pp | 100.0% (1/1 fires) PRINT | +1.04 pp | 66.7% (2/3 fires) PRINT | 75.0% n=4 | 75.0% n=4 |
| `union_news_vol_h1` | factor mine | **KILL** | 8 | +2.33 pp | 75.0% (3/4 fires) PRINT | +0.03 pp | 60.0% (3/5 fires) PRINT | 75.0% n=8 | 75.0% n=8 |
| `union_news_vol_h3` | factor mine | **KILL** | 7 | +1.98 pp | 66.7% (2/3 fires) PRINT | +0.28 pp | 60.0% (3/5 fires) PRINT | 71.4% n=7 | 71.4% n=7 |
| `union_r_up_h1` | factor mine | **null** | 0 | — | n_fires=0  | — | n_fires=0  | — | — |
| `union_r_up_h3` | factor mine | **null** | 0 | — | n_fires=0  | — | n_fires=0  | — | — |
| `union_ret_5_h1` | factor mine | **CONDITIONAL** | 12 | +0.39 pp | 33.3% (1/3 fires) FAIL | +1.02 pp | 75.0% (3/4 fires) PRINT | 75.0% n=12 | 66.7% n=12 |
| `union_ret_5_h3` | factor mine | **CONDITIONAL** | 12 | +0.36 pp | 33.3% (1/3 fires) FAIL | +1.14 pp | 75.0% (3/4 fires) PRINT | 75.0% n=12 | 66.7% n=12 |
...
| `union_vol_g_h1` | factor mine | **CONDITIONAL** | 4 | +6.72 pp | 50.0% (1/2 fires) FAIL | +1.13 pp | 66.7% (2/3 fires) PRINT | 50.0% n=4 | 50.0% n=4 |
| `union_vol_g_h3` | factor mine | **KILL** | 4 | +7.24 pp | 50.0% (1/2 fires) FAIL | +1.15 pp | 66.7% (2/3 fires) PRINT | 50.0% n=4 | 50.0% n=4 |
| `union_vol_g_h5` | factor mine | **CONDITIONAL** | 3 | +8.31 pp | 50.0% (1/2 fires) FAIL | +1.19 pp | 66.7% (2/3 fires) PRINT | 33.3% n=3 | 33.3% n=3 |
| `union_vol_green_h1` | factor mine | **CONDITIONAL** | 4 | +8.17 pp | 50.0% (1/2 fires) FAIL | +0.67 pp | 100.0% (3/3 fires) PRINT | 50.0% n=4 | 50.0% n=4 |
| `union_vol_green_h3` | factor mine | **CONDITIONAL** | 4 | +8.47 pp | 50.0% (1/2 fires) FAIL | +0.64 pp | 66.7% (2/3 fires) PRINT | 50.0% n=4 | 50.0% n=4 |
| `union_vol_missing_h1` | factor mine | **null** | 0 | — | n_fires=0  | — | n_fires=0  | — | — |
| `union_vol_missing_h3` | factor mine | **null** | 0 | — | n_fires=0  | — | n_fires=0  | — | — |
| `union_w_hot_candle_h1` | factor mine | **CONDITIONAL** | 11 | +2.17 pp | 100.0% (3/3 fires) PRINT | +0.83 pp | 75.0% (3/4 fires) PRINT | 81.8% n=11 | 72.7% n=11 |
| `union_w_hot_candle_h3` | factor mine | **CONDITIONAL** | 11 | +1.57 pp | 100.0% (3/3 fires) PRINT | +0.12 pp | 66.7% (2/3 fires) PRINT | 81.8% n=11 | 72.7% n=11 |
| `union_w_hot_cond_h1` | factor mine | **CONDITIONAL** | 7 | +2.29 pp | 100.0% (3/3 fires) PRINT | +0.93 pp | 75.0% (3/4 fires) PRINT | 85.7% n=7 | 71.4% n=7 |
| `union_w_hot_cond_h3` | factor mine | **CONDITIONAL** | 5 | +3.01 pp | 100.0% (3/3 fires) PRINT | +1.10 pp | 75.0% (3/4 fires) PRINT | 100.0% n=5 | 80.0% n=5 |
| `union_white_coil_h1` | factor mine | **CONDITIONAL** | 2 | +2.67 pp | 100.0% (1/1 fires) PRINT | +0.73 pp | 100.0% (3/3 fires) PRINT | 100.0% n=2 | 100.0% n=2 |
| `union_white_coil_h3` | factor mine | **CONDITIONAL** | 2 | +2.61 pp | 100.0% (1/1 fires) PRINT | +0.81 pp | 100.0% (2/2 fires) PRINT | 100.0% n=2 | 100.0% n=2 |
| `union_white_h1` | factor mine | **CONDITIONAL** | 1 | +3.46 pp | 0.0% (0/1 fires) FAIL | +1.05 pp | 100.0% (3/3 fires) PRINT | 100.0% n=1 | 100.0% n=1 |
| `union_white_h3` | factor mine | **KILL** | 1 | +3.57 pp | 0.0% (0/1 fires) FAIL | +1.16 pp | 100.0% (3/3 fires) PRINT | 100.0% n=1 | 100.0% n=1 |
| `union_white_h5` | factor mine | **CONDITIONAL** | 0 | — | n_fires=0 null | +0.81 pp | 100.0% (3/3 fires) PRINT | — | — |
| `yday_gainer_h1` | factor mine | **CONDITIONAL** | 2 | +17.66 pp | 100.0% (1/1 fires) PRINT | +1.25 pp | 100.0% (3/3 fires) PRINT | 50.0% n=2 | 50.0% n=2 |
| `yday_gainer_h3` | factor mine | **CONDITIONAL** | 2 | +17.97 pp | 100.0% (1/1 fires) PRINT | +1.90 pp | 100.0% (3/3 fires) PRINT | 50.0% n=2 | 50.0% n=2 |
| `yday_gainer_h5` | factor mine | **CONDITIONAL** | 2 | +18.04 pp | 100.0% (1/1 fires) PRINT | +1.19 pp | 100.0% (3/3 fires) PRINT | 50.0% n=2 | 50.0% n=2 |
| `green_book_prior` | stock book | **KILL** | 61 | -0.39 pp | 37.5% (3/8 fires) FAIL | -0.37 pp | 37.5% (3/8 fires) FAIL | 39.3% n=61 | 31.1% n=61 |
| `green_pile_prior` | stock book | **KILL** | 50 | +0.20 pp | 50.0% (4/8 fires) FAIL | +0.14 pp | 62.5% (5/8 fires) CLEAR | 44.0% n=50 | 36.0% n=50 |
| `weighted_book_1d_prior` | stock book | **CONDITIONAL** | 37 | +0.49 pp | 75.0% (6/8 fires) CLEAR | +0.06 pp | 66.7% (2/3 fires) PRINT | 51.4% n=37 | 45.9% n=37 |
| `unweighted_book_prior` | stock book | **KILL** | 61 | -0.39 pp | 37.5% (3/8 fires) FAIL | -0.37 pp | 37.5% (3/8 fires) FAIL | 39.3% n=61 | 31.1% n=61 |
| `1d_size` | .io paper | **CONDITIONAL** | 8 | +1.95 pp | 100.0% (2/2 fires) PRINT | +0.72 pp | 100.0% (6/6 fires) PRINT | 75.0% n=8 | 87.5% n=8 |
| `1d_top` | .io paper | **CONDITIONAL** | 12 | +0.81 pp | 100.0% (3/3 fires) PRINT | +0.17 pp | 50.0% (3/6 fires) FAIL | 75.0% n=12 | 50.0% n=12 |
| `1m_size` | .io paper | **null** | 4 | -0.84 pp | 100.0% (1/1 fires) PRINT | -0.44 pp | 0.0% (0/1 fires) FAIL | 25.0% n=4 | 25.0% n=4 |
| `1m_top` | .io paper | **null** | 9 | -0.17 pp | 0.0% (0/1 fires) FAIL | -0.46 pp | 0.0% (0/3 fires) FAIL | 33.3% n=9 | 44.4% n=9 |
| `1w_size` | .io paper | **KILL** | 6 | +2.05 pp | 100.0% (2/2 fires) PRINT | -0.09 pp | 40.0% (2/5 fires) FAIL | 100.0% n=6 | 100.0% n=6 |
| `1w_top` | .io paper | **KILL** | 5 | +0.70 pp | 100.0% (2/2 fires) PRINT | -0.14 pp | 50.0% (2/4 fires) FAIL | 100.0% n=5 | 60.0% n=5 |
| `2w_size` | .io paper | **CONDITIONAL** | 10 | +1.45 pp | 66.7% (2/3 fires) PRINT | +0.23 pp | 40.0% (2/5 fires) FAIL | 60.0% n=10 | 60.0% n=10 |
| `2w_top` | .io paper | **null** | 13 | -0.29 pp | 50.0% (1/2 fires) FAIL | -0.25 pp | 50.0% (1/2 fires) FAIL | 53.8% n=13 | 46.2% n=13 |
| `3d_size` | .io paper | **CONDITIONAL** | 9 | +2.31 pp | 100.0% (3/3 fires) PRINT | -0.07 pp | 33.3% (2/6 fires) FAIL | 100.0% n=9 | 100.0% n=9 |
| `3d_top` | .io paper | **CONDITIONAL** | 9 | +1.32 pp | 66.7% (2/3 fires) PRINT | +0.05 pp | 40.0% (2/5 fires) FAIL | 100.0% n=9 | 77.8% n=9 |
...
| `book_paper_1w` | book paper | **CONDITIONAL** | 5 | +1.12 pp | 100.0% (1/1 fires) PRINT | +0.24 pp | 50.0% (1/2 fires) FAIL | 100.0% n=5 | 60.0% n=5 |
| `mover_paper_live` | mover stitch | **KILL** | 11 | +0.25 pp | 100.0% (3/3 fires) PRINT | +0.06 pp | 66.7% (2/3 fires) PRINT | 45.5% n=11 | 36.4% n=11 |
...
`JOIN_POST_813.md` tip `d2df1e99` · PR #153. Gate: `OPEN_SAME_ROW_LABELS.md` / `CLOCK_MAP.md`. Research only. Live frozen.
