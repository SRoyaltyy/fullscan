...
| 3 | SR | +16 | 17 | 1 | 2026-09-04→2026-09-08 | Utilities - Regulated Gas |
| 4 | ANET | +16 | 18 | 2 | 2026-09-10→2026-09-11 | Computer Hardware |
...
| 9 | WDS | +16 | 16 | 0 | 2026-09-10→2026-09-11 | Oil & Gas E&P |
| 10 | BMRN | +16 | 17 | 1 | 2026-09-10→2026-09-11 | Biotechnology |
| 11 | CORT | +15 | 16 | 1 | 2026-09-04→2026-09-08 | Biotechnology |
| 12 | HASI | +15 | 15 | 0 | 2026-09-04→2026-09-08 | Asset Management |
| 13 | CXW | +15 | 17 | 2 | 2026-09-10→2026-09-11 | Security & Protection Services |
| 14 | SFL | +15 | 16 | 1 | 2026-09-10→2026-09-11 | Marine Shipping |
...
| `B08_target_price_delta` | delta=0.23000000000000398 (now=92.56 vs prior_export=92.33 on finviz_2026-09-20) | **GOOD** |
...
| `B11_insider_tx_delta` | delta=-0.13000000000000034 (now=-3.22 vs prior=-3.09 on finviz_2026-09-20) | **BAD** |
...
| `B08_target_price_delta` | delta=0.0 (now=141.0 vs prior_export=141.0 on finviz_2026-09-20) | **NEUTRAL** |
| `B09_analyst_recom` | 1.86 | **GOOD** |
| `B10_insider_transactions` | -6.62 | **BAD** |
| `B11_insider_tx_delta` | delta=0.0 (now=-6.62 vs prior=-6.62 on finviz_2026-09-20) | **NEUTRAL** |
| `B12_institutional_transactions` | 2.41 | **GOOD** |
| `B13_short_float` | 9.81 | **NEUTRAL** |
| `B14_earnings_date` | 7/29/2026 4:30:00 PM | **NEUTRAL** |
| `B17_eps_surprise_pair` | last2 EPS surprises: current=1381.48 (this export) | prior_export=1381.48 (finviz_2026-09-20) | GOOD if latest beat (and better if both beat) | **GOOD** |
| `B18_rev_surprise_pair` | last2 Revenue surprises: current=15.83 (this export) | prior_export=15.83 (finviz_2026-09-20) | GOOD if latest beat (and better if both beat) | **GOOD** |
...
| `B08_target_price_delta` | delta=0.0 (now=49.33 vs prior_export=49.33 on finviz_2026-09-20) | **NEUTRAL** |
...
| `B14_earnings_date` | 8/6/2026 4:30:00 PM | **NEUTRAL** |
| `B17_eps_surprise_pair` | last2 EPS surprises: current=2.66 (this export) | prior_export=2.66 (finviz_2026-09-20) | GOOD if latest beat (and better if both beat) | **GOOD** |
| `B18_rev_surprise_pair` | last2 Revenue surprises: current=7.9 (this export) | prior_export=7.9 (finviz_2026-09-20) | GOOD if latest beat (and better if both beat) | **GOOD** |
...
| `B11_insider_tx_delta` | delta=-0.05000000000000071 (now=-15.22 vs prior=-15.17 on finviz_2026-09-20) | **BAD** |
...
| `B08_target_price_delta` | delta=0.0 (now=13.32 vs prior_export=13.32 on finviz_2026-09-20) | **NEUTRAL** |
| `B09_analyst_recom` | 2.0 | **GOOD** |
| `B10_insider_transactions` | 0.0 | **NEUTRAL** |
| `B11_insider_tx_delta` | delta=0.0 (now=0.0 vs prior=0.0 on finviz_2026-09-20) | **NEUTRAL** |
...
| `B17_eps_surprise_pair` | last2 EPS surprises: current=84.93 (this export) | prior_export=84.93 (finviz_2026-09-20) | GOOD if latest beat (and better if both beat) | **GOOD** |
| `B18_rev_surprise_pair` | last2 Revenue surprises: current=11.75 (this export) | prior_export=11.75 (finviz_2026-09-20) | GOOD if latest beat (and better if both beat) | **GOOD** |
...
| `B08_target_price_delta` | delta=0.0 (now=110.33 vs prior_export=110.33 on finviz_2026-09-20) | **NEUTRAL** |
...
| `B14_earnings_date` | 8/5/2026 4:30:00 PM | **NEUTRAL** |
| `B17_eps_surprise_pair` | last2 EPS surprises: current=23.13 (this export) | prior_export=23.13 (finviz_2026-09-20) | GOOD if latest beat (and better if both beat) | **GOOD** |
| `B18_rev_surprise_pair` | last2 Revenue surprises: current=12.76 (this export) | prior_export=12.76 (finviz_2026-09-20) | GOOD if latest beat (and better if both beat) | **GOOD** |
