...
| 2 | DSGX | +16 | 17 | 1 | 2026-09-10→2026-09-11 | Software - Application |
| 3 | WWW | +16 | 18 | 2 | 2026-09-10→2026-09-11 | Footwear & Accessories |
| 4 | SM | +16 | 17 | 1 | 2026-09-10→2026-09-11 | Oil & Gas E&P |
| 5 | SKM | +16 | 16 | 0 | 2026-09-04→2026-09-08 | Telecom Services |
| 6 | ANET | +16 | 18 | 2 | 2026-09-10→2026-09-11 | Computer Hardware |
| 7 | HSBC | +16 | 17 | 1 | 2026-09-04→2026-09-08 | Banks - Diversified |
| 8 | CXW | +16 | 17 | 1 | 2026-09-10→2026-09-11 | Security & Protection Services |
| 9 | CORT | +16 | 17 | 1 | 2026-09-04→2026-09-08 | Biotechnology |
| 10 | BMRN | +16 | 17 | 1 | 2026-09-10→2026-09-11 | Biotechnology |
| 11 | SLDE | +15 | 16 | 1 | 2026-09-10→2026-09-11 | Insurance - Property & Casualty |
| 12 | HAS | +15 | 16 | 1 | 2026-09-10→2026-09-11 | Leisure |
| 13 | RPRX | +15 | 16 | 1 | 2026-09-04→2026-09-08 | Biotechnology |
| 14 | SR | +15 | 16 | 1 | 2026-09-04→2026-09-08 | Utilities - Regulated Gas |
| 15 | ETN | +15 | 17 | 2 | 2026-09-04→2026-09-08 | Specialty Industrial Machinery |
...
| `B08_target_price_delta` | delta=0.0 (now=9.5 vs prior_export=9.5 on finviz_2026-09-22) | **NEUTRAL** |
...
| `B17_eps_surprise_pair` | last2 EPS surprises: current=11.76 (this export) | prior_export=11.76 (finviz_2026-09-22) | GOOD if latest beat (and better if both beat) | **GOOD** |
| `B18_rev_surprise_pair` | last2 Revenue surprises: current=2.57 (this export) | prior_export=2.57 (finviz_2026-09-22) | GOOD if latest beat (and better if both beat) | **GOOD** |
...
| `B08_target_price_delta` | delta=0.0 (now=101.23 vs prior_export=101.23 on finviz_2026-09-22) | **NEUTRAL** |
...
| `B17_eps_surprise_pair` | last2 EPS surprises: current=3.07 (this export) | prior_export=3.07 (finviz_2026-09-22) | GOOD if latest beat (and better if both beat) | **GOOD** |
| `B18_rev_surprise_pair` | last2 Revenue surprises: current=0.83 (this export) | prior_export=0.83 (finviz_2026-09-22) | GOOD if latest beat (and better if both beat) | **GOOD** |

### WWW  ·  score **+16**  ·  Footwear & Accessories
...
| `B08_target_price_delta` | delta=0.0 (now=24.3 vs prior_export=24.3 on finviz_2026-09-22) | **NEUTRAL** |
| `B09_analyst_recom` | 2.0 | **GOOD** |
| `B10_insider_transactions` | -4.08 | **BAD** |
| `B11_insider_tx_delta` | delta=-0.6600000000000001 (now=-4.08 vs prior=-3.42 on finviz_2026-09-22) | **BAD** |
| `B12_institutional_transactions` | 0.26 | **GOOD** |
| `B13_short_float` | 7.19 | **NEUTRAL** |
| `B14_earnings_date` | 8/13/2026 8:30:00 AM | **NEUTRAL** |
| `B17_eps_surprise_pair` | last2 EPS surprises: current=4.99 (this export) | prior_export=4.99 (finviz_2026-09-22) | GOOD if latest beat (and better if both beat) | **GOOD** |
| `B18_rev_surprise_pair` | last2 Revenue surprises: current=1.13 (this export) | prior_export=1.13 (finviz_2026-09-22) | GOOD if latest beat (and better if both beat) | **GOOD** |
...
| `B08_target_price_delta` | delta=0.6099999999999994 (now=44.17 vs prior_export=43.56 on finviz_2026-09-22) | **GOOD** |
| `B09_analyst_recom` | 2.0 | **GOOD** |
| `B10_insider_transactions` | -1.96 | **BAD** |
| `B11_insider_tx_delta` | delta=0.0 (now=-1.96 vs prior=-1.96 on finviz_2026-09-22) | **NEUTRAL** |
| `B12_institutional_transactions` | 0.44 | **GOOD** |
| `B13_short_float` | 5.43 | **NEUTRAL** |
| `B14_earnings_date` | 8/5/2026 4:30:00 PM | **NEUTRAL** |
| `B17_eps_surprise_pair` | last2 EPS surprises: current=11.53 (this export) | prior_export=11.53 (finviz_2026-09-22) | GOOD if latest beat (and better if both beat) | **GOOD** |
| `B18_rev_surprise_pair` | last2 Revenue surprises: current=23.46 (this export) | prior_export=23.46 (finviz_2026-09-22) | GOOD if latest beat (and better if both beat) | **GOOD** |
...
| `B08_target_price_delta` | delta=0.0 (now=45.14 vs prior_export=45.14 on finviz_2026-09-22) | **NEUTRAL** |
...
| `B17_eps_surprise_pair` | last2 EPS surprises: current=44.43 (this export) | prior_export=44.43 (finviz_2026-09-22) | GOOD if latest beat (and better if both beat) | **GOOD** |
| `B18_rev_surprise_pair` | last2 Revenue surprises: current=3.38 (this export) | prior_export=3.38 (finviz_2026-09-22) | GOOD if latest beat (and better if both beat) | **GOOD** |
...
| `B08_target_price_delta` | delta=0.0 (now=248.86 vs prior_export=248.86 on finviz_2026-09-22) | **NEUTRAL** |
| `B09_analyst_recom` | 1.12 | **GOOD** |
| `B10_insider_transactions` | -3.24 | **BAD** |
| `B11_insider_tx_delta` | delta=-0.020000000000000018 (now=-3.24 vs prior=-3.22 on finviz_2026-09-22) | **BAD** |
| `B12_institutional_transactions` | 0.66 | **GOOD** |
| `B13_short_float` | 1.38 | **NEUTRAL** |
| `B14_earnings_date` | 8/4/2026 4:30:00 PM | **NEUTRAL** |
| `B17_eps_surprise_pair` | last2 EPS surprises: current=15.14 (this export) | prior_export=15.14 (finviz_2026-09-22) | GOOD if latest beat (and better if both beat) | **GOOD** |
| `B18_rev_surprise_pair` | last2 Revenue surprises: current=7.26 (this export) | prior_export=7.26 (finviz_2026-09-22) | GOOD if latest beat (and better if both beat) | **GOOD** |
...
| `B08_target_price_delta` | delta=0.0 (now=108.62 vs prior_export=108.62 on finviz_2026-09-22) | **NEUTRAL** |
...
| `B17_eps_surprise_pair` | last2 EPS surprises: current=3.31 (this export) | prior_export=3.31 (finviz_2026-09-22) | GOOD if latest beat (and better if both beat) | **GOOD** |
...
| `B08_target_price_delta` | delta=0.0 (now=41.8 vs prior_export=41.8 on finviz_2026-09-22) | **NEUTRAL** |
| `B09_analyst_recom` | 1.0 | **GOOD** |
| `B10_insider_transactions` | -15.22 | **BAD** |
| `B11_insider_tx_delta` | delta=0.0 (now=-15.22 vs prior=-15.22 on finviz_2026-09-22) | **NEUTRAL** |
| `B12_institutional_transactions` | 0.08 | **GOOD** |
| `B13_short_float` | 14.97 | **NEUTRAL** |
| `B14_earnings_date` | 8/5/2026 4:30:00 PM | **NEUTRAL** |
| `B17_eps_surprise_pair` | last2 EPS surprises: current=7.56 (this export) | prior_export=7.56 (finviz_2026-09-22) | GOOD if latest beat (and better if both beat) | **GOOD** |
| `B18_rev_surprise_pair` | last2 Revenue surprises: current=10.71 (this export) | prior_export=10.71 (finviz_2026-09-22) | GOOD if latest beat (and better if both beat) | **GOOD** |
...
| `B08_target_price_delta` | delta=0.0 (now=141.0 vs prior_export=141.0 on finviz_2026-09-22) | **NEUTRAL** |
| `B09_analyst_recom` | 1.86 | **GOOD** |
| `B10_insider_transactions` | -6.61 | **BAD** |
| `B11_insider_tx_delta` | delta=0.009999999999999787 (now=-6.61 vs prior=-6.62 on finviz_2026-09-22) | **GOOD** |
| `B12_institutional_transactions` | 2.41 | **GOOD** |
| `B13_short_float` | 9.81 | **NEUTRAL** |
| `B14_earnings_date` | 7/29/2026 4:30:00 PM | **NEUTRAL** |
| `B17_eps_surprise_pair` | last2 EPS surprises: current=1381.48 (this export) | prior_export=1381.48 (finviz_2026-09-22) | GOOD if latest beat (and better if both beat) | **GOOD** |
| `B18_rev_surprise_pair` | last2 Revenue surprises: current=15.83 (this export) | prior_export=15.83 (finviz_2026-09-22) | GOOD if latest beat (and better if both beat) | **GOOD** |
...
| `B08_target_price_delta` | delta=0.0 (now=91.68 vs prior_export=91.68 on finviz_2026-09-22) | **NEUTRAL** |
| `B09_analyst_recom` | 1.6 | **GOOD** |
| `B10_insider_transactions` | -0.83 | **BAD** |
| `B11_insider_tx_delta` | delta=0.0 (now=-0.83 vs prior=-0.83 on finviz_2026-09-22) | **NEUTRAL** |
| `B12_institutional_transactions` | 1.05 | **GOOD** |
| `B13_short_float` | 5.17 | **NEUTRAL** |
| `B14_earnings_date` | 8/6/2026 4:30:00 PM | **NEUTRAL** |
| `B17_eps_surprise_pair` | last2 EPS surprises: current=26.66 (this export) | prior_export=26.66 (finviz_2026-09-22) | GOOD if latest beat (and better if both beat) | **GOOD** |
| `B18_rev_surprise_pair` | last2 Revenue surprises: current=6.19 (this export) | prior_export=6.19 (finviz_2026-09-22) | GOOD if latest beat (and better if both beat) | **GOOD** |
...
| `B08_target_price_delta` | delta=0.0 (now=26.0 vs prior_export=26.0 on finviz_2026-09-22) | **NEUTRAL** |
| `B09_analyst_recom` | 1.5 | **GOOD** |
| `B10_insider_transactions` | -11.61 | **BAD** |
| `B11_insider_tx_delta` | delta=0.0 (now=-11.61 vs prior=-11.61 on finviz_2026-09-22) | **NEUTRAL** |
| `B12_institutional_transactions` | 9.22 | **GOOD** |
| `B13_short_float` | 8.77 | **NEUTRAL** |
| `B14_earnings_date` | 7/28/2026 4:30:00 PM | **NEUTRAL** |
| `B17_eps_surprise_pair` | last2 EPS surprises: current=24.75 (this export) | prior_export=24.75 (finviz_2026-09-22) | GOOD if latest beat (and better if both beat) | **GOOD** |
| `B18_rev_surprise_pair` | last2 Revenue surprises: current=7.66 (this export) | prior_export=7.66 (finviz_2026-09-22) | GOOD if latest beat (and better if both beat) | **GOOD** |
...
| `B08_target_price_delta` | delta=0.0 (now=110.23 vs prior_export=110.23 on finviz_2026-09-22) | **NEUTRAL** |
| `B09_analyst_recom` | 1.44 | **GOOD** |
| `B10_insider_transactions` | -7.1 | **BAD** |
| `B11_insider_tx_delta` | delta=0.0 (now=-7.1 vs prior=-7.1 on finviz_2026-09-22) | **NEUTRAL** |
| `B12_institutional_transactions` | 3.18 | **GOOD** |
| `B13_short_float` | 5.14 | **NEUTRAL** |
| `B14_earnings_date` | 7/21/2026 8:30:00 AM | **NEUTRAL** |
| `B17_eps_surprise_pair` | last2 EPS surprises: current=10.67 (this export) | prior_export=10.67 (finviz_2026-09-22) | GOOD if latest beat (and better if both beat) | **GOOD** |
| `B18_rev_surprise_pair` | last2 Revenue surprises: current=6.62 (this export) | prior_export=6.62 (finviz_2026-09-22) | GOOD if latest beat (and better if both beat) | **GOOD** |
...
| `B08_target_price_delta` | delta=0.0 (now=65.71 vs prior_export=65.71 on finviz_2026-09-22) | **NEUTRAL** |
| `B09_analyst_recom` | 1.5 | **GOOD** |
| `B10_insider_transactions` | -1.64 | **BAD** |
| `B11_insider_tx_delta` | delta=0.0 (now=-1.64 vs prior=-1.64 on finviz_2026-09-22) | **NEUTRAL** |
| `B12_institutional_transactions` | 1.38 | **GOOD** |
| `B13_short_float` | 2.85 | **NEUTRAL** |
| `B14_earnings_date` | 8/5/2026 8:30:00 AM | **NEUTRAL** |
| `B17_eps_surprise_pair` | last2 EPS surprises: current=3.82 (this export) | prior_export=3.82 (finviz_2026-09-22) | GOOD if latest beat (and better if both beat) | **GOOD** |
| `B18_rev_surprise_pair` | last2 Revenue surprises: current=1.85 (this export) | prior_export=1.85 (finviz_2026-09-22) | GOOD if latest beat (and better if both beat) | **GOOD** |
...
| `B06_profitable` | True | **GOOD** |
| `B07_target_price` | 92.56 | **NEUTRAL** |
| `B08_target_price_delta` | delta=0.0 (now=92.56 vs prior_export=92.56 on finviz_2026-09-22) | **NEUTRAL** |
| `B09_analyst_recom` | 1.6 | **GOOD** |
| `B10_insider_transactions` | -0.06 | **BAD** |
| `B11_insider_tx_delta` | delta=0.0 (now=-0.06 vs prior=-0.06 on finviz_2026-09-22) | **NEUTRAL** |
| `B12_institutional_transactions` | 1.46 | **GOOD** |
| `B13_short_float` | 4.65 | **NEUTRAL** |
| `B14_earnings_date` | 8/5/2026 8:30:00 AM | **NEUTRAL** |
| `B17_eps_surprise_pair` | last2 EPS surprises: current=17.93 (this export) | prior_export=17.93 (finviz_2026-09-22) | GOOD if latest beat (and better if both beat) | **GOOD** |
| `B18_rev_surprise_pair` | last2 Revenue surprises: current=6.48 (this export) | prior_export=6.48 (finviz_2026-09-22) | GOOD if latest beat (and better if both beat) | **GOOD** |
...
| `B08_target_price_delta` | delta=0.0 (now=486.89 vs prior_export=486.89 on finviz_2026-09-22) | **NEUTRAL** |
| `B09_analyst_recom` | 1.67 | **GOOD** |
| `B10_insider_transactions` | -4.71 | **BAD** |
| `B11_insider_tx_delta` | delta=0.0 (now=-4.71 vs prior=-4.71 on finviz_2026-09-22) | **NEUTRAL** |
| `B12_institutional_transactions` | 0.19 | **GOOD** |
| `B13_short_float` | 1.86 | **NEUTRAL** |
| `B14_earnings_date` | 7/31/2026 8:30:00 AM | **NEUTRAL** |
| `B17_eps_surprise_pair` | last2 EPS surprises: current=2.53 (this export) | prior_export=2.53 (finviz_2026-09-22) | GOOD if latest beat (and better if both beat) | **GOOD** |
| `B18_rev_surprise_pair` | last2 Revenue surprises: current=4.61 (this export) | prior_export=4.61 (finviz_2026-09-22) | GOOD if latest beat (and better if both beat) | **GOOD** |
