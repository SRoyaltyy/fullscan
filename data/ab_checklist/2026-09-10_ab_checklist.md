...
| 6 | SR | +15 | 16 | 1 | 2026-09-04→2026-09-08 | Utilities - Regulated Gas |
| 7 | MMSI | +15 | 17 | 2 | 2026-09-04→2026-09-08 | Medical Instruments & Supplies |
| 8 | ETN | +15 | 17 | 2 | 2026-09-04→2026-09-08 | Specialty Industrial Machinery |
| 9 | CDNA | +15 | 16 | 1 | 2026-09-04→2026-09-08 | Diagnostics & Research |
| 10 | KO | +15 | 16 | 1 | 2026-09-04→2026-09-08 | Beverages - Non-Alcoholic |
| 11 | VCTR | +15 | 15 | 0 | 2026-09-04→2026-09-08 | Asset Management |
| 12 | CORT | +15 | 16 | 1 | 2026-09-04→2026-09-08 | Biotechnology |
| 13 | SHEL | +15 | 17 | 2 | 2026-09-04→2026-09-08 | Oil & Gas Integrated |
| 14 | ALB | +15 | 16 | 1 | 2026-09-04→2026-09-08 | Specialty Chemicals |
...
| `B08_target_price_delta` | delta=0.0 (now=54.14 vs prior_export=54.14 on finviz_2026-09-09) | **NEUTRAL** |
| `B09_analyst_recom` | 1.75 | **GOOD** |
| `B10_insider_transactions` | -6.96 | **BAD** |
| `B11_insider_tx_delta` | delta=0.0 (now=-6.96 vs prior=-6.96 on finviz_2026-09-09) | **NEUTRAL** |
| `B12_institutional_transactions` | 0.91 | **GOOD** |
| `B13_short_float` | 12.31 | **NEUTRAL** |
| `B14_earnings_date` | 7/30/2026 4:30:00 PM | **NEUTRAL** |
| `B17_eps_surprise_pair` | last2 EPS surprises: current=59.41 (this export) | prior_export=59.41 (finviz_2026-09-09) | GOOD if latest beat (and better if both beat) | **GOOD** |
| `B18_rev_surprise_pair` | last2 Revenue surprises: current=15.69 (this export) | prior_export=15.69 (finviz_2026-09-09) | GOOD if latest beat (and better if both beat) | **GOOD** |
...
| `B08_target_price_delta` | delta=0.0 (now=110.33 vs prior_export=110.33 on finviz_2026-09-09) | **NEUTRAL** |
...
| `B17_eps_surprise_pair` | last2 EPS surprises: current=23.13 (this export) | prior_export=23.13 (finviz_2026-09-09) | GOOD if latest beat (and better if both beat) | **GOOD** |
| `B18_rev_surprise_pair` | last2 Revenue surprises: current=12.76 (this export) | prior_export=12.76 (finviz_2026-09-09) | GOOD if latest beat (and better if both beat) | **GOOD** |
