# A+B1 Feature Checklist — 2026-09-15

- Gate: Market Cap > $80M · ADV > 500,000 shares → **2,652** names
- Export: `finviz_2026-09-15.csv` · prior export for Δ: `2026-09-14`
...
|-----:|--------|------:|-----:|----:|------|----------|
| 1 | ANET | +17 | 18 | 1 | 2026-09-10→2026-09-11 | Computer Hardware |
| 2 | PAYS | +17 | 18 | 1 | 2026-09-10→2026-09-11 | Software - Infrastructure |
| 3 | WWW | +17 | 18 | 1 | 2026-09-10→2026-09-11 | Footwear & Accessories |
| 4 | CFFN | +17 | 17 | 0 | 2026-09-04→2026-09-08 | Banks - Regional |
| 5 | SR | +16 | 17 | 1 | 2026-09-04→2026-09-08 | Utilities - Regulated Gas |
| 6 | DSGX | +16 | 17 | 1 | 2026-09-10→2026-09-11 | Software - Application |
| 7 | NTAP | +16 | 18 | 2 | 2026-09-10→2026-09-11 | Software - Infrastructure |
| 8 | ETN | +16 | 18 | 2 | 2026-09-04→2026-09-08 | Specialty Industrial Machinery |
| 9 | HSBC | +16 | 17 | 1 | 2026-09-04→2026-09-08 | Banks - Diversified |
| 10 | WDS | +16 | 16 | 0 | 2026-09-10→2026-09-11 | Oil & Gas E&P |
| 11 | SKM | +16 | 16 | 0 | 2026-09-04→2026-09-08 | Telecom Services |
| 12 | JCI | +16 | 18 | 2 | 2026-09-10→2026-09-11 | Building Products & Equipment |
| 13 | CXW | +16 | 17 | 1 | 2026-09-10→2026-09-11 | Security & Protection Services |
| 14 | MMSI | +15 | 17 | 2 | 2026-09-04→2026-09-08 | Medical Instruments & Supplies |
| 15 | NWBI | +15 | 16 | 1 | 2026-09-04→2026-09-08 | Banks - Regional |
...
| `B08_target_price_delta` | delta=0.0 (now=248.86 vs prior_export=248.86 on finviz_2026-09-14) | **NEUTRAL** |
| `B09_analyst_recom` | 1.09 | **GOOD** |
| `B10_insider_transactions` | -3.11 | **BAD** |
| `B11_insider_tx_delta` | delta=0.0 (now=-3.11 vs prior=-3.11 on finviz_2026-09-14) | **NEUTRAL** |
| `B12_institutional_transactions` | 0.65 | **GOOD** |
| `B13_short_float` | 1.38 | **NEUTRAL** |
| `B14_earnings_date` | 8/4/2026 4:30:00 PM | **NEUTRAL** |
| `B17_eps_surprise_pair` | last2 EPS surprises: current=15.14 (this export) | prior_export=15.14 (finviz_2026-09-14) | GOOD if latest beat (and better if both beat) | **GOOD** |
| `B18_rev_surprise_pair` | last2 Revenue surprises: current=7.26 (this export) | prior_export=7.26 (finviz_2026-09-14) | GOOD if latest beat (and better if both beat) | **GOOD** |

### PAYS  ·  score **+17**  ·  Software - Infrastructure
...
| `B08_target_price_delta` | delta=0.40000000000000036 (now=13.5 vs prior_export=13.1 on finviz_2026-09-14) | **GOOD** |
| `B09_analyst_recom` | 1.0 | **GOOD** |
| `B10_insider_transactions` | -3.91 | **BAD** |
| `B11_insider_tx_delta` | delta=0.5899999999999999 (now=-3.91 vs prior=-4.5 on finviz_2026-09-14) | **GOOD** |
| `B12_institutional_transactions` | 14.18 | **GOOD** |
| `B13_short_float` | 3.98 | **NEUTRAL** |
| `B14_earnings_date` | 8/5/2026 4:30:00 PM | **NEUTRAL** |
| `B17_eps_surprise_pair` | last2 EPS surprises: current=83.33 (this export) | prior_export=83.33 (finviz_2026-09-14) | GOOD if latest beat (and better if both beat) | **GOOD** |
| `B18_rev_surprise_pair` | last2 Revenue surprises: current=7.18 (this export) | prior_export=7.18 (finviz_2026-09-14) | GOOD if latest beat (and better if both beat) | **GOOD** |
...
| `B08_target_price_delta` | delta=0.0 (now=24.3 vs prior_export=24.3 on finviz_2026-09-14) | **NEUTRAL** |
| `B09_analyst_recom` | 2.0 | **GOOD** |
| `B10_insider_transactions` | -3.42 | **BAD** |
| `B11_insider_tx_delta` | delta=0.0 (now=-3.42 vs prior=-3.42 on finviz_2026-09-14) | **NEUTRAL** |
| `B12_institutional_transactions` | 0.26 | **GOOD** |
| `B13_short_float` | 7.22 | **NEUTRAL** |
| `B14_earnings_date` | 8/13/2026 8:30:00 AM | **NEUTRAL** |
| `B17_eps_surprise_pair` | last2 EPS surprises: current=4.99 (this export) | prior_export=4.99 (finviz_2026-09-14) | GOOD if latest beat (and better if both beat) | **GOOD** |
| `B18_rev_surprise_pair` | last2 Revenue surprises: current=1.13 (this export) | prior_export=1.13 (finviz_2026-09-14) | GOOD if latest beat (and better if both beat) | **GOOD** |
...
| `B08_target_price_delta` | delta=0.0 (now=9.5 vs prior_export=9.5 on finviz_2026-09-14) | **NEUTRAL** |
| `B09_analyst_recom` | 2.33 | **GOOD** |
| `B10_insider_transactions` | 0.0 | **NEUTRAL** |
| `B11_insider_tx_delta` | delta=0.0 (now=0.0 vs prior=0.0 on finviz_2026-09-14) | **NEUTRAL** |
| `B12_institutional_transactions` | 0.7 | **GOOD** |
| `B13_short_float` | 5.67 | **NEUTRAL** |
| `B14_earnings_date` | 7/29/2026 8:30:00 AM | **NEUTRAL** |
| `B17_eps_surprise_pair` | last2 EPS surprises: current=11.76 (this export) | prior_export=11.76 (finviz_2026-09-14) | GOOD if latest beat (and better if both beat) | **GOOD** |
| `B18_rev_surprise_pair` | last2 Revenue surprises: current=2.57 (this export) | prior_export=2.57 (finviz_2026-09-14) | GOOD if latest beat (and better if both beat) | **GOOD** |

### SR  ·  score **+16**  ·  Utilities - Regulated Gas
...
| `B08_target_price_delta` | delta=0.23000000000000398 (now=92.67 vs prior_export=92.44 on finviz_2026-09-14) | **GOOD** |
| `B09_analyst_recom` | 1.6 | **GOOD** |
| `B10_insider_transactions` | -0.06 | **BAD** |
| `B11_insider_tx_delta` | delta=0.0 (now=-0.06 vs prior=-0.06 on finviz_2026-09-14) | **NEUTRAL** |
| `B12_institutional_transactions` | 1.3 | **GOOD** |
| `B13_short_float` | 4.65 | **NEUTRAL** |
| `B14_earnings_date` | 8/5/2026 8:30:00 AM | **NEUTRAL** |
| `B17_eps_surprise_pair` | last2 EPS surprises: current=17.93 (this export) | prior_export=17.93 (finviz_2026-09-14) | GOOD if latest beat (and better if both beat) | **GOOD** |
| `B18_rev_surprise_pair` | last2 Revenue surprises: current=6.48 (this export) | prior_export=6.48 (finviz_2026-09-14) | GOOD if latest beat (and better if both beat) | **GOOD** |
...
| `B08_target_price_delta` | delta=0.0 (now=101.75 vs prior_export=101.75 on finviz_2026-09-14) | **NEUTRAL** |
...
| `B17_eps_surprise_pair` | last2 EPS surprises: current=3.07 (this export) | prior_export=3.07 (finviz_2026-09-14) | GOOD if latest beat (and better if both beat) | **GOOD** |
| `B18_rev_surprise_pair` | last2 Revenue surprises: current=0.83 (this export) | prior_export=0.83 (finviz_2026-09-14) | GOOD if latest beat (and better if both beat) | **GOOD** |

### NTAP  ·  score **+16**  ·  Software - Infrastructure
price=199.27999877929688  pair=`2026-09-10→2026-09-11`

| Feature | Value (with dates) | Status |
|---------|--------------------|:------:|
| `A01_rsi_value` | RSI=61.61 on 2026-09-11; prev RSI=46.89 on 2026-09-10 | **NEUTRAL** |
| `A02_rsi_cross_30` | above | RSI 46.89@2026-09-10 → 61.61@2026-09-11 vs 30 | rule: cross_up=GOOD | **NEUTRAL** |
| `A03_rsi_cross_50` | cross_up | RSI 46.89@2026-09-10 → 61.61@2026-09-11 vs 50 | rule: cross_up=GOOD cross_down=BAD | **GOOD** |
| `A04_rsi_cross_70` | below | RSI 46.89@2026-09-10 → 61.61@2026-09-11 vs 70 | rule: cross_down=BAD | **NEUTRAL** |
| `A05_body_red_green_2day` | STRICT 2-day pair only: 2026-09-10 + 2026-09-11; ratio=GREEN_body_sum/RED_body_sum=12.149 (G=13.8500 R=1.1400); 2026-09-10:RED:O=184.7400,C=183.6000,body=-1.1400,vol=1878500.0; 2026-09-11:GREEN:O=185.4300,C=199.2800,body=+13.8500,vol=2608900.0 | **GOOD** |
| `A06_volume_red_green_2day` | STRICT 2-day pair only: 2026-09-10 + 2026-09-11; ratio=GREEN_vol/RED_vol=1.389 (Gvol=2608900 Rvol=1878500); 2026-09-10:RED:O=184.7400,C=183.6000,body=-1.1400,vol=1878500.0; 2026-09-11:GREEN:O=185.4300,C=199.2800,body=+13.8500,vol=2608900.0 | **GOOD** |
| `A07_rvol` | RVOL=1.034 on 2026-09-11: today_vol=2608900 / avg20=2523330 (avg window 2026-08-13→2026-09-10, excludes asof) | **NEUTRAL** |
| `A08_bollinger_position` | pos=0.545 on 2026-09-11 (price=199.2800, mid=190.9145, upper=206.2506, lower=175.5784; 20d BB) | **NEUTRAL** |
| `A09_above_sma50` | above=True on 2026-09-11: price=199.2800 vs SMA50=180.9689 dist=+10.12% | **GOOD** |
| `A10_sma20_50_80_stack` | bull_aligned_20>50>80 on 2026-09-11: SMA20=190.9145 SMA50=180.9689 SMA80=170.6003 | **GOOD** |
| `A11_three_section_lows` | window=2026-06-10→2026-09-11 (63 bars); S1[2026-06-10→2026-07-10] low=2026-06-26@148.8180; S2[2026-07-13→2026-08-12] low=2026-07-16@156.2600; S3[2026-08-13→2026-09-11] low=2026-09-03@161.0000 | lows=[148.81800926064327, 156.25999450683594, 161.0] span=8.19% rising_lows=True flatish(≤12%)=True | **GOOD** |
| `A12_green_body_vs_wick_2day` | pair 2026-09-10+2026-09-11: GREEN body_frac=0.9760397266107214 wick_frac=0.02396027338927863 | **GOOD** |
| `A13_red_body_vs_wick_2day` | pair 2026-09-10+2026-09-11: RED body_frac=0.29007559491685336 wick_frac=0.7099244050831467 | **GOOD** |
| `A15_tape_recovery_setup` | body_rg_2d=12.149134665578027 need>1.4; red_wick_gt_green=False 5d trail=2026-09-04:GREEN:body=+3.0000:wick=5.4000; 2026-09-08:GREEN:body=+6.4000:wick=1.2800; 2026-09-09:RED:body=-4.6100:wick=2.1600; 2026-09-10:RED:body=-1.1400:wick=2.7900; 2026-09-11:GREEN:body=+13.8500:wick=0.3400 | **NEUTRAL** |
| `B01_eps_surprise` | EPS surprise=21.55 (current export asof; earnings_date=9/2/2026 4:30:00 PM) | **GOOD** |
| `B02_revenue_surprise` | Revenue surprise=10.24 (current export; earnings_date=9/2/2026 4:30:00 PM) | **GOOD** |
| `B03_sales` | 7392.0 | **NEUTRAL** |
| `B04_income` | 1418.0 | **GOOD** |
| `B05_profit_margin` | 19.18 | **GOOD** |
| `B06_profitable` | True | **GOOD** |
| `B07_target_price` | 196.87 | **NEUTRAL** |
| `B08_target_price_delta` | delta=2.0 (now=196.87 vs prior_export=194.87 on finviz_2026-09-14) | **GOOD** |
| `B09_analyst_recom` | 2.45 | **GOOD** |
| `B10_insider_transactions` | -7.82 | **BAD** |
| `B11_insider_tx_delta` | delta=0.16999999999999993 (now=-7.82 vs prior=-7.99 on finviz_2026-09-14) | **GOOD** |
| `B12_institutional_transactions` | -4.44 | **BAD** |
| `B13_short_float` | 5.49 | **NEUTRAL** |
| `B14_earnings_date` | 9/2/2026 4:30:00 PM | **NEUTRAL** |
| `B17_eps_surprise_pair` | last2 EPS surprises: current=21.55 (this export) | prior_export=21.55 (finviz_2026-09-14) | GOOD if latest beat (and better if both beat) | **GOOD** |
| `B18_rev_surprise_pair` | last2 Revenue surprises: current=10.24 (this export) | prior_export=10.24 (finviz_2026-09-14) | GOOD if latest beat (and better if both beat) | **GOOD** |
...
| `B06_profitable` | True | **GOOD** |
| `B07_target_price` | 486.89 | **NEUTRAL** |
| `B08_target_price_delta` | delta=1.669999999999959 (now=486.89 vs prior_export=485.22 on finviz_2026-09-14) | **GOOD** |
| `B09_analyst_recom` | 1.67 | **GOOD** |
| `B10_insider_transactions` | -4.71 | **BAD** |
| `B11_insider_tx_delta` | delta=0.0 (now=-4.71 vs prior=-4.71 on finviz_2026-09-14) | **NEUTRAL** |
| `B12_institutional_transactions` | 0.17 | **GOOD** |
| `B13_short_float` | 1.86 | **NEUTRAL** |
| `B14_earnings_date` | 7/31/2026 8:30:00 AM | **NEUTRAL** |
| `B17_eps_surprise_pair` | last2 EPS surprises: current=2.53 (this export) | prior_export=2.53 (finviz_2026-09-14) | GOOD if latest beat (and better if both beat) | **GOOD** |
| `B18_rev_surprise_pair` | last2 Revenue surprises: current=4.61 (this export) | prior_export=4.61 (finviz_2026-09-14) | GOOD if latest beat (and better if both beat) | **GOOD** |
...
| `B08_target_price_delta` | delta=0.0 (now=108.62 vs prior_export=108.62 on finviz_2026-09-14) | **NEUTRAL** |
| `B09_analyst_recom` | 2.4 | **GOOD** |
| `B10_insider_transactions` | nan | **NEUTRAL** |
| `B11_insider_tx_delta` | n/a (now=nan, prior_export_date=2026-09-14) | **NEUTRAL** |
| `B12_institutional_transactions` | 0.17 | **GOOD** |
| `B13_short_float` | 0.15 | **NEUTRAL** |
| `B14_earnings_date` | 8/4/2026 8:30:00 AM | **NEUTRAL** |
| `B17_eps_surprise_pair` | last2 EPS surprises: current=3.31 (this export) | prior_export=3.31 (finviz_2026-09-14) | GOOD if latest beat (and better if both beat) | **GOOD** |
| `B18_rev_surprise_pair` | last2 Revenue surprises: current=2.09 (this export) | prior_export=2.09 (finviz_2026-09-14) | GOOD if latest beat (and better if both beat) | **GOOD** |
...
| `B08_target_price_delta` | delta=0.0 (now=23.83 vs prior_export=23.83 on finviz_2026-09-14) | **NEUTRAL** |
...
| `B17_eps_surprise_pair` | last2 EPS surprises: current=13.2 (this export) | prior_export=13.2 (finviz_2026-09-14) | GOOD if latest beat (and better if both beat) | **GOOD** |
| `B18_rev_surprise_pair` | last2 Revenue surprises: current=1.03 (this export) | prior_export=1.03 (finviz_2026-09-14) | GOOD if latest beat (and better if both beat) | **GOOD** |
...
| `B06_profitable` | True | **GOOD** |
| `B07_target_price` | 44.84 | **NEUTRAL** |
| `B08_target_price_delta` | delta=0.0 (now=44.84 vs prior_export=44.84 on finviz_2026-09-14) | **NEUTRAL** |
...
| `B14_earnings_date` | 8/4/2026 4:30:00 PM | **NEUTRAL** |
| `B17_eps_surprise_pair` | last2 EPS surprises: current=44.43 (this export) | prior_export=44.43 (finviz_2026-09-14) | GOOD if latest beat (and better if both beat) | **GOOD** |
| `B18_rev_surprise_pair` | last2 Revenue surprises: current=3.38 (this export) | prior_export=3.38 (finviz_2026-09-14) | GOOD if latest beat (and better if both beat) | **GOOD** |
...
| `B06_profitable` | True | **GOOD** |
| `B07_target_price` | 167.65 | **NEUTRAL** |
| `B08_target_price_delta` | delta=0.6500000000000057 (now=167.65 vs prior_export=167.0 on finviz_2026-09-14) | **GOOD** |
| `B09_analyst_recom` | 2.13 | **GOOD** |
| `B10_insider_transactions` | -5.9 | **BAD** |
| `B11_insider_tx_delta` | delta=0.0 (now=-5.9 vs prior=-5.9 on finviz_2026-09-14) | **NEUTRAL** |
| `B12_institutional_transactions` | -2.22 | **BAD** |
| `B13_short_float` | 1.69 | **NEUTRAL** |
| `B14_earnings_date` | 7/29/2026 8:30:00 AM | **NEUTRAL** |
| `B17_eps_surprise_pair` | last2 EPS surprises: current=9.02 (this export) | prior_export=9.02 (finviz_2026-09-14) | GOOD if latest beat (and better if both beat) | **GOOD** |
| `B18_rev_surprise_pair` | last2 Revenue surprises: current=2.33 (this export) | prior_export=2.33 (finviz_2026-09-14) | GOOD if latest beat (and better if both beat) | **GOOD** |
...
| `B08_target_price_delta` | delta=0.0 (now=41.8 vs prior_export=41.8 on finviz_2026-09-14) | **NEUTRAL** |
| `B09_analyst_recom` | 1.0 | **GOOD** |
| `B10_insider_transactions` | -15.17 | **BAD** |
| `B11_insider_tx_delta` | delta=0.0 (now=-15.17 vs prior=-15.17 on finviz_2026-09-14) | **NEUTRAL** |
| `B12_institutional_transactions` | 0.09 | **GOOD** |
| `B13_short_float` | 14.98 | **NEUTRAL** |
| `B14_earnings_date` | 8/5/2026 4:30:00 PM | **NEUTRAL** |
| `B17_eps_surprise_pair` | last2 EPS surprises: current=7.56 (this export) | prior_export=7.56 (finviz_2026-09-14) | GOOD if latest beat (and better if both beat) | **GOOD** |
| `B18_rev_surprise_pair` | last2 Revenue surprises: current=10.71 (this export) | prior_export=10.71 (finviz_2026-09-14) | GOOD if latest beat (and better if both beat) | **GOOD** |
...
| `B08_target_price_delta` | delta=0.0 (now=101.45 vs prior_export=101.45 on finviz_2026-09-14) | **NEUTRAL** |
| `B09_analyst_recom` | 1.67 | **GOOD** |
| `B10_insider_transactions` | -1.56 | **BAD** |
| `B11_insider_tx_delta` | delta=0.0 (now=-1.56 vs prior=-1.56 on finviz_2026-09-14) | **NEUTRAL** |
| `B12_institutional_transactions` | 3.98 | **GOOD** |
| `B13_short_float` | 6.22 | **NEUTRAL** |
| `B14_earnings_date` | 7/30/2026 4:30:00 PM | **NEUTRAL** |
| `B17_eps_surprise_pair` | last2 EPS surprises: current=24.09 (this export) | prior_export=24.09 (finviz_2026-09-14) | GOOD if latest beat (and better if both beat) | **GOOD** |
| `B18_rev_surprise_pair` | last2 Revenue surprises: current=3.36 (this export) | prior_export=3.36 (finviz_2026-09-14) | GOOD if latest beat (and better if both beat) | **GOOD** |
...
| `B08_target_price_delta` | delta=0.0 (now=16.57 vs prior_export=16.57 on finviz_2026-09-14) | **NEUTRAL** |
| `B09_analyst_recom` | 2.75 | **NEUTRAL** |
| `B10_insider_transactions` | 0.14 | **GOOD** |
| `B11_insider_tx_delta` | delta=0.0 (now=0.14 vs prior=0.14 on finviz_2026-09-14) | **NEUTRAL** |
| `B12_institutional_transactions` | 1.7 | **GOOD** |
| `B13_short_float` | 5.59 | **NEUTRAL** |
| `B14_earnings_date` | 7/27/2026 4:30:00 PM | **NEUTRAL** |
| `B17_eps_surprise_pair` | last2 EPS surprises: current=10.02 (this export) | prior_export=10.02 (finviz_2026-09-14) | GOOD if latest beat (and better if both beat) | **GOOD** |
| `B18_rev_surprise_pair` | last2 Revenue surprises: current=1.12 (this export) | prior_export=1.12 (finviz_2026-09-14) | GOOD if latest beat (and better if both beat) | **GOOD** |

CSV: `data/ab_checklist/2026-09-15_ab_checklist.csv`
