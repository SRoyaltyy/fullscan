...
| 4 | WDS | +16 | 16 | 0 | 2026-09-10→2026-09-11 | Oil & Gas E&P |
...
| 8 | CXW | +16 | 17 | 1 | 2026-09-10→2026-09-11 | Security & Protection Services |
| 9 | DSGX | +16 | 17 | 1 | 2026-09-10→2026-09-11 | Software - Application |
| 10 | AVT | +15 | 17 | 2 | 2026-09-10→2026-09-11 | Electronics & Computer Distribution |
| 11 | ALB | +15 | 16 | 1 | 2026-09-04→2026-09-08 | Specialty Chemicals |
| 12 | PAYS | +15 | 16 | 1 | 2026-09-10→2026-09-11 | Software - Infrastructure |
| 13 | HASI | +15 | 15 | 0 | 2026-09-04→2026-09-08 | Asset Management |
| 14 | RPRX | +15 | 16 | 1 | 2026-09-04→2026-09-08 | Biotechnology |
| 15 | SLDE | +15 | 16 | 1 | 2026-09-10→2026-09-11 | Insurance - Property & Casualty |
...
| `B08_target_price_delta` | delta=0.0 (now=91.48 vs prior_export=91.48 on finviz_2026-09-14) | **NEUTRAL** |
| `B09_analyst_recom` | 1.6 | **GOOD** |
| `B10_insider_transactions` | -0.83 | **BAD** |
| `B11_insider_tx_delta` | delta=0.0 (now=-0.83 vs prior=-0.83 on finviz_2026-09-14) | **NEUTRAL** |
| `B12_institutional_transactions` | 1.09 | **GOOD** |
| `B13_short_float` | 5.17 | **NEUTRAL** |
| `B14_earnings_date` | 8/6/2026 4:30:00 PM | **NEUTRAL** |
| `B17_eps_surprise_pair` | last2 EPS surprises: current=26.66 (this export) | prior_export=26.66 (finviz_2026-09-14) | GOOD if latest beat (and better if both beat) | **GOOD** |
| `B18_rev_surprise_pair` | last2 Revenue surprises: current=6.19 (this export) | prior_export=6.19 (finviz_2026-09-14) | GOOD if latest beat (and better if both beat) | **GOOD** |
...
### AVT  ·  score **+15**  ·  Electronics & Computer Distribution
price=99.62999725341797  pair=`2026-09-10→2026-09-11`

| Feature | Value (with dates) | Status |
|---------|--------------------|:------:|
| `A01_rsi_value` | RSI=66.61 on 2026-09-11; prev RSI=55.37 on 2026-09-10 | **NEUTRAL** |
| `A02_rsi_cross_30` | above | RSI 55.37@2026-09-10 → 66.61@2026-09-11 vs 30 | rule: cross_up=GOOD | **NEUTRAL** |
| `A03_rsi_cross_50` | above | RSI 55.37@2026-09-10 → 66.61@2026-09-11 vs 50 | rule: cross_up=GOOD cross_down=BAD | **NEUTRAL** |
| `A04_rsi_cross_70` | below | RSI 55.37@2026-09-10 → 66.61@2026-09-11 vs 70 | rule: cross_down=BAD | **NEUTRAL** |
| `A05_body_red_green_2day` | STRICT 2-day pair only: 2026-09-10 + 2026-09-11; ratio=GREEN_body_sum/RED_body_sum=99.000 (G=7.1400 R=0.0000); 2026-09-10:GREEN:O=91.3200,C=92.9700,body=+1.6500,vol=1135100.0; 2026-09-11:GREEN:O=94.1400,C=99.6300,body=+5.4900,vol=1961200.0 | **GOOD** |
| `A06_volume_red_green_2day` | STRICT 2-day pair only: 2026-09-10 + 2026-09-11; ratio=GREEN_vol/RED_vol=99.000 (Gvol=3096300 Rvol=0); 2026-09-10:GREEN:O=91.3200,C=92.9700,body=+1.6500,vol=1135100.0; 2026-09-11:GREEN:O=94.1400,C=99.6300,body=+5.4900,vol=1961200.0 | **GOOD** |
| `A07_rvol` | RVOL=1.832 on 2026-09-11: today_vol=1961200 / avg20=1070355 (avg window 2026-08-13→2026-09-10, excludes asof) | **GOOD** |
| `A08_bollinger_position` | pos=1.175 on 2026-09-11 (price=99.6300, mid=91.2230, upper=98.3768, lower=84.0692; 20d BB) | **BAD** |
| `A09_above_sma50` | above=True on 2026-09-11: price=99.6300 vs SMA50=89.7350 dist=+11.03% | **GOOD** |
| `A10_sma20_50_80_stack` | bull_aligned_20>50>80 on 2026-09-11: SMA20=91.2230 SMA50=89.7350 SMA80=89.0107 | **GOOD** |
| `A11_three_section_lows` | window=2026-06-09→2026-09-11 (63 bars); S1[2026-06-09→2026-07-09] low=2026-07-07@80.1300; S2[2026-07-10→2026-08-12] low=2026-07-17@82.5000; S3[2026-08-13→2026-09-11] low=2026-08-24@85.5200 | lows=[80.12999725341797, 82.5, 85.5199966430664] span=6.73% rising_lows=True flatish(≤12%)=True | **GOOD** |
| `A12_green_body_vs_wick_2day` | pair 2026-09-10+2026-09-11: GREEN body_frac=0.7254420289704329 wick_frac=0.2745579710295672 | **GOOD** |
| `A13_red_body_vs_wick_2day` | pair 2026-09-10+2026-09-11: RED body_frac=nan wick_frac=nan | **NEUTRAL** |
| `A15_tape_recovery_setup` | body_rg_2d=99.0 need>1.4; red_wick_gt_green=True 5d trail=2026-09-04:GREEN:body=+1.0400:wick=1.2700; 2026-09-08:RED:body=-0.3900:wick=1.2900; 2026-09-09:RED:body=-0.1200:wick=1.5700; 2026-09-10:GREEN:body=+1.6500:wick=1.5700; 2026-09-11:GREEN:body=+5.4900:wick=0.3600 | **GOOD** |
| `B01_eps_surprise` | EPS surprise=26.95 (current export asof; earnings_date=8/5/2026 8:30:00 AM) | **GOOD** |
| `B02_revenue_surprise` | Revenue surprise=9.77 (current export; earnings_date=8/5/2026 8:30:00 AM) | **GOOD** |
| `B03_sales` | 27632.68 | **NEUTRAL** |
| `B04_income` | 334.39 | **GOOD** |
| `B05_profit_margin` | 1.21 | **GOOD** |
| `B06_profitable` | True | **GOOD** |
| `B07_target_price` | 106.25 | **NEUTRAL** |
| `B08_target_price_delta` | delta=0.0 (now=106.25 vs prior_export=106.25 on finviz_2026-09-14) | **NEUTRAL** |
| `B09_analyst_recom` | 2.43 | **GOOD** |
| `B10_insider_transactions` | -9.57 | **BAD** |
| `B11_insider_tx_delta` | delta=0.0 (now=-9.57 vs prior=-9.57 on finviz_2026-09-14) | **NEUTRAL** |
| `B12_institutional_transactions` | 0.13 | **GOOD** |
| `B13_short_float` | 9.82 | **NEUTRAL** |
| `B14_earnings_date` | 8/5/2026 8:30:00 AM | **NEUTRAL** |
| `B17_eps_surprise_pair` | last2 EPS surprises: current=26.95 (this export) | prior_export=26.95 (finviz_2026-09-14) | GOOD if latest beat (and better if both beat) | **GOOD** |
| `B18_rev_surprise_pair` | last2 Revenue surprises: current=9.77 (this export) | prior_export=9.77 (finviz_2026-09-14) | GOOD if latest beat (and better if both beat) | **GOOD** |
...
| `B08_target_price_delta` | delta=0.0 (now=176.0 vs prior_export=176.0 on finviz_2026-09-14) | **NEUTRAL** |
| `B09_analyst_recom` | 1.83 | **GOOD** |
| `B10_insider_transactions` | -4.73 | **BAD** |
| `B11_insider_tx_delta` | delta=0.0 (now=-4.73 vs prior=-4.73 on finviz_2026-09-14) | **NEUTRAL** |
| `B12_institutional_transactions` | 5.23 | **GOOD** |
| `B13_short_float` | 8.19 | **NEUTRAL** |
| `B14_earnings_date` | 8/5/2026 4:30:00 PM | **NEUTRAL** |
| `B17_eps_surprise_pair` | last2 EPS surprises: current=17.09 (this export) | prior_export=17.09 (finviz_2026-09-14) | GOOD if latest beat (and better if both beat) | **GOOD** |
| `B18_rev_surprise_pair` | last2 Revenue surprises: current=8.49 (this export) | prior_export=8.49 (finviz_2026-09-14) | GOOD if latest beat (and better if both beat) | **GOOD** |
...
| `B06_profitable` | True | **GOOD** |
| `B07_target_price` | 13.1 | **NEUTRAL** |
| `B08_target_price_delta` | delta=0.0 (now=13.1 vs prior_export=13.1 on finviz_2026-09-14) | **NEUTRAL** |
| `B09_analyst_recom` | 1.0 | **GOOD** |
| `B10_insider_transactions` | -4.5 | **BAD** |
| `B11_insider_tx_delta` | delta=0.0 (now=-4.5 vs prior=-4.5 on finviz_2026-09-14) | **NEUTRAL** |
...
| `B08_target_price_delta` | delta=0.0 (now=49.33 vs prior_export=49.33 on finviz_2026-09-14) | **NEUTRAL** |
| `B09_analyst_recom` | 1.44 | **GOOD** |
| `B10_insider_transactions` | 0.0 | **NEUTRAL** |
| `B11_insider_tx_delta` | delta=0.0 (now=0.0 vs prior=0.0 on finviz_2026-09-14) | **NEUTRAL** |
...
| `B14_earnings_date` | 8/6/2026 4:30:00 PM | **NEUTRAL** |
| `B17_eps_surprise_pair` | last2 EPS surprises: current=2.66 (this export) | prior_export=2.66 (finviz_2026-09-14) | GOOD if latest beat (and better if both beat) | **GOOD** |
| `B18_rev_surprise_pair` | last2 Revenue surprises: current=7.9 (this export) | prior_export=7.9 (finviz_2026-09-14) | GOOD if latest beat (and better if both beat) | **GOOD** |
...
| `B08_target_price_delta` | delta=0.0 (now=65.71 vs prior_export=65.71 on finviz_2026-09-14) | **NEUTRAL** |
| `B09_analyst_recom` | 1.4 | **GOOD** |
| `B10_insider_transactions` | -1.64 | **BAD** |
| `B11_insider_tx_delta` | delta=0.0 (now=-1.64 vs prior=-1.64 on finviz_2026-09-14) | **NEUTRAL** |
| `B12_institutional_transactions` | 1.4 | **GOOD** |
| `B13_short_float` | 2.85 | **NEUTRAL** |
| `B14_earnings_date` | 8/5/2026 8:30:00 AM | **NEUTRAL** |
| `B17_eps_surprise_pair` | last2 EPS surprises: current=3.82 (this export) | prior_export=3.82 (finviz_2026-09-14) | GOOD if latest beat (and better if both beat) | **GOOD** |
| `B18_rev_surprise_pair` | last2 Revenue surprises: current=1.85 (this export) | prior_export=1.85 (finviz_2026-09-14) | GOOD if latest beat (and better if both beat) | **GOOD** |
...
| `B08_target_price_delta` | delta=0.0 (now=26.0 vs prior_export=26.0 on finviz_2026-09-14) | **NEUTRAL** |
| `B09_analyst_recom` | 1.5 | **GOOD** |
| `B10_insider_transactions` | -12.31 | **BAD** |
| `B11_insider_tx_delta` | delta=0.0 (now=-12.31 vs prior=-12.31 on finviz_2026-09-14) | **NEUTRAL** |
| `B12_institutional_transactions` | 9.21 | **GOOD** |
| `B13_short_float` | 8.79 | **NEUTRAL** |
| `B14_earnings_date` | 7/28/2026 4:30:00 PM | **NEUTRAL** |
| `B17_eps_surprise_pair` | last2 EPS surprises: current=24.75 (this export) | prior_export=24.75 (finviz_2026-09-14) | GOOD if latest beat (and better if both beat) | **GOOD** |
| `B18_rev_surprise_pair` | last2 Revenue surprises: current=7.66 (this export) | prior_export=7.66 (finviz_2026-09-14) | GOOD if latest beat (and better if both beat) | **GOOD** |
