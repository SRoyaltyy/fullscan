# A+B1 Feature Checklist — 2026-09-20

- Gate: Market Cap > $80M · ADV > 500,000 shares → **2,654** names
- Export: `finviz_2026-09-20.csv` · prior export for Δ: `2026-09-18`
...
|-----:|--------|------:|-----:|----:|------|----------|
| 1 | ANET | +18 | 19 | 1 | 2026-09-10→2026-09-11 | Computer Hardware |
| 2 | WWW | +17 | 18 | 1 | 2026-09-10→2026-09-11 | Footwear & Accessories |
...
| 10 | ALB | +15 | 16 | 1 | 2026-09-04→2026-09-08 | Specialty Chemicals |
| 11 | SFL | +15 | 16 | 1 | 2026-09-10→2026-09-11 | Marine Shipping |
| 12 | SLDE | +15 | 16 | 1 | 2026-09-10→2026-09-11 | Insurance - Property & Casualty |
| 13 | JCI | +15 | 17 | 2 | 2026-09-10→2026-09-11 | Building Products & Equipment |
| 14 | CDNA | +15 | 16 | 1 | 2026-09-04→2026-09-08 | Diagnostics & Research |
| 15 | RPRX | +15 | 16 | 1 | 2026-09-04→2026-09-08 | Biotechnology |

## Full checklist — top 15

### ANET  ·  score **+18**  ·  Computer Hardware
...
| `B08_target_price_delta` | delta=0.0 (now=248.86 vs prior_export=248.86 on finviz_2026-09-18) | **NEUTRAL** |
| `B09_analyst_recom` | 1.09 | **GOOD** |
| `B10_insider_transactions` | -3.09 | **BAD** |
| `B11_insider_tx_delta` | delta=0.020000000000000018 (now=-3.09 vs prior=-3.11 on finviz_2026-09-18) | **GOOD** |
| `B12_institutional_transactions` | 0.66 | **GOOD** |
| `B13_short_float` | 1.38 | **NEUTRAL** |
| `B14_earnings_date` | 8/4/2026 4:30:00 PM | **NEUTRAL** |
| `B17_eps_surprise_pair` | last2 EPS surprises: current=15.14 (this export) | prior_export=15.14 (finviz_2026-09-18) | GOOD if latest beat (and better if both beat) | **GOOD** |
| `B18_rev_surprise_pair` | last2 Revenue surprises: current=7.26 (this export) | prior_export=7.26 (finviz_2026-09-18) | GOOD if latest beat (and better if both beat) | **GOOD** |
...
| `B08_target_price_delta` | delta=0.0 (now=24.3 vs prior_export=24.3 on finviz_2026-09-18) | **NEUTRAL** |
| `B09_analyst_recom` | 2.0 | **GOOD** |
| `B10_insider_transactions` | -3.42 | **BAD** |
| `B11_insider_tx_delta` | delta=0.0 (now=-3.42 vs prior=-3.42 on finviz_2026-09-18) | **NEUTRAL** |
| `B12_institutional_transactions` | 0.26 | **GOOD** |
| `B13_short_float` | 7.22 | **NEUTRAL** |
| `B14_earnings_date` | 8/13/2026 8:30:00 AM | **NEUTRAL** |
| `B17_eps_surprise_pair` | last2 EPS surprises: current=4.99 (this export) | prior_export=4.99 (finviz_2026-09-18) | GOOD if latest beat (and better if both beat) | **GOOD** |
| `B18_rev_surprise_pair` | last2 Revenue surprises: current=1.13 (this export) | prior_export=1.13 (finviz_2026-09-18) | GOOD if latest beat (and better if both beat) | **GOOD** |
...
| `B08_target_price_delta` | delta=0.0 (now=9.5 vs prior_export=9.5 on finviz_2026-09-18) | **NEUTRAL** |
| `B09_analyst_recom` | 2.33 | **GOOD** |
| `B10_insider_transactions` | 0.0 | **NEUTRAL** |
| `B11_insider_tx_delta` | delta=0.0 (now=0.0 vs prior=0.0 on finviz_2026-09-18) | **NEUTRAL** |
| `B12_institutional_transactions` | 0.7 | **GOOD** |
| `B13_short_float` | 5.67 | **NEUTRAL** |
| `B14_earnings_date` | 7/29/2026 8:30:00 AM | **NEUTRAL** |
| `B17_eps_surprise_pair` | last2 EPS surprises: current=11.76 (this export) | prior_export=11.76 (finviz_2026-09-18) | GOOD if latest beat (and better if both beat) | **GOOD** |
| `B18_rev_surprise_pair` | last2 Revenue surprises: current=2.57 (this export) | prior_export=2.57 (finviz_2026-09-18) | GOOD if latest beat (and better if both beat) | **GOOD** |
...
| `B08_target_price_delta` | delta=0.0 (now=23.83 vs prior_export=23.83 on finviz_2026-09-18) | **NEUTRAL** |
| `B09_analyst_recom` | 2.69 | **NEUTRAL** |
| `B10_insider_transactions` | nan | **NEUTRAL** |
| `B11_insider_tx_delta` | n/a (now=nan, prior_export_date=2026-09-18) | **NEUTRAL** |
| `B12_institutional_transactions` | 0.68 | **GOOD** |
| `B13_short_float` | 0.19 | **NEUTRAL** |
| `B14_earnings_date` | 8/24/2026 4:30:00 PM | **NEUTRAL** |
| `B17_eps_surprise_pair` | last2 EPS surprises: current=13.2 (this export) | prior_export=13.2 (finviz_2026-09-18) | GOOD if latest beat (and better if both beat) | **GOOD** |
| `B18_rev_surprise_pair` | last2 Revenue surprises: current=1.03 (this export) | prior_export=1.03 (finviz_2026-09-18) | GOOD if latest beat (and better if both beat) | **GOOD** |
...
| `B08_target_price_delta` | delta=0.0 (now=41.8 vs prior_export=41.8 on finviz_2026-09-18) | **NEUTRAL** |
| `B09_analyst_recom` | 1.0 | **GOOD** |
| `B10_insider_transactions` | -15.17 | **BAD** |
| `B11_insider_tx_delta` | delta=0.0 (now=-15.17 vs prior=-15.17 on finviz_2026-09-18) | **NEUTRAL** |
| `B12_institutional_transactions` | 0.08 | **GOOD** |
| `B13_short_float` | 14.98 | **NEUTRAL** |
| `B14_earnings_date` | 8/5/2026 4:30:00 PM | **NEUTRAL** |
| `B17_eps_surprise_pair` | last2 EPS surprises: current=7.56 (this export) | prior_export=7.56 (finviz_2026-09-18) | GOOD if latest beat (and better if both beat) | **GOOD** |
| `B18_rev_surprise_pair` | last2 Revenue surprises: current=10.71 (this export) | prior_export=10.71 (finviz_2026-09-18) | GOOD if latest beat (and better if both beat) | **GOOD** |
...
| `B08_target_price_delta` | delta=0.0 (now=91.68 vs prior_export=91.68 on finviz_2026-09-18) | **NEUTRAL** |
| `B09_analyst_recom` | 1.6 | **GOOD** |
| `B10_insider_transactions` | -0.83 | **BAD** |
| `B11_insider_tx_delta` | delta=0.0 (now=-0.83 vs prior=-0.83 on finviz_2026-09-18) | **NEUTRAL** |
| `B12_institutional_transactions` | 1.05 | **GOOD** |
| `B13_short_float` | 5.17 | **NEUTRAL** |
| `B14_earnings_date` | 8/6/2026 4:30:00 PM | **NEUTRAL** |
| `B17_eps_surprise_pair` | last2 EPS surprises: current=26.66 (this export) | prior_export=26.66 (finviz_2026-09-18) | GOOD if latest beat (and better if both beat) | **GOOD** |
| `B18_rev_surprise_pair` | last2 Revenue surprises: current=6.19 (this export) | prior_export=6.19 (finviz_2026-09-18) | GOOD if latest beat (and better if both beat) | **GOOD** |
...
| `B08_target_price_delta` | delta=0.0 (now=45.14 vs prior_export=45.14 on finviz_2026-09-18) | **NEUTRAL** |
...
| `B14_earnings_date` | 8/4/2026 4:30:00 PM | **NEUTRAL** |
| `B17_eps_surprise_pair` | last2 EPS surprises: current=44.43 (this export) | prior_export=44.43 (finviz_2026-09-18) | GOOD if latest beat (and better if both beat) | **GOOD** |
| `B18_rev_surprise_pair` | last2 Revenue surprises: current=3.38 (this export) | prior_export=3.38 (finviz_2026-09-18) | GOOD if latest beat (and better if both beat) | **GOOD** |
...
| `B08_target_price_delta` | delta=0.0 (now=108.62 vs prior_export=108.62 on finviz_2026-09-18) | **NEUTRAL** |
...
| `B17_eps_surprise_pair` | last2 EPS surprises: current=3.31 (this export) | prior_export=3.31 (finviz_2026-09-18) | GOOD if latest beat (and better if both beat) | **GOOD** |
| `B18_rev_surprise_pair` | last2 Revenue surprises: current=2.09 (this export) | prior_export=2.09 (finviz_2026-09-18) | GOOD if latest beat (and better if both beat) | **GOOD** |
...
| `B08_target_price_delta` | delta=0.0 (now=101.23 vs prior_export=101.23 on finviz_2026-09-18) | **NEUTRAL** |
...
| `B17_eps_surprise_pair` | last2 EPS surprises: current=3.07 (this export) | prior_export=3.07 (finviz_2026-09-18) | GOOD if latest beat (and better if both beat) | **GOOD** |
| `B18_rev_surprise_pair` | last2 Revenue surprises: current=0.83 (this export) | prior_export=0.83 (finviz_2026-09-18) | GOOD if latest beat (and better if both beat) | **GOOD** |
...
| `B08_target_price_delta` | delta=0.0 (now=174.89 vs prior_export=174.89 on finviz_2026-09-18) | **NEUTRAL** |
| `B09_analyst_recom` | 1.83 | **GOOD** |
| `B10_insider_transactions` | -4.89 | **BAD** |
| `B11_insider_tx_delta` | delta=0.0 (now=-4.89 vs prior=-4.89 on finviz_2026-09-18) | **NEUTRAL** |
| `B12_institutional_transactions` | 5.05 | **GOOD** |
| `B13_short_float` | 8.19 | **NEUTRAL** |
| `B14_earnings_date` | 8/5/2026 4:30:00 PM | **NEUTRAL** |
| `B17_eps_surprise_pair` | last2 EPS surprises: current=17.09 (this export) | prior_export=17.09 (finviz_2026-09-18) | GOOD if latest beat (and better if both beat) | **GOOD** |
| `B18_rev_surprise_pair` | last2 Revenue surprises: current=8.49 (this export) | prior_export=8.49 (finviz_2026-09-18) | GOOD if latest beat (and better if both beat) | **GOOD** |

### SFL  ·  score **+15**  ·  Marine Shipping
price=13.180000305175781  pair=`2026-09-10→2026-09-11`

| Feature | Value (with dates) | Status |
|---------|--------------------|:------:|
| `A01_rsi_value` | RSI=68.05 on 2026-09-11; prev RSI=59.85 on 2026-09-10 | **NEUTRAL** |
| `A02_rsi_cross_30` | above | RSI 59.85@2026-09-10 → 68.05@2026-09-11 vs 30 | rule: cross_up=GOOD | **NEUTRAL** |
| `A03_rsi_cross_50` | above | RSI 59.85@2026-09-10 → 68.05@2026-09-11 vs 50 | rule: cross_up=GOOD cross_down=BAD | **NEUTRAL** |
| `A04_rsi_cross_70` | below | RSI 59.85@2026-09-10 → 68.05@2026-09-11 vs 70 | rule: cross_down=BAD | **NEUTRAL** |
| `A05_body_red_green_2day` | STRICT 2-day pair only: 2026-09-10 + 2026-09-11; ratio=GREEN_body_sum/RED_body_sum=99.000 (G=0.5300 R=0.0000); 2026-09-10:GREEN:O=12.5700,C=12.6800,body=+0.1100,vol=1333900.0; 2026-09-11:GREEN:O=12.7600,C=13.1800,body=+0.4200,vol=2000500.0 | **GOOD** |
| `A06_volume_red_green_2day` | STRICT 2-day pair only: 2026-09-10 + 2026-09-11; ratio=GREEN_vol/RED_vol=99.000 (Gvol=3334400 Rvol=0); 2026-09-10:GREEN:O=12.5700,C=12.6800,body=+0.1100,vol=1333900.0; 2026-09-11:GREEN:O=12.7600,C=13.1800,body=+0.4200,vol=2000500.0 | **GOOD** |
| `A07_rvol` | RVOL=1.535 on 2026-09-11: today_vol=2000500 / avg20=1303290 (avg window 2026-08-13→2026-09-10, excludes asof) | **GOOD** |
| `A08_bollinger_position` | pos=1.418 on 2026-09-11 (price=13.1800, mid=12.4930, upper=12.9773, lower=12.0087; 20d BB) | **BAD** |
| `A09_above_sma50` | above=True on 2026-09-11: price=13.1800 vs SMA50=11.8730 dist=+11.01% | **GOOD** |
| `A10_sma20_50_80_stack` | bull_aligned_20>50>80 on 2026-09-11: SMA20=12.4930 SMA50=11.8730 SMA80=11.7030 | **GOOD** |
| `A11_three_section_lows` | window=2026-06-09→2026-09-11 (63 bars); S1[2026-06-09→2026-07-09] low=2026-06-30@10.0700; S2[2026-07-10→2026-08-12] low=2026-07-10@10.8400; S3[2026-08-13→2026-09-11] low=2026-08-13@11.8000 | lows=[10.069999694824219, 10.84000015258789, 11.800000190734863] span=17.18% rising_lows=True flatish(≤12%)=False | **GOOD** |
| `A12_green_body_vs_wick_2day` | pair 2026-09-10+2026-09-11: GREEN body_frac=0.6398560182252764 wick_frac=0.3601439817747236 | **GOOD** |
| `A13_red_body_vs_wick_2day` | pair 2026-09-10+2026-09-11: RED body_frac=nan wick_frac=nan | **NEUTRAL** |
| `A15_tape_recovery_setup` | body_rg_2d=99.0 need>1.4; red_wick_gt_green=False 5d trail=2026-09-04:GREEN:body=+0.2500:wick=0.0800; 2026-09-08:RED:body=-0.2800:wick=0.0600; 2026-09-09:GREEN:body=+0.0300:wick=0.3100; 2026-09-10:GREEN:body=+0.1100:wick=0.1900; 2026-09-11:GREEN:body=+0.4200:wick=0.0400 | **NEUTRAL** |
...
| `B08_target_price_delta` | delta=0.0 (now=13.32 vs prior_export=13.32 on finviz_2026-09-18) | **NEUTRAL** |
| `B09_analyst_recom` | 2.0 | **GOOD** |
| `B10_insider_transactions` | 0.0 | **NEUTRAL** |
| `B11_insider_tx_delta` | delta=0.0 (now=0.0 vs prior=0.0 on finviz_2026-09-18) | **NEUTRAL** |
| `B12_institutional_transactions` | 7.77 | **GOOD** |
| `B13_short_float` | 3.25 | **NEUTRAL** |
| `B14_earnings_date` | 8/26/2026 8:30:00 AM | **NEUTRAL** |
| `B17_eps_surprise_pair` | last2 EPS surprises: current=84.93 (this export) | prior_export=84.93 (finviz_2026-09-18) | GOOD if latest beat (and better if both beat) | **GOOD** |
| `B18_rev_surprise_pair` | last2 Revenue surprises: current=11.75 (this export) | prior_export=11.75 (finviz_2026-09-18) | GOOD if latest beat (and better if both beat) | **GOOD** |
...
| `B08_target_price_delta` | delta=0.0 (now=26.0 vs prior_export=26.0 on finviz_2026-09-18) | **NEUTRAL** |
| `B09_analyst_recom` | 1.5 | **GOOD** |
| `B10_insider_transactions` | -11.61 | **BAD** |
| `B11_insider_tx_delta` | delta=0.0 (now=-11.61 vs prior=-11.61 on finviz_2026-09-18) | **NEUTRAL** |
| `B12_institutional_transactions` | 9.22 | **GOOD** |
| `B13_short_float` | 8.77 | **NEUTRAL** |
| `B14_earnings_date` | 7/28/2026 4:30:00 PM | **NEUTRAL** |
| `B17_eps_surprise_pair` | last2 EPS surprises: current=24.75 (this export) | prior_export=24.75 (finviz_2026-09-18) | GOOD if latest beat (and better if both beat) | **GOOD** |
| `B18_rev_surprise_pair` | last2 Revenue surprises: current=7.66 (this export) | prior_export=7.66 (finviz_2026-09-18) | GOOD if latest beat (and better if both beat) | **GOOD** |
...
| `B06_profitable` | True | **GOOD** |
| `B07_target_price` | 167.76 | **NEUTRAL** |
| `B08_target_price_delta` | delta=0.0 (now=167.76 vs prior_export=167.76 on finviz_2026-09-18) | **NEUTRAL** |
| `B09_analyst_recom` | 2.13 | **GOOD** |
| `B10_insider_transactions` | -5.9 | **BAD** |
| `B11_insider_tx_delta` | delta=0.0 (now=-5.9 vs prior=-5.9 on finviz_2026-09-18) | **NEUTRAL** |
| `B12_institutional_transactions` | -2.21 | **BAD** |
| `B13_short_float` | 1.69 | **NEUTRAL** |
| `B14_earnings_date` | 7/29/2026 8:30:00 AM | **NEUTRAL** |
| `B17_eps_surprise_pair` | last2 EPS surprises: current=9.02 (this export) | prior_export=9.02 (finviz_2026-09-18) | GOOD if latest beat (and better if both beat) | **GOOD** |
| `B18_rev_surprise_pair` | last2 Revenue surprises: current=2.33 (this export) | prior_export=2.33 (finviz_2026-09-18) | GOOD if latest beat (and better if both beat) | **GOOD** |
...
| `B08_target_price_delta` | delta=0.0 (now=54.14 vs prior_export=54.14 on finviz_2026-09-18) | **NEUTRAL** |
| `B09_analyst_recom` | 1.75 | **GOOD** |
| `B10_insider_transactions` | -6.98 | **BAD** |
| `B11_insider_tx_delta` | delta=0.0 (now=-6.98 vs prior=-6.98 on finviz_2026-09-18) | **NEUTRAL** |
| `B12_institutional_transactions` | 0.48 | **GOOD** |
| `B13_short_float` | 12.39 | **NEUTRAL** |
| `B14_earnings_date` | 7/30/2026 4:30:00 PM | **NEUTRAL** |
| `B17_eps_surprise_pair` | last2 EPS surprises: current=59.41 (this export) | prior_export=59.41 (finviz_2026-09-18) | GOOD if latest beat (and better if both beat) | **GOOD** |
| `B18_rev_surprise_pair` | last2 Revenue surprises: current=15.69 (this export) | prior_export=15.69 (finviz_2026-09-18) | GOOD if latest beat (and better if both beat) | **GOOD** |
...
| `B08_target_price_delta` | delta=0.0 (now=65.71 vs prior_export=65.71 on finviz_2026-09-18) | **NEUTRAL** |
| `B09_analyst_recom` | 1.5 | **GOOD** |
| `B10_insider_transactions` | -1.64 | **BAD** |
| `B11_insider_tx_delta` | delta=0.0 (now=-1.64 vs prior=-1.64 on finviz_2026-09-18) | **NEUTRAL** |
| `B12_institutional_transactions` | 1.38 | **GOOD** |
| `B13_short_float` | 2.85 | **NEUTRAL** |
| `B14_earnings_date` | 8/5/2026 8:30:00 AM | **NEUTRAL** |
| `B17_eps_surprise_pair` | last2 EPS surprises: current=3.82 (this export) | prior_export=3.82 (finviz_2026-09-18) | GOOD if latest beat (and better if both beat) | **GOOD** |
| `B18_rev_surprise_pair` | last2 Revenue surprises: current=1.85 (this export) | prior_export=1.85 (finviz_2026-09-18) | GOOD if latest beat (and better if both beat) | **GOOD** |

CSV: `data/ab_checklist/2026-09-20_ab_checklist.csv`
