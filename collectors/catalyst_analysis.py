...
# ═══════════════════════════════════════════════════════
TICKERS = ["ALB"]
CUTOFF_DATE = "2026-06-22"          # e.g. "2026-03-15" — discard events after this; set to None for live
# ═══════════════════════════════════════════════════════
