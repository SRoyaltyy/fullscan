...
for sub in boring-winners ticker-lookback gainer-lookback mover-lookback flatten-lookback sleeve-combine sleeve-merge mover-paper book-paper strategy-board factor-mine down-day-mine generate; do
