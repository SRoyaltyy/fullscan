...
evidence_cited: "Actual outcome: XLB 0.00%, SPY +0.32%, rel −0.32%. Copper hit record highs on the tariff threat (LME 3m settled ~$14,273/t, traded as high as ~$14,343/t; COMEX ~$6.70, +1.54%) and gold held ~$4,650, yet XLB was flat. XLK +1.06% led the tape; materials lagged. Morning premarket showed mixed/weak major XLB weights (LIN ~−0.3%, NEM ~−0.8%, SHW +1%). The S4 = 0/non-confirming tape was the better signal than the S0/S1 leading positives."
error_category: "B"
