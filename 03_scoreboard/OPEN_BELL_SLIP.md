...
Window `2026-08-13 → 2026-09-22` (28 sessions). KEEP bar: **≥30 filled fires** and **>55% after-fee hit rate**.

## KEEP / KILL vs ideal open

| Sleeve | Reality | Intended | Filled | Miss | After-fee win | After-fee $ | vs ideal $ | Verdict |
|---|---|---:|---:|---:|---:|---:|---:|---|
| `combo_sh_macd_5050_shared` | ideal | 174 | 141 | 33 | 31.9% | -93.56 | — | **KILL** |
| `combo_sh_macd_5050_shared` | market | 174 | 141 | 33 | 15.6% | -154.14 | $-60.58 | **KILL** |
| `combo_sh_macd_5050_shared` | limit_open | 174 | 131 | 43 | 28.2% | -100.17 | $-6.61 | **KILL** |
| `combo_sh_macd_5050_shared` | limit_prior | 174 | 117 | 57 | 30.8% | -71.17 | $+22.39 | **KILL** |
| `union_hot_n4_h1` | ideal | 112 | 88 | 24 | 33.0% | -37.23 | — | **KILL** |
| `union_hot_n4_h1` | market | 112 | 88 | 24 | 17.1% | -79.40 | $-42.17 | **KILL** |
| `union_hot_n4_h1` | limit_open | 112 | 82 | 30 | 28.1% | -44.02 | $-6.79 | **KILL** |
| `union_hot_n4_h1` | limit_prior | 112 | 74 | 38 | 32.4% | -29.85 | $+7.38 | **KILL** |
| `flatten_would` | ideal | 171 | 140 | 31 | 22.1% | -122.07 | — | **KILL** |
| `flatten_would` | market | 171 | 140 | 31 | 10.7% | -191.19 | $-69.12 | **KILL** |
| `flatten_would` | limit_open | 171 | 134 | 37 | 21.6% | -125.91 | $-3.84 | **KILL** |
| `flatten_would` | limit_prior | 171 | 102 | 69 | 22.6% | -44.33 | $+77.74 | **KILL** |
