...
Window `2026-08-13 → 2026-09-21` (27 sessions). KEEP bar: **≥30 filled fires** and **>55% after-fee hit rate**.

## KEEP / KILL vs ideal open

| Sleeve | Reality | Intended | Filled | Miss | After-fee win | After-fee $ | vs ideal $ | Verdict |
|---|---|---:|---:|---:|---:|---:|---:|---|
| `combo_sh_macd_5050_shared` | ideal | 166 | 140 | 26 | 31.4% | -93.78 | — | **KILL** |
| `combo_sh_macd_5050_shared` | market | 166 | 140 | 26 | 15.7% | -154.02 | $-60.24 | **KILL** |
| `combo_sh_macd_5050_shared` | limit_open | 166 | 130 | 36 | 27.7% | -100.39 | $-6.61 | **KILL** |
| `combo_sh_macd_5050_shared` | limit_prior | 166 | 117 | 49 | 30.8% | -71.17 | $+22.61 | **KILL** |
| `union_hot_n4_h1` | ideal | 108 | 88 | 20 | 33.0% | -37.23 | — | **KILL** |
| `union_hot_n4_h1` | market | 108 | 88 | 20 | 17.1% | -79.40 | $-42.17 | **KILL** |
| `union_hot_n4_h1` | limit_open | 108 | 82 | 26 | 28.1% | -44.02 | $-6.79 | **KILL** |
| `union_hot_n4_h1` | limit_prior | 108 | 74 | 34 | 32.4% | -29.85 | $+7.38 | **KILL** |
| `flatten_would` | ideal | 165 | 140 | 25 | 22.1% | -122.07 | — | **KILL** |
| `flatten_would` | market | 165 | 140 | 25 | 10.7% | -191.19 | $-69.12 | **KILL** |
| `flatten_would` | limit_open | 165 | 134 | 31 | 21.6% | -125.91 | $-3.84 | **KILL** |
| `flatten_would` | limit_prior | 165 | 102 | 63 | 22.6% | -44.33 | $+77.74 | **KILL** |
