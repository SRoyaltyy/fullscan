...
_Generated 2026-09-07 · live `flatten_robust` frozen. Yahoo/rows A–F seed only. No merge. Light+O is baseline. T/BA highlight ghosts not reopened._

## Plain English

First open-entry **pair + lag** pilot on a short letter list. Fair 9:30 inputs only: yesterday-and-older numbers from O / AA / H, plus today's open-knowable numbers and the S/L text on EQ. Example shape (open-legal siblings): O two days ago under 1 and today's ES equals 1; or O two days ago under 1 and yesterday's AA equals 1. AA today is **not** licensed same-row open — that pair waits for the close-entry pass.

**Clean null on the open-entry pilot.** KEEP 0 · KILL 2237 · THIN 0. Bounded pair+lag does not clear ship + Q1 / July / five-name on this tape. Trees skipped. Next: close-entry pass, then a wider letter set — not a remine of T/BA highlights.

Dumps **3603**. Atoms **79**. Pairs **1533**. Open-long everyone-else hold2 +0.54% (n=498610). Both SPY tapes required. Light+O ± AH/FR untouched.

### Family scoreboard

| family | what it is | KEEP | KILL | THIN |
|---|---|---:|---:|---:|
| single | one number or EQ text, maybe lagged | 0 | 134 | 0 |
| pair | lag number ∧ today's open-knowable (or AA lag sibling) | 0 | 2103 | 0 |

### Pilot table (hold2, English first)

| meaning | clock | holdout | vs everyone | Q1 | spy↑ | spy↓ | July | top-5 | verdict | why |
|---|---|---|---|---|---|---|---|---|---|---|
| AA 5 days ago is under 1 AND C today is under 1 | open | +6.43% (n=9176) | +5.89 pp | +0.16% (n=2662) | +7.33% (n=11896) | +8.65% (n=10068) | 48% | 32% | **KILL** | month_lottery,month_split,ticker_ghost |
| AA 3 days ago equals 1 AND IY today equals 1 | open | +0.32% (n=7561) | -0.23 pp | +0.08% (n=3493) | +0.69% (n=13413) | -0.59% (n=5554) | 0% | 19% | **KILL** | tape_split,spy_regime,q3_sign,q3_split,no_edge_vs_uncond,month_split |
| AA 3 days ago equals 1 AND IY today is at least 1 | open | +0.32% (n=7561) | -0.23 pp | +0.08% (n=3493) | +0.69% (n=13413) | -0.59% (n=5554) | 0% | 19% | **KILL** | tape_split,spy_regime,q3_sign,q3_split,no_edge_vs_uncond,month_split |
| AA 3 days ago equals 1 AND IY today is above 0 | open | +0.32% (n=7561) | -0.23 pp | +0.08% (n=3493) | +0.69% (n=13413) | -0.59% (n=5554) | 0% | 19% | **KILL** | tape_split,spy_regime,q3_sign,q3_split,no_edge_vs_uncond,month_split |
| AA 3 days ago is at least 1 AND IY today equals 1 | open | +0.32% (n=7561) | -0.23 pp | +0.08% (n=3493) | +0.69% (n=13413) | -0.59% (n=5554) | 0% | 19% | **KILL** | tape_split,spy_regime,q3_sign,q3_split,no_edge_vs_uncond,month_split |
| AA 3 days ago is at least 1 AND IY today is at least 1 | open | +0.32% (n=7561) | -0.23 pp | +0.08% (n=3493) | +0.69% (n=13413) | -0.59% (n=5554) | 0% | 19% | **KILL** | tape_split,spy_regime,q3_sign,q3_split,no_edge_vs_uncond,month_split |
| AA 3 days ago is at least 1 AND IY today is above 0 | open | +0.32% (n=7561) | -0.23 pp | +0.08% (n=3493) | +0.69% (n=13413) | -0.59% (n=5554) | 0% | 19% | **KILL** | tape_split,spy_regime,q3_sign,q3_split,no_edge_vs_uncond,month_split |
| AA 5 days ago is under 1 AND DE today is at least 1 | open | +0.38% (n=140195) | -0.16 pp | -0.49% (n=36782) | +0.63% (n=192366) | +0.22% (n=151657) | 30% | 35% | **KILL** | no_edge_vs_uncond,q1_sign,month_split,ticker_ghost |
| AA 5 days ago is under 1 AND DE today is above 0 | open | +0.38% (n=140195) | -0.16 pp | -0.49% (n=36782) | +0.63% (n=192366) | +0.22% (n=151657) | 30% | 35% | **KILL** | no_edge_vs_uncond,q1_sign,month_split,ticker_ghost |
| AA 5 days ago is under 1 AND Q today is above 0 | open | +0.37% (n=139684) | -0.18 pp | -0.53% (n=60406) | +0.69% (n=183376) | +0.17% (n=159732) | 28% | 35% | **KILL** | tape_split,no_edge_vs_uncond,q1_sign,month_split,ticker_ghost |
| H 5 days ago is under 1 AND C today is under 1 | open | +13.81% (n=11881) | +13.27 pp | +9.83% (n=4320) | +9.07% (n=15295) | +12.33% (n=13109) | 38% | 42% | **KILL** | month_split,ticker_ghost |
| H 4 days ago is under 1 AND C today is under 1 | open | +13.73% (n=11950) | +13.19 pp | +9.48% (n=4476) | +9.07% (n=15299) | +12.21% (n=13262) | 38% | 42% | **KILL** | month_split,ticker_ghost |
| H 3 days ago is under 1 AND C today is under 1 | open | +13.64% (n=12015) | +13.09 pp | +9.09% (n=4630) | +8.96% (n=15448) | +12.19% (n=13268) | 38% | 42% | **KILL** | month_split,ticker_ghost |
| H yesterday is under 1 AND C today is under 1 | open | +13.49% (n=12149) | +12.94 pp | +8.57% (n=4942) | +8.89% (n=15606) | +12.05% (n=13421) | 38% | 42% | **KILL** | month_split,ticker_ghost |
| H 2 days ago is under 1 AND C today is under 1 | open | +13.55% (n=12080) | +13.01 pp | +8.78% (n=4781) | +8.95% (n=15450) | +12.05% (n=13418) | 38% | 42% | **KILL** | month_split,ticker_ghost |
| AA 3 days ago is under 1 AND C today is under 1 | open | +12.15% (n=9296) | +11.61 pp | +6.71% (n=2937) | +6.75% (n=12098) | +14.21% (n=10135) | 35% | 35% | **KILL** | month_split,ticker_ghost |
| O 3 days ago is under 1 AND DE today is at least 1 | open | +0.77% (n=146885) | +0.22 pp | +0.05% (n=37720) | +0.61% (n=201826) | +0.61% (n=158834) | 26% | 34% | **KILL** | no_edge_vs_uncond,ticker_ghost |
| O 3 days ago is under 1 AND DE today is above 0 | open | +0.77% (n=146885) | +0.22 pp | +0.05% (n=37720) | +0.61% (n=201826) | +0.61% (n=158834) | 26% | 34% | **KILL** | no_edge_vs_uncond,ticker_ghost |
| O 2 days ago is under 1 AND DE today is at least 1 | open | +0.59% (n=147102) | +0.04 pp | +0.03% (n=38097) | +0.59% (n=201536) | +0.46% (n=159696) | 27% | 33% | **KILL** | no_edge_vs_uncond,month_split,ticker_ghost |
| O 2 days ago is under 1 AND DE today is above 0 | open | +0.59% (n=147102) | +0.04 pp | +0.03% (n=38097) | +0.59% (n=201536) | +0.46% (n=159696) | 27% | 33% | **KILL** | no_edge_vs_uncond,month_split,ticker_ghost |
| H yesterday is under 1 AND ET today is under 1 | open | +0.76% (n=179737) | +0.21 pp | +0.23% (n=85271) | +0.72% (n=237455) | +0.38% (n=203699) | 23% | 41% | **KILL** | no_edge_vs_uncond,month_split,ticker_ghost |
| H 4 days ago is under 1 AND ET today is under 1 | open | +0.76% (n=179739) | +0.21 pp | +0.23% (n=85272) | +0.72% (n=237469) | +0.38% (n=203697) | 23% | 41% | **KILL** | no_edge_vs_uncond,month_split,ticker_ghost |
| H 5 days ago is under 1 AND J today is under 1 | open | +0.82% (n=195152) | +0.27 pp | +0.19% (n=92855) | +0.78% (n=258093) | +0.35% (n=222200) | 27% | 45% | **KILL** | no_edge_vs_uncond,month_split,ticker_ghost |
| H 4 days ago is under 1 AND J today is under 1 | open | +0.81% (n=196614) | +0.27 pp | +0.17% (n=96426) | +0.78% (n=258130) | +0.34% (n=225760) | 27% | 45% | **KILL** | no_edge_vs_uncond,month_split,ticker_ghost |
| H 5 days ago is under 1 AND ET today is under 1 | open | +0.75% (n=179739) | +0.21 pp | +0.23% (n=85272) | +0.72% (n=237468) | +0.38% (n=203696) | 23% | 41% | **KILL** | no_edge_vs_uncond,month_split,ticker_ghost |
| H 2 days ago is under 1 AND ET today is under 1 | open | +0.75% (n=179745) | +0.21 pp | +0.23% (n=85272) | +0.72% (n=237479) | +0.38% (n=203705) | 23% | 41% | **KILL** | no_edge_vs_uncond,month_split,ticker_ghost |
| H 3 days ago is under 1 AND ET today is under 1 | open | +0.75% (n=179744) | +0.21 pp | +0.23% (n=85272) | +0.72% (n=237470) | +0.38% (n=203706) | 23% | 41% | **KILL** | no_edge_vs_uncond,month_split,ticker_ghost |
| H 4 days ago is under 1 AND Q today is above 0 | open | +0.88% (n=179686) | +0.34 pp | +0.09% (n=85610) | +0.82% (n=232442) | +0.42% (n=210333) | 27% | 45% | **KILL** | no_edge_vs_uncond,month_split,ticker_ghost |

Code names (after the English): `AA_l5_lt1__and__C_l0_lt1`, `AA_l3_eq1__and__IY_l0_eq1`, `AA_l3_eq1__and__IY_l0_ge1`, `AA_l3_eq1__and__IY_l0_gt0`, `AA_l3_ge1__and__IY_l0_eq1`, `AA_l3_ge1__and__IY_l0_ge1`, `AA_l3_ge1__and__IY_l0_gt0`, `AA_l5_lt1__and__DE_l0_ge1` ….
