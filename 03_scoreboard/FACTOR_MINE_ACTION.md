...
|---|---|---|---|---:|---:|---:|---:|---:|---|---|
| `combo_jse_333_shared` | leftover | list | none | +26.79 | — | 8/26 | 270 | 289 | PASS | [combo_jse_333_shared.md](factor_mine/combo_jse_333_shared.md) |
| `combo_ej_5050_shared` | leftover | list | none | +25.70 | — | 6/26 | 234 | 230 | PASS | [combo_ej_5050_shared.md](factor_mine/combo_ej_5050_shared.md) |
| `combo_es_9010_shared` | leftover | list | none | +27.65 | — | 20/26 | 188 | 258 | PASS | [combo_es_9010_shared.md](factor_mine/combo_es_9010_shared.md) |
| `combo_se_3070_shared` | leftover | list | none | +27.34 | — | 20/26 | 194 | 261 | PASS | [combo_se_3070_shared.md](factor_mine/combo_se_3070_shared.md) |
| `union_e_fresh_h3` | leftover | list | none | +26.85 | -7.87 | 20/26 | 104 | 168 | PASS | [union_e_fresh_h3.md](factor_mine/union_e_fresh_h3.md) |
| `combo_sh_3070_shared` | leftover | list | none | +36.12 | — | 21/26 | 180 | 125 | PASS | [combo_sh_3070_shared.md](factor_mine/combo_sh_3070_shared.md) |
| `combo_ps_7030_shared` | leftover | list | none | +28.82 | — | 21/26 | 138 | 111 | PASS | [combo_ps_7030_shared.md](factor_mine/combo_ps_7030_shared.md) |
| `union_news_pack_net2_h1` | leftover | list | none | +28.55 | +22.32 | 21/26 | 56 | 19 | PASS | [union_news_pack_net2_h1.md](factor_mine/union_news_pack_net2_h1.md) |
| `combo_es_8020_shared` | leftover | list | none | +28.11 | — | 20/26 | 194 | 261 | PASS | [combo_es_8020_shared.md](factor_mine/combo_es_8020_shared.md) |
| `union_hot_n4_h1` | leftover | list | none | +27.68 | +45.62 | 21/26 | 108 | 38 | PASS | [union_hot_n4_h1.md](factor_mine/union_hot_n4_h1.md) |
| `combo_p2s_5050_shared` | leftover | list | none | +27.40 | — | 21/26 | 132 | 110 | PASS | [combo_p2s_5050_shared.md](factor_mine/combo_p2s_5050_shared.md) |
| `combo_ee1_3070_shared` | leftover | list | none | +26.85 | — | 20/26 | 104 | 215 | PASS | [combo_ee1_3070_shared.md](factor_mine/combo_ee1_3070_shared.md) |
| `combo_ee1_5050_shared` | leftover | list | none | +26.85 | — | 20/26 | 104 | 215 | PASS | [combo_ee1_5050_shared.md](factor_mine/combo_ee1_5050_shared.md) |
| `combo_ee1_7030_shared` | leftover | list | none | +26.85 | — | 20/26 | 104 | 215 | PASS | [combo_ee1_7030_shared.md](factor_mine/combo_ee1_7030_shared.md) |
| `combo_ps_5050_shared` | leftover | list | none | +26.55 | — | 21/26 | 136 | 112 | PASS | [combo_ps_5050_shared.md](factor_mine/combo_ps_5050_shared.md) |
| `union_news_pack_h1` | leftover | list | none | +24.09 | +21.62 | 21/26 | 62 | 20 | PASS | [union_news_pack_h1.md](factor_mine/union_news_pack_h1.md) |
| `combo_eh_3070_shared` | leftover | list | none | +22.47 | — | 20/26 | 242 | 223 | PASS | [combo_eh_3070_shared.md](factor_mine/combo_eh_3070_shared.md) |
| `combo_eh_5050_shared` | leftover | list | none | +22.18 | — | 20/26 | 242 | 223 | PASS | [combo_eh_5050_shared.md](factor_mine/combo_eh_5050_shared.md) |
| `combo_sh_5050_shared` | leftover | list | none | +36.73 | — | 17/26 | 180 | 125 | PASS | [combo_sh_5050_shared.md](factor_mine/combo_sh_5050_shared.md) |
| `combo_seh_451540_shared` | leftover | list | none | +29.59 | — | 17/26 | 294 | 295 | PASS | [combo_seh_451540_shared.md](factor_mine/combo_seh_451540_shared.md) |
| `combo_sh_7030_shared` | leftover | list | none | +28.51 | — | 16/26 | 180 | 125 | PASS | [combo_sh_7030_shared.md](factor_mine/combo_sh_7030_shared.md) |
| `combo_se_5050_skip` | leftover | list | none | +28.21 | — | 16/26 | 168 | 255 | PASS | [combo_se_5050_skip.md](factor_mine/combo_se_5050_skip.md) |
| `combo_se1_5050_shared` | leftover | list | none | +24.70 | — | 16/26 | 208 | 129 | PASS | [combo_se1_5050_shared.md](factor_mine/combo_se1_5050_shared.md) |
| `combo_ers_7030_shared` | leftover | list | none | +24.34 | — | 15/26 | 198 | 268 | PASS | [combo_ers_7030_shared.md](factor_mine/combo_ers_7030_shared.md) |
| `combo_ser_5050_shared` | leftover | list | none | +23.75 | — | 16/26 | 178 | 248 | PASS | [combo_ser_5050_shared.md](factor_mine/combo_ser_5050_shared.md) |
| `combo_jer_5050_shared` | leftover | list | none | +23.75 | — | 6/26 | 238 | 235 | PASS | [combo_jer_5050_shared.md](factor_mine/combo_jer_5050_shared.md) |
| `combo_e1s_7030_shared` | leftover | list | none | +21.28 | — | 16/26 | 208 | 129 | PASS | [combo_e1s_7030_shared.md](factor_mine/combo_e1s_7030_shared.md) |
| `combo_sj_5050_shared` | leftover | list | none | +17.47 | — | 12/26 | 210 | 130 | PASS | [combo_sj_5050_shared.md](factor_mine/combo_sj_5050_shared.md) |
| `combo_sj_3070_shared` | leftover | list | none | +16.83 | — | 10/26 | 210 | 130 | PASS | [combo_sj_3070_shared.md](factor_mine/combo_sj_3070_shared.md) |
| `combo_sj_7030_shared` | leftover | list | none | +13.02 | — | 12/26 | 210 | 130 | PASS | [combo_sj_7030_shared.md](factor_mine/combo_sj_7030_shared.md) |
| `combo_sn_5050_shared` | leftover | list | none | +12.85 | — | 16/26 | 214 | 156 | PASS | [combo_sn_5050_shared.md](factor_mine/combo_sn_5050_shared.md) |
...
| `union_news_g_h5` | leftover | list | none | -10.92 | +110.47 | 0/26 | 98 | 264 | PASS | [union_news_g_h5.md](factor_mine/union_news_g_h5.md) |
| `union_white_coil_h1` | leftover | list | none | -8.54 | -6.88 | 0/26 | 141 | 0 | PASS | [union_white_coil_h1.md](factor_mine/union_white_coil_h1.md) |
| `union_news_or_h1` | leftover | list | none | +2.48 | +20.26 | 14/26 | 138 | 65 | PASS | [union_news_or_h1.md](factor_mine/union_news_or_h1.md) |
| `union_news_or_net4_h1` | leftover | list | none | -8.06 | -1.79 | 0/26 | 98 | 23 | PASS | [union_news_or_net4_h1.md](factor_mine/union_news_or_net4_h1.md) |
| `union_news_or_net4_conv_h1` | conviction | list | none | -3.84 | +0.19 | 0/26 | 60 | 24 | PASS | [union_news_or_net4_conv_h1.md](factor_mine/union_news_or_net4_conv_h1.md) |
| `short_news_head_h3` | leftover | list | none | +10.94 | +18.37 | 16/26 | 54 | 69 | PASS | [short_news_head_h3.md](factor_mine/short_news_head_h3.md) |
...
| `union_news_g_cam71_h1` | leftover | list | none | -10.46 | -4.11 | 0/26 | 50 | 2 | PASS | [union_news_g_cam71_h1.md](factor_mine/union_news_g_cam71_h1.md) |
| `union_news_g_conv_h1` | conviction | list | none | +1.09 | +14.81 | 2/26 | 76 | 42 | PASS | [union_news_g_conv_h1.md](factor_mine/union_news_g_conv_h1.md) |
| `union_e_green_h3` | leftover | list | none | -0.88 | -13.35 | 11/26 | 66 | 98 | PASS | [union_e_green_h3.md](factor_mine/union_e_green_h3.md) |
| `flatten_h5` | leftover | list | none | +3.38 | -1.38 | 1/26 | 110 | 288 | PASS | [flatten_h5.md](factor_mine/flatten_h5.md) |
| `flatten_h5_rankw` | rank_w | list | none | +0.10 | -1.38 | 1/26 | 104 | 278 | PASS | [flatten_h5_rankw.md](factor_mine/flatten_h5_rankw.md) |
| `flatten_h5_time` | leftover | time | none | +3.38 | -1.38 | 1/26 | 110 | 288 | PASS | [flatten_h5_time.md](factor_mine/flatten_h5_time.md) |
| `flatten_h5_sboost` | leftover | list | both | +0.96 | -1.38 | 1/26 | 113 | 294 | PASS | [flatten_h5_sboost.md](factor_mine/flatten_h5_sboost.md) |
| `union_h5_sboost` | leftover | list | both | -1.77 | +14.55 | 0/26 | 152 | 390 | PASS | [union_h5_sboost.md](factor_mine/union_h5_sboost.md) |
...
| `union_h3_cut` | leftover | cut_loser | none | -3.33 | +6.09 | 0/26 | 138 | 245 | PASS | [union_h3_cut.md](factor_mine/union_h3_cut.md) |
| `union_h1_topheavy` | topheavy | list | none | +1.95 | +7.77 | 3/26 | 188 | 88 | PASS | [union_h1_topheavy.md](factor_mine/union_h1_topheavy.md) |
