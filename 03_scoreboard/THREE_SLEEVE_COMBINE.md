...
_Generated 2026-09-10T02:08:46-04:00 — window 2026-08-13 → 2026-09-09_
...
**Today (2026-09-09):** score -13.95 → **cash** — predict -13.95 < -3.0 — hard-red: no new 1d risk; hold existing .io size sleeves

## What each sleeve is actually good at

### Excel — vast swaths, not a book

Scans **3,603** grids (Yahoo OHLCV cluster colors, zero tokens). Live ledger: **2043** suggestions, win 34.6% vs entry open. That win rate is the tell: the engine is a *searchlight*, not a portfolio.

| strategy | n | mean vs open | win |
|---|---:|---:|---:|
| `L1_long_green_tp8_lowvol` | 594 | -1.9% | 33.0% |
| `L2_long_green_tp3_lowvol` | 594 | -1.9% | 33.0% |
| `L3_long_green_hold2_midcap` | 713 | -1.4% | 39.4% |
| `L5_long_green_hold2_midhibeta` | 102 | -4.9% | 32.4% |
...
Use Excel to *see* names the other two never look at, and as a same-day confirm. Same-day Excel ∩ 1d book: **2** of 18 book days. All-three tickers in the window: `none`.

### Mover paper — highest hit-rate, losses almost deleted

| Start | Final | Return | Max DD | Trades | Win |
|---:|---:|---:|---:|---:|---:|
| $100,000 | $112,747.77 | **+12.7%** | -6.8% | 60 | **51.7%** |

Gross won $25,824 vs lost $15,476. The day gate (S ≥ +1.0) is the whole product: it closed **10** sessions and blocked **3** days whose ungated top-10 BUY basket was negative.
...
| 2026-09-03 | -0.9 | **CLOSED** | -1.4% |
| 2026-09-04 | 2.25 | OPEN | -0.9% |
| 2026-09-07 | — | OPEN | -0.2% |
| 2026-09-08 | -11.475 | **CLOSED** | — |
| 2026-09-09 | -13.95 | **CLOSED** | — |
...
|---|---:|---:|---:|---:|
| all .io sessions | 17 | +0.6% | +0.7% | 58.8% |
| SPY down days | 9 | -0.1% | +0.4% | 66.7% |
| SPY up days | 7 | +1.6% | +1.2% | 57.1% |
| S ≥ +1 (mover's days) | 5 | +1.0% | +1.3% | 80.0% |
| -3.0 ≤ S < +1 | 1 | +2.0% | +0.9% | 100.0% |
| S < -3.0 (hard red) | 7 | +0.9% | +1.2% | 71.4% |
| 1d_size on SPY down | 9 | -0.2% | +0.3% | 33.3% |
| 1d_top on SPY down | 9 | -0.1% | +0.4% | 55.6% |
...
| 2026-08-17 | 2.25 | mover | -0.5% | +0.8% | -0.1% | +0.5% |
...
| 2026-09-04 | 2.25 | mover | -0.4% | +0.7% | -0.8% | -0.9% |
| 2026-09-06 | — | io | +0.0% | -0.0% | -0.3% | -0.4% |
| 2026-09-07 | — | io | +0.0% | -0.0% | -0.2% | -0.3% |
| 2026-09-08 | -11.475 | cash | -0.5% | -3.0% | -1.2% | +0.5% |
| 2026-09-09 | -13.95 | cash | — | -0.0% | -0.0% | -0.0% |
...
| Book | Return | Max DD |
|---|---:|---:|
| Mover alone | +12.7% | -6.8% |
| .io 2w_size alone | +10.6% | -3.8% |
| Router flatten (S < −3 → cash) | +3.0% | -4.5% |
| **Hold-through** (S ≥ +1 mover, else .io; no flatten) | **+9.8%** | -6.2% |
| Split 40/40/20 | +9.4% | -3.6% |
...
6. **Intersection is a bonus, not a requirement.** Mover ∩ book tickers this window: `ACMR`, `ASND`, `ATRC`, `CRM`, `ERO`, `HOOD`, `MRX`, `MU`, `NVAX`, `XP`. Waiting for all three to agree starves the book.
