...
_Generated 2026-09-11T11:35:39 — 2026-08-13 → 2026-09-11_
...
|---:|---:|---:|---:|---:|---:|---|---|
| $100,000 | $108,616.66 | **+8.62%** | 7.12% | 72 | 45.8% | trails +10.27% | **FAIL** |
...
| fortnight | 2026-09-10 | 2026-09-11 | 2 | +0.00% | partial |
...
| `flatten_hard_red` | previous 2w_size | +10.76% | $110,760.55 | 7.88% | -5.53 |
...
| 2026-09-10 | -13.28 | hold $108,617 | hold $110,826 | io $113,796 |
| 2026-09-11 | +0.50 | io $108,617 | io $110,761 | io $113,796 |

## If you started any day

Fresh $100,000 each session, policy `flatten_robust`, through 2026-09-11. Mean **-1.35%** across 21 starts (6 finished above start). Starts with ≥5 sessions left: mean **-1.67%** (n=17, min -8.91). Held stock ties up cash. Weekend dates have no tape.

| Start | First route | Would-buy if you are full of cash | Return | Sessions | Made money |
|---|---|---|---:|---:|---|
| 2026-08-13 | io | BTSG, IREN, TPG, TGTX, SLS, HIMS, INO, TNDM, VOR | +8.62% | 21 | YES |
| 2026-08-14 | io | TLN, VST, NRG, DAVE, SLG, MARA, LDI, BTBT, BETR, ANGX, WWW | +2.93% | 20 | YES |
| 2026-08-17 | io | DVN, EOG, FANG, TMC, TGB, ELF, DNN, HNST, NB, CDNL, ABX | +5.88% | 19 | YES |
| 2026-08-18 | hold | OXY, APA, COP, MUR, MLYS, TRMD, OBE, CYPH, TBPH, JLHL, CBRS | +4.87% | 18 | YES |
| 2026-08-19 | hold | OBE, STE, DHR, SYK, MUR, TRMD, MLYS, TBPH, INMD, GUTS, DUOL | +4.87% | 17 | YES |
| 2026-08-20 | mover | AG, BHP, CDE, HDSN, IAG, KGC, NFGC, WPM, ABUS, AEM, MRVI, DNA | +4.87% | 16 | YES |
| 2026-08-21 | mover | AU, AUPH, AEM, ARCT, AUTL, CRDL, CRSP, CYPH, FUTU, GMAB, BTBT, ENHA | -0.07% | 15 | no |
| 2026-08-24 | hold | RZLT, MOS, OCUL, INSP, CRMD, HCA, CRML, SAFX | -3.48% | 14 | no |
| 2026-08-25 | io | MOS, OCUL, INSP, CRMD, RZLT, HCA, CAPR, SAFX | -3.48% | 13 | no |
| 2026-08-26 | io | OCUL, CRMD, RZLT, MOS, INSP, HCA, AVBP, FLNC | -8.91% | 12 | no |
| 2026-08-27 | io | RRC, CRK, MOS, SLI | -5.51% | 11 | no |
| 2026-08-28 | io | RRC, CRK, MOS, SLI, SEDG, GRRR | -4.27% | 10 | no |
| 2026-08-31 | hold | RES, PBF, NOV, WTTR, USDE, ACDC | -7.11% | 9 | no |
| 2026-09-01 | hold | DK, BTE, MTDR, RES, KOS, OIS, FTI, KMI, OKE, TRGP, AME | -7.11% | 8 | no |
| 2026-09-02 | hold | PCRX, HRMY, PBH, VSTM, MGTX, PBR-A, PBR, PRQR, FATE | -7.11% | 7 | no |
| 2026-09-03 | io | ATRC, HRMY, CABA, VSTM, RVTY, CRK, MRNA | -7.11% | 6 | no |
| 2026-09-04 | mover | CABA, ALEC, BHC, BMEA, OABI, OPK, VIR, ATRC, CRM, HRMY, HQ, EOSE | -6.31% | 5 | no |
| 2026-09-08 | hold | GGB, SID, SUZ, TX, CAN, ABTC | +0.00% | 4 | no |
| 2026-09-09 | hold | PCG, AR, CIG, UGP, VET, GRNT, VENU, CABA | +0.00% | 3 | no |
| 2026-09-10 | hold | UGP, LBRT, CLB, OIS, ODD, SIG | +0.00% | 2 | no |
| 2026-09-11 | io | AUPH, OVID, SANM, ORCL, NVT, COHU, CMRC, DBI | +0.00% | 1 | no |
...
| `flatten_3d` | +6.38% | 4.82% | -0.74 | -0.74 | no |
...
| `hard_red_shorts` | +1.87% | 6.26% | -2.7 | -2.7 | no |
...
| `concentrated_switch` | +3.60% | 5.80% | -4.18 | -4.18 | no |
| `io_3d_switch` | +4.00% | 5.86% | -4.3 | -4.3 | no |
...
| `flatten_hard_red` | +10.76% | 7.88% | -5.53 | -5.53 | no |
...
- **.io `2w_size`** is the current top published book (+10.27%) and the one that keeps winning on SPY-down / hard-red mornings (08-14 +3.2%, 08-18/19 +2.0/+4.1%). An earlier NAV stitch that flattened on every green morning *including* 08-13/14 (zero BUY calls) sat in cash and gave the edge back.
