...
_Generated 2026-09-16T13:38:29 — 2026-08-13 → 2026-09-16_
...
|---:|---:|---:|---:|---:|---:|---|---|
| $100,000 | $102,600.45 | **+2.60%** | 12.62% | 78 | 42.3% | trails +9.49% | **FAIL** |

Futubull fees paid **$2,827.53** (in $1,396.38 / out $1,431.15). Whole shares. A name that is already held ties up cash — later names that day only see leftover cash, so some tickets do not fill.

| Side | Trades | Win | P&L |
|---|---:|---:|---:|
| BUY | 78 | 42.3% | $2,600.48 |
| SELL | 0 | 0.0% | $0.00 |

## 15% every 2 weeks

Target **+15%** per calendar fortnight (14 days) and per 10 trading sessions.
Fortnights: **FAIL** (min -2.0). 10-session blocks: **FAIL** (min -2.0). Rolling: **FAIL** (min -12.26).

| Kind | Start | End | n | Return | Gate |
|---|---|---|---:|---:|---|
| fortnight | 2026-08-13 | 2026-08-26 | 10 | +12.24% | FAIL |
| fortnight | 2026-08-27 | 2026-09-09 | 9 | -2.00% | FAIL |
| fortnight | 2026-09-10 | 2026-09-16 | 5 | -5.54% | partial |
| block | 2026-08-13 | 2026-08-26 | 10 | +12.24% | FAIL |
| block | 2026-08-27 | 2026-09-10 | 10 | -2.00% | FAIL |
| block | 2026-09-11 | 2026-09-16 | 4 | -5.45% | partial |
...
| roll | 2026-09-02 | 2026-09-16 | 10 | -12.26% | FAIL |
...
| 2026-09-16 | +5.30 | io | $102,600.45 | $102,600.45 | 0 | 0 |
...
|---|---|---:|---:|---:|---:|
| `flatten_robust` | **LIVE** | +2.60% | $102,600.45 | 12.62% | -2.0 |
| `flatten_hard_red` | previous 2w_size | +8.18% | $108,177.95 | 10.25% | -5.53 |
| `flatten_switch_recycle` | ungated predecessor | +13.83% | $113,828.76 | 8.03% | -5.41 |
...
| 2026-09-14 | -11.00 | hold $103,441 | hold $108,296 | io $113,829 |
| 2026-09-15 | -3.84 | hold $102,180 | hold $107,906 | io $113,829 |
| 2026-09-16 | +5.30 | io $102,600 | io $108,178 | io $113,829 |

## If you started any day

Fresh $100,000 each session, policy `flatten_robust`, through 2026-09-16. Mean **-5.96%** across 24 starts (2 finished above start). Starts with ≥5 sessions left: mean **-6.88%** (n=20, min -13.96). Held stock ties up cash. Weekend dates have no tape.

| Start | First route | Would-buy if you are full of cash | Return | Sessions | Made money |
|---|---|---|---:|---:|---|
| 2026-08-13 | io | BTSG, IREN, TPG, TGTX, SLS, HIMS, INO, TNDM, VOR | +2.60% | 24 | YES |
| 2026-08-14 | io | TLN, VST, NRG, DAVE, SLG, MARA, LDI, BTBT, BETR, ANGX, WWW | -2.77% | 23 | no |
| 2026-08-17 | io | DVN, EOG, FANG, TMC, TGB, ELF, DNN, HNST, NB, CDNL, ABX | +0.03% | 22 | YES |
| 2026-08-18 | hold | OXY, APA, COP, MUR, MLYS, TRMD, OBE, CYPH, TBPH, JLHL, CBRS | -0.92% | 21 | no |
| 2026-08-19 | hold | OBE, STE, DHR, SYK, MUR, TRMD, MLYS, TBPH, INMD, GUTS, DUOL | -0.92% | 20 | no |
| 2026-08-20 | mover | AG, BHP, CDE, HDSN, IAG, KGC, NFGC, WPM, ABUS, AEM, MRVI, DNA | -0.92% | 19 | no |
| 2026-08-21 | mover | AU, AUPH, AEM, ARCT, AUTL, CRDL, CRSP, CYPH, FUTU, GMAB, BTBT, ENHA | -5.60% | 18 | no |
| 2026-08-24 | hold | RZLT, MOS, OCUL, INSP, CRMD, HCA, CRML, SAFX | -8.83% | 17 | no |
| 2026-08-25 | io | MOS, OCUL, INSP, CRMD, RZLT, HCA, CAPR, SAFX | -8.83% | 16 | no |
| 2026-08-26 | io | OCUL, CRMD, RZLT, MOS, INSP, HCA, AVBP, FLNC | -13.96% | 15 | no |
| 2026-08-27 | io | RRC, CRK, MOS, SLI | -10.74% | 14 | no |
| 2026-08-28 | io | RRC, CRK, MOS, SLI, SEDG, GRRR | -9.57% | 13 | no |
| 2026-08-31 | hold | RES, PBF, NOV, WTTR, USDE, ACDC | -12.25% | 12 | no |
| 2026-09-01 | hold | DK, BTE, MTDR, RES, KOS, OIS, FTI, KMI, OKE, TRGP, AME | -12.25% | 11 | no |
| 2026-09-02 | hold | PCRX, HRMY, PBH, VSTM, MGTX, PBR-A, PBR, PRQR, FATE | -12.25% | 10 | no |
| 2026-09-03 | io | ATRC, HRMY, CABA, VSTM, RVTY, CRK, MRNA | -12.25% | 9 | no |
| 2026-09-04 | mover | CABA, ALEC, BHC, BMEA, OABI, OPK, VIR, ATRC, CRM, HRMY, HQ, EOSE | -11.50% | 8 | no |
| 2026-09-08 | hold | GGB, SID, SUZ, TX, CAN, ABTC | -5.53% | 7 | no |
| 2026-09-09 | hold | PCG, AR, CIG, UGP, VET, GRNT, VENU, CABA | -5.53% | 6 | no |
| 2026-09-10 | hold | UGP, LBRT, CLB, OIS, BAND, DDOG | -5.53% | 5 | no |
| 2026-09-11 | io | AUPH, OVID, SANM, ORCL, NVT, COHU, AMTX, CLOV | -5.53% | 4 | no |
| 2026-09-14 | hold | CVE, DK, BG, NVT, ACVA, ATEC | +0.00% | 3 | no |
| 2026-09-15 | hold | ICLR, SMMT, WAY, ATRC, HLP, RPD | +0.00% | 2 | no |
| 2026-09-16 | io | IQV, RDNT, AVAH, BLFS, HQ, HLP | +0.00% | 1 | no |
...
| `flatten_3d` | +6.40% | 4.82% | -1.2 | -0.94 | no |
| `flatten_switch_60` | +9.19% | 5.53% | -1.93 | -1.58 | no |
| `flatten_overlap_55` | +9.53% | 5.55% | -1.96 | -1.61 | no |
| `flatten_robust` | +2.60% | 12.62% | -2.0 | -2.0 | no |
| `flatten_robust_ripper` | +2.60% | 12.62% | -2.0 | -2.0 | no |
...
| `flatten_rotate` | +15.07% | 7.34% | -3.82 | -3.47 | no |
| `flatten_switch_full` | +11.14% | 7.34% | -3.82 | -3.47 | no |
...
| `flatten_switch_recycle` | +13.83% | 8.03% | -5.41 | -5.07 | no |
| `flatten_hard_red` | +8.18% | 10.25% | -5.53 | -5.53 | no |
| `switch_80_overlap` | +0.50% | 7.49% | -5.94 | -6.46 | no |
| `flatten_blank_cash` | +9.38% | 7.08% | -6.5 | -6.16 | no |
...
- **.io `2w_size`** is the current top published book (+9.49%) and the one that keeps winning on SPY-down / hard-red mornings (08-14 +3.2%, 08-18/19 +2.0/+4.1%). An earlier NAV stitch that flattened on every green morning *including* 08-13/14 (zero BUY calls) sat in cash and gave the edge back.
