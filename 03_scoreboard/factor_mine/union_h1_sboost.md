...
Cash book **+6.24%** ($10,624) · signal-only (no cash/fees) was +6.97%. Starts YES **11/21**. Fills 168 · skips 72 · realized $+516.14.
...
**PASS** · 0 violations. Independent replay of fills never sold an unheld lot and never spent past leftover cash. Close cash $307.99.
...
| 2026-09-11 | +0.50 | $10,516.17 | — | $10,516.17 | -0.00 | +132.30 | AUPH, OVID, SANM, ORCL, NVT, COHU, CMRC, DBI | — | $307.99 | $10,623.68 | AUPH×80, OVID×481, SANM×6, ORCL×7, NVT×8, COHU×23, CMRC×419, DBI×222 |
...
| 2026-09-11 09:30 ET | **BUY** | `SANM` | 6 | $206.84 | $2.01 | — | $6,649.16 | — | S≥+5: sizeup + more names; list flatten; ret5=+4.4; leftover $1314.52 | join🟢 sector🟢 gen🟡 news🟡 digest🟡 judge🟢 ab🟢 peer🟢 heat🟢 vol🔴 buy🟡 |
| 2026-09-11 09:30 ET | **BUY** | `ORCL` | 7 | $164.43 | $2.01 | — | $5,496.13 | — | S≥+5: sizeup + more names; list flatten,earn_react; 🔵; ⚪; ret5=+9.0; leftover $1314.52 | join🟢 sector🟢 gen🟡 news🟢 digest🟢 judge🟢 ab🟢 peer🟢 heat🟢 vol🟢 buy🟡 |
| 2026-09-11 09:30 ET | **BUY** | `NVT` | 8 | $157.78 | $2.01 | — | $4,231.88 | — | S≥+5: sizeup + more names; list flatten; 🔵; ret5=+7.8; leftover $1314.52 | join🟢 sector🔴 gen🟡 news🟡 digest🟢 judge🟡 ab🟢 peer🟢 heat🟢 vol🟡 buy🟡 |
| 2026-09-11 09:30 ET | **BUY** | `COHU` | 23 | $56.09 | $2.06 | — | $2,939.75 | — | S≥+5: sizeup + more names; list flatten; 🔵; ⚪; ret5=+15.3; leftover $1314.52 | join🟢 sector🟢 gen🟡 news🟡 digest🟡 judge🟢 ab🟢 peer🟢 heat🟢 vol🟡 buy🟡 |
| 2026-09-11 09:30 ET | **BUY** | `CMRC` | 419 | $3.13 | $5.41 | — | $1,622.88 | — | S≥+5: sizeup + more names; list probable,yday_gainer,yday_mover; ret5=+6.2; leftover $1314.52 | join🔴 sector🟢 gen🟡 news🟡 digest🟡 judge🟢 ab🟢 peer🟢 heat🔴 vol🟢 buy🟡 |
| 2026-09-11 09:30 ET | **BUY** | `DBI` | 222 | $5.91 | $2.86 | — | $307.99 | — | S≥+5: sizeup + more names; list probable,yday_gainer,yday_mover; ret5=-4.9; leftover $1314.52 | join🔴 sector🔴 gen🟡 news🟡 digest🟢 ab🔴 peer🟢 heat🔴 vol🟢 buy🟡 |
| 2026-09-11 16:00 ET | **CLOSE** | 16:00 close | — | — | — | — | $307.99 | ▲ close $10,623.68 vs 09:30 $10,516.17 (session +132.30) | 16:00 close · cash $307.99 · equity $10,623.68 vs 09:30 $10,516.17 (+107.51; session marks +132.30) · 8 name(s) marked open→close (per-name table). AUPH×80 09:30 $16.28 → close $16.10 -14.40; OVID×481 09:30 $2.73 → close $2.69 -19.24; SANM×6 09:30 $206.84 → close $216.00 +54.96; ORCL×7 09:30 $164.43 → close $150.28 -99.05; NVT×8 09:30 $157.78 → close $162.38 +36.80; COHU×23 09:30 $56.09 → close $57.08 +22.77; CMRC×419 09:30 $3.13 → close $3.50 +157.12; DBI×222 09:30 $5.91 → close $5.88 -6.66 | — |
...
|---|---:|---|---|
| `AUPH` | 80 | 2026-09-11 @ $16.28 | S≥+5: sizeup + more names; list flatten; 🔵; ret5=-1.1; leftover $1314.52 |
| `OVID` | 481 | 2026-09-11 @ $2.73 | S≥+5: sizeup + more names; list flatten; 🔵; ret5=+3.0; leftover $1314.52 |
| `SANM` | 6 | 2026-09-11 @ $206.84 | S≥+5: sizeup + more names; list flatten; ret5=+4.4; leftover $1314.52 |
| `ORCL` | 7 | 2026-09-11 @ $164.43 | S≥+5: sizeup + more names; list flatten,earn_react; 🔵; ⚪; ret5=+9.0; leftover $1314.52 |
| `NVT` | 8 | 2026-09-11 @ $157.78 | S≥+5: sizeup + more names; list flatten; 🔵; ret5=+7.8; leftover $1314.52 |
| `COHU` | 23 | 2026-09-11 @ $56.09 | S≥+5: sizeup + more names; list flatten; 🔵; ⚪; ret5=+15.3; leftover $1314.52 |
| `CMRC` | 419 | 2026-09-11 @ $3.13 | S≥+5: sizeup + more names; list probable,yday_gainer,yday_mover; ret5=+6.2; leftover $1314.52 |
| `DBI` | 222 | 2026-09-11 @ $5.91 | S≥+5: sizeup + more names; list probable,yday_gainer,yday_mover; ret5=-4.9; leftover $1314.52 |
