...
Cash book **+0.42%** ($10,043) · signal-only (no cash/fees) was +11.14%. Starts YES **1/24**. Fills 180 · skips 87 · realized $+145.83.
...
**PASS** · 0 violations. Independent replay of fills never sold an unheld lot and never spent past leftover cash. Close cash $182.59.
...
|---|---:|---|---|
| `IQV` | 9 | 2026-09-16 @ $270.89 | S≥+5: sizeup + more names; list flatten; ⚪; ret5=-0.8; leftover $2536.47 |
| `RDNT` | 32 | 2026-09-16 @ $77.12 | S≥+5: sizeup + more names; list flatten; ⚪; ret5=-5.1; leftover $2536.47 |
| `AVAH` | 177 | 2026-09-16 @ $14.31 | S≥+5: sizeup + more names; list flatten; ⚪; ret5=+3.2; leftover $2536.47 |
| `BLFS` | 69 | 2026-09-16 @ $36.46 | S≥+5: sizeup + more names; list flatten; ⚪; ret5=-4.6; leftover $2536.47 |
