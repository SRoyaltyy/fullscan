...
Cash book **-10.57%** ($8,943) · signal-only (no cash/fees) was -18.42%. Starts YES **0/27**. Fills 23 · skips 7 · realized $-1014.85.
...
**PASS** · 0 violations. Independent replay of fills never sold an unheld lot and never spent past leftover cash. Close cash $11.91.
...
| 2026-09-21 | `ARLO` | 670 | — | $13.38 | +0.00 | $13.33 | -33.50 | -33.50 | +0.00 | -33.50 |
...
| 2026-09-21 | +12.87 | $8,985.15 | — | $8,985.15 | -0.00 | -33.50 | ARLO | — | $11.91 | $8,943.01 | ARLO×670 |
...
| 2026-09-21 09:30 ET | **BUY** | `ARLO` | 670 | $13.38 | $8.64 | — | $11.91 | — | Clock-B #8 flow-in + green + not extended; gate clk_flow_coil=True; rank cond; list ohlc_hot; ret5=+7.3; leftover $8985.15 | join🟢 sector🔴 gen🟢 news🟡 digest🟢 ab🟢 peer🔴 heat🔴 vol🟢 buy🟡 |
| 2026-09-21 16:00 ET | **CLOSE** | 16:00 close | — | — | — | — | $11.91 | ▼ close $8,943.01 vs 09:30 $8,985.15 (session -33.50) | 16:00 close · cash $11.91 · equity $8,943.01 vs 09:30 $8,985.15 (-42.14; session marks -33.50) · 1 name(s) marked open→close (per-name table). ARLO×670 09:30 $13.38 → close $13.33 -33.50 | — |
...
|---|---:|---|---|
| `ARLO` | 670 | 2026-09-21 @ $13.38 | Clock-B #8 flow-in + green + not extended; gate clk_flow_coil=True; rank cond; list ohlc_hot; ret5=+7.3; leftover $8985.15 |
