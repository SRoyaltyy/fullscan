...
Cash book **-8.34%** ($9,166) · signal-only (no cash/fees) was -1.75%. Starts YES **1/20**. Fills 132 · skips 64 · realized $-834.25.
...
**PASS** · 0 violations. Independent replay of fills never sold an unheld lot and never spent past leftover cash. Close cash $9,165.72.
