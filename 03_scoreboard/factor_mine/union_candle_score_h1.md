...
Cash book **-0.60%** ($9,940) · signal-only (no cash/fees) was -6.50%. Starts YES **1/19**. Fills 162 · skips 64 · realized $-60.26.
...
**PASS** · 0 violations. Independent replay of fills never sold an unheld lot and never spent past leftover cash. Close cash $9,939.74.
