...
Cash book **-3.40%** ($9,660) · signal-only (no cash/fees) was +9.77%. Starts YES **4/19**. Fills 128 · skips 24 · realized $-340.30.
...
**PASS** · 0 violations. Independent replay of fills never sold an unheld lot and never spent past leftover cash. Close cash $9,659.72.
