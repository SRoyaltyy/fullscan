...
Cash book **+8.26%** ($10,826) · signal-only (no cash/fees) was +1.67%. Starts YES **10/21**. Fills 143 · skips 7 · realized $+826.86.
...
**PASS** · 0 violations. Independent replay of fills never sold an unheld lot and never spent past leftover cash. Close cash $9,479.84.
...
| 2026-09-11 | +0.50 | $10,826.85 | — | $10,826.85 | +0.00 | +1.33 | PAGS | — | $9,479.84 | $10,825.80 | PAGS×133 |
...
| 2026-09-11 09:30 ET | **BUY** | `PAGS` | 133 | $10.11 | $2.39 | — | $9,479.84 | — | union ∩ white, no 🚨; gate zero_red=True; list yday_gainer; ⚪; ret5=+5.1; leftover $1353.36 | join🟢 sector🟢 gen🟡 news🟡 digest🟡 judge🟢 ab🟢 peer🟢 heat🟢 vol🟡 buy🟡 |
| 2026-09-11 16:00 ET | **CLOSE** | 16:00 close | — | — | — | — | $9,479.84 | ▲ close $10,825.80 vs 09:30 $10,826.85 (session +1.33) | 16:00 close · cash $9,479.84 · equity $10,825.80 vs 09:30 $10,826.85 (-1.05; session marks +1.33) · 1 name(s) marked open→close (per-name table). PAGS×133 09:30 $10.11 → close $10.12 +1.33 | — |
...
|---|---:|---|---|
| `PAGS` | 133 | 2026-09-11 @ $10.11 | union ∩ white, no 🚨; gate zero_red=True; list yday_gainer; ⚪; ret5=+5.1; leftover $1353.36 |
