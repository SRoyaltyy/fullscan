...
Cash book **-2.20%** ($9,780) · signal-only (no cash/fees) was +0.71%. Starts YES **3/19**. Fills 144 · skips 64 · realized $-220.15.
...
**PASS** · 0 violations. Independent replay of fills never sold an unheld lot and never spent past leftover cash. Close cash $9,779.85.
