...
Cash book **-1.88%** ($9,812) · signal-only (no cash/fees) was +8.03%. Starts YES **15/23**. Fills 159 · skips 86 · realized $-589.86.
...
**PASS** · 0 violations. Independent replay of fills never sold an unheld lot and never spent past leftover cash. Close cash $8,232.72.
