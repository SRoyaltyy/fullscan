...
Side **mix** · universe `combo` · top 8 · rank `list` · size `combo` · sell `owner_list` · S-boost `none` · shared union_e_fresh_h3/union_e_fresh_h1 w=0.7,0.3 net=priority
...
- Members: union_e_fresh_h3 70%, union_e_fresh_h1 30%.
