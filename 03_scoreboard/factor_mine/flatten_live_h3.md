...
Cash book **-6.24%** ($9,376) · signal-only (no cash/fees) was +6.87%. Starts YES **0/26**. Fills 42 · skips 45 · realized $-623.92.
...
| 2026-08-26 09:30 ET | **SELL** | `ARCT` | 2 | $15.35 | $0.33 | $+7.88 | $10,290.63 | ▲ +7.88 after sell → book $10,363.88; vs 09:30 mark -0.34 | dropped from list after 3 sess (min 3) | join🔴 sector🟡 gen🟢 news🟡 digest🟢 judge🔴 ab🟢 peer🟢 heat🟢 vol🔴 buy🟡 |
