...
Cash book **-9.76%** ($9,024) · signal-only (no cash/fees) was -11.55%. Starts YES **0/20**. Fills 160 · skips 73 · realized $-976.25.
...
**PASS** · 0 violations. Independent replay of fills never sold an unheld lot and never spent past leftover cash. Close cash $9,023.81.
