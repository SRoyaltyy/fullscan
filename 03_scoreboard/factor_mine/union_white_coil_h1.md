...
Cash book **-7.44%** ($9,256) · signal-only (no cash/fees) was -4.44%. Starts YES **0/26**. Fills 130 · skips 0 · realized $-614.16.
...
**PASS** · 0 violations. Independent replay of fills never sold an unheld lot and never spent past leftover cash. Close cash $12.04.
...
| 2026-09-18 | `RXT` | 595 | — | $3.94 | +0.00 | $3.80 | -83.30 | -83.30 | +0.00 | -83.30 |
| 2026-09-18 | `RARE` | 158 | — | $14.79 | +0.00 | $14.51 | -44.24 | -44.24 | +0.00 | -44.24 |
| 2026-09-18 | `TH` | 112 | — | $20.91 | +0.00 | $21.19 | +31.36 | +31.36 | +0.00 | +31.36 |
| 2026-09-18 | `SFL` | 170 | — | $13.74 | +0.00 | $13.63 | -18.70 | -18.70 | +0.00 | -18.70 |
...
| 2026-09-18 | +4.86 | $9,385.85 | — | $9,385.85 | -0.00 | -114.88 | RXT, RARE, TH, SFL | — | $12.04 | $9,256.00 | RXT×595, RARE×158, TH×112, SFL×170 |
...
| 2026-09-18 09:30 ET | **BUY** | `RXT` | 595 | $3.94 | $7.68 | — | $7,033.87 | — | combo gate; gate zero_red=True,ret_5_max=10.0,rvol_max=2.2; list yday_gainer; 🔵; ⚪; ret5=+3.2; leftover $2346.46 | join🟢 sector🟢 gen🟢 news🟡 digest🟢 judge🟢 ab🟢 peer🟢 heat🟢 vol🟡 buy🟡 |
| 2026-09-18 09:30 ET | **BUY** | `RARE` | 158 | $14.79 | $2.46 | — | $4,694.59 | — | combo gate; gate zero_red=True,ret_5_max=10.0,rvol_max=2.2; list yday_gainer; 🔵; ⚪; ret5=-3.7; leftover $2346.46 | join🟢 sector🟢 gen🟢 news🟢 digest🟡 ab🟢 peer🟢 heat🟢 vol🟢 buy🟡 |
| 2026-09-18 09:30 ET | **BUY** | `TH` | 112 | $20.91 | $2.33 | — | $2,350.34 | — | combo gate; gate zero_red=True,ret_5_max=10.0,rvol_max=2.2; list ohlc_hot; 🔵; ⚪; ret5=+8.6; leftover $2346.46 | join🟢 sector🟢 gen🟢 news🟢 digest🟢 ab🟢 peer🟢 heat🟢 vol🟢 buy🟡 |
| 2026-09-18 09:30 ET | **BUY** | `SFL` | 170 | $13.74 | $2.50 | — | $12.04 | — | combo gate; gate zero_red=True,ret_5_max=10.0,rvol_max=2.2; list ohlc_hot; 🔵; ⚪; ret5=+8.4; leftover $2346.46 | join🟢 sector🟢 gen🟢 news🟡 digest🟢 ab🟢 peer🟢 heat🟢 vol🟡 buy🟡 |
| 2026-09-18 16:00 ET | **CLOSE** | 16:00 close | — | — | — | — | $12.04 | ▼ close $9,256.00 vs 09:30 $9,385.85 (session -114.88) | 16:00 close · cash $12.04 · equity $9,256.00 vs 09:30 $9,385.85 (-129.85; session marks -114.88) · 4 name(s) marked open→close (per-name table). RXT×595 09:30 $3.94 → close $3.80 -83.30; RARE×158 09:30 $14.79 → close $14.51 -44.24; TH×112 09:30 $20.91 → close $21.19 +31.36; SFL×170 09:30 $13.74 → close $13.63 -18.70 | — |

## Still open (marked at last close)

| Ticker | Shares | Entry | Why |
|---|---:|---|---|
| `RXT` | 595 | 2026-09-18 @ $3.94 | combo gate; gate zero_red=True,ret_5_max=10.0,rvol_max=2.2; list yday_gainer; 🔵; ⚪; ret5=+3.2; leftover $2346.46 |
| `RARE` | 158 | 2026-09-18 @ $14.79 | combo gate; gate zero_red=True,ret_5_max=10.0,rvol_max=2.2; list yday_gainer; 🔵; ⚪; ret5=-3.7; leftover $2346.46 |
| `TH` | 112 | 2026-09-18 @ $20.91 | combo gate; gate zero_red=True,ret_5_max=10.0,rvol_max=2.2; list ohlc_hot; 🔵; ⚪; ret5=+8.6; leftover $2346.46 |
| `SFL` | 170 | 2026-09-18 @ $13.74 | combo gate; gate zero_red=True,ret_5_max=10.0,rvol_max=2.2; list ohlc_hot; 🔵; ⚪; ret5=+8.4; leftover $2346.46 |
