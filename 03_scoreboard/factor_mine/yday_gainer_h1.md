...
Cash book **+6.16%** ($10,616) · signal-only (no cash/fees) was +6.50%. Starts YES **7/20**. Fills 144 · skips 72 · realized $+616.11.
...
**PASS** · 0 violations. Independent replay of fills never sold an unheld lot and never spent past leftover cash. Close cash $10,616.07.
