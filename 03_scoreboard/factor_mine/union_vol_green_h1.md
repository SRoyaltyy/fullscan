...
Cash book **+7.18%** ($10,718) · signal-only (no cash/fees) was -5.49%. Starts YES **11/20**. Fills 128 · skips 47 · realized $+718.13.
...
**PASS** · 0 violations. Independent replay of fills never sold an unheld lot and never spent past leftover cash. Close cash $10,718.12.
