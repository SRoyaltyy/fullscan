...
Cash book **-1.57%** ($9,843) · signal-only (no cash/fees) was +0.31%. Starts YES **0/18**. Fills 139 · skips 52 · realized $-156.96.
...
**PASS** · 0 violations. Independent replay of fills never sold an unheld lot and never spent past leftover cash. Close cash $8,615.83.
...
|---|---:|---|---|
| `HAFN` | 137 | 2026-09-04 @ $8.94 | combo gate; gate last_green=True,ret_5_min=0.0,ret_5_max=10.0,rvol_min=0.7,rvol_max=2.2; list ohlc_hot; ret5=+7.7; leftover $1232.24 |
