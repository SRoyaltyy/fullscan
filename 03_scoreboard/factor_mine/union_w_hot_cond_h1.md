...
Cash book **-1.79%** ($9,821) · signal-only (no cash/fees) was +30.35%. Starts YES **6/21**. Fills 173 · skips 73 · realized $-154.41.
...
**PASS** · 0 violations. Independent replay of fills never sold an unheld lot and never spent past leftover cash. Close cash $3,746.03.
...
| 2026-09-11 | `CYPH` | 514 | — | $2.39 | +0.00 | $2.27 | -64.25 | -64.25 | +0.00 | -64.25 |
| 2026-09-11 | `IRD` | 199 | — | $6.16 | +0.00 | $6.04 | -23.88 | -23.88 | +0.00 | -23.88 |
...
| 2026-09-11 | +0.50 | $9,845.56 | — | $9,845.56 | +0.00 | -5.46 | INDP, CYPH, IRD, HPE, SEDG | — | $3,746.03 | $9,820.88 | INDP×455, CYPH×514, IRD×199, HPE×21, SEDG×33 |
...
| 2026-09-11 09:30 ET | **BUY** | `INDP` | 455 | $2.70 | $5.87 | — | $8,611.20 | — | rank by w_hot_cond; rank w_hot_cond; list yday_gainer,yday_mover; 🔵; ret5=+61.6; leftover $1230.70 | join🟢 sector🟡 gen🟡 news🟡 digest🔴 judge🟢 ab🟢 peer🟢 heat🔴 vol🟢 buy🟡 |
| 2026-09-11 09:30 ET | **BUY** | `CYPH` | 514 | $2.39 | $6.63 | — | $7,376.10 | — | rank by w_hot_cond; rank w_hot_cond; list yday_mover; 🔵; ret5=+44.1; leftover $1230.70 | join🟢 sector🟡 gen🟡 news🟡 digest🔴 judge🟢 ab🟢 peer🟢 heat🔴 vol🟢 buy🟡 |
| 2026-09-11 09:30 ET | **BUY** | `IRD` | 199 | $6.16 | $2.59 | — | $6,147.68 | — | rank by w_hot_cond; rank w_hot_cond; list yday_gainer; 🔵; ret5=+49.6; leftover $1230.70 | join🟢 sector🟡 gen🟡 news🟡 digest🔴 judge🟢 ab🟢 heat🔴 vol🟢 buy🟡 |
| 2026-09-11 09:30 ET | **BUY** | `HPE` | 21 | $56.37 | $2.05 | — | $4,961.85 | — | rank by w_hot_cond; rank w_hot_cond; list ohlc_hot; 🔵; ⚪; ret5=+15.8; leftover $1230.70 | join🟢 sector🟢 gen🟡 news🟢 digest🟢 judge🟢 ab🟢 peer🟢 heat🟢 vol🟡 buy🟡 |
| 2026-09-11 09:30 ET | **BUY** | `SEDG` | 33 | $36.78 | $2.09 | — | $3,746.03 | — | rank by w_hot_cond; rank w_hot_cond; list ohlc_hot; 🔵; ⚪; ret5=+13.1; leftover $1230.70 | join🟢 sector🟢 gen🟡 news🟡 digest🟡 judge🟢 ab🟢 peer🟢 heat🟢 vol🟢 buy🟡 |
| 2026-09-11 16:00 ET | **CLOSE** | 16:00 close | — | — | — | — | $3,746.03 | ▼ close $9,820.88 vs 09:30 $9,845.56 (session -5.46) | 16:00 close · cash $3,746.03 · equity $9,820.88 vs 09:30 $9,845.56 (-24.68; session marks -5.46) · 5 name(s) marked open→close (per-name table). INDP×455 09:30 $2.70 → close $2.77 +31.85; CYPH×514 09:30 $2.39 → close $2.27 -64.25; IRD×199 09:30 $6.16 → close $6.04 -23.88; HPE×21 09:30 $56.37 → close $62.09 +120.12; SEDG×33 09:30 $36.78 → close $34.68 -69.30 | — |
...
|---|---:|---|---|
| `INDP` | 455 | 2026-09-11 @ $2.70 | rank by w_hot_cond; rank w_hot_cond; list yday_gainer,yday_mover; 🔵; ret5=+61.6; leftover $1230.70 |
| `CYPH` | 514 | 2026-09-11 @ $2.39 | rank by w_hot_cond; rank w_hot_cond; list yday_mover; 🔵; ret5=+44.1; leftover $1230.70 |
| `IRD` | 199 | 2026-09-11 @ $6.16 | rank by w_hot_cond; rank w_hot_cond; list yday_gainer; 🔵; ret5=+49.6; leftover $1230.70 |
| `HPE` | 21 | 2026-09-11 @ $56.37 | rank by w_hot_cond; rank w_hot_cond; list ohlc_hot; 🔵; ⚪; ret5=+15.8; leftover $1230.70 |
| `SEDG` | 33 | 2026-09-11 @ $36.78 | rank by w_hot_cond; rank w_hot_cond; list ohlc_hot; 🔵; ⚪; ret5=+13.1; leftover $1230.70 |
