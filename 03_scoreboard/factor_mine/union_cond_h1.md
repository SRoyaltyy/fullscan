...
Cash book **-3.06%** ($9,694) · signal-only (no cash/fees) was +7.94%. Starts YES **3/20**. Fills 164 · skips 73 · realized $-305.66.
...
**PASS** · 0 violations. Independent replay of fills never sold an unheld lot and never spent past leftover cash. Close cash $9,694.37.
