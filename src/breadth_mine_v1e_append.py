"""Append-only guard for breadth_mine_v1e.

Each session is written once under research/breadth_mine_v1e/returns/.
...
RETURNS_DIR = Path("research/breadth_mine_v1e/returns")
