"""Append-only guard for breadth_rank_v1b.

Each session is written once under research/breadth_rank_v1b/returns/.
...
RETURNS_DIR = Path("research/breadth_rank_v1b/returns")
