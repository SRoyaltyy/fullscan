"""Append-only guard for breadth_mine_v1.

Each session is written once under research/breadth_mine_v1/returns/.
...
RETURNS_DIR = Path("research/breadth_mine_v1/returns")
