"""Score the fingerprinted breadth_mine_v1 grid.
...
from src.breadth_mine_v1_append import file_sha256, manifest_line
from src.breadth_mine_v1_grid import (
    ATOM_ROLES,
    ATOMS,
    CUT_LOSS,
    EXITS,
...
from src.breadth_mine_v1_metrics import (
    compound,
    ex_best_compound,
    luck_p,
    median,
...
def walk_all(days: list[dict], fees: dict) -> dict:
    from src.breadth_mine_v1_grid import rule_id
