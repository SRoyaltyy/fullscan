"""Bounded search space for breadth_mine_v1.

Fifteen atoms: one predicate from each Group 1 family in
research/lever_search/PREREG.md (price, candle, AB-price, Finviz)
and one predicate for each fullscan input named in the study.
Singles and unordered pairs, crossed with both sides and the
exit, hold, and top-N lists from that preregistration's Layer A.

N is 57,600. This module enumerates that grid and nothing else.
"""
