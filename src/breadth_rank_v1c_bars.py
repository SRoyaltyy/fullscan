"""Fresh Yahoo split-adjusted bars for breadth_rank_v1c.
...
BAR_DIR = ROOT / "research" / "breadth_rank_v1c" / "bars"
...
def session_jumps(bars: dict[str, list[dict]],
    ...
    """Flag open/previous-close and close/open when the ratio breaks 3x."""
    if splits is None:
        splits = {}
    flags = []
