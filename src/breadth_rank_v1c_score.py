"""Score breadth_rank_v1c one session at a time.
...
from src.breadth_rank_v1c_append import file_sha256, manifest_line
from src.breadth_rank_v1c_bars import load_bars
