...
def analyze_article(
    ...
    row = {
        ...
        "harvest_source": art.get("harvest_source") or art.get("source") or "",
        "url": art.get("url") or "",
        "source_file": art.get("source_file") or art.get("source") or "",
        "ticker_hint": art.get("ticker_hint") or "",
        "task_id": art.get("task_id") or "",
        "automation_slug": art.get("automation_slug") or "",
        "automation_kind": art.get("automation_kind") or "",
        "macro_only": bool(art.get("macro_only")),
