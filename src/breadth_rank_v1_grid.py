"""Forty rank rules for breadth_rank_v1.

Each rule turns a frozen basket of the breadth_mine_v1 atoms into one
continuous score. There is no filter gate. N is 40, which is at most 50.
The luck denominator adds these 40 tries to the 182,190 already counted
by breadth_mine_v1, v1b, and v1c.
"""
...
# Basket id, then the atoms that enter that rule's score, in byte order.
