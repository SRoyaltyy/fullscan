"""Append-only guard for factor_mine_seq_labelled.

Each session is written once under research/lever_search_labelled/returns/.
...
RETURNS_DIR = Path("research/lever_search_labelled/returns")
...
def check_against(rev: str) -> None:
    """Compare the working tree with the labelled return record at git rev."""
...
def main(argv: list[str] | None = None) -> None:
    parser = argparse.ArgumentParser(
        description="Fail if an earlier factor_mine_seq_labelled session changed."
    )
