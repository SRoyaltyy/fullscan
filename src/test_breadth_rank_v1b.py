"""Checks for the fingerprinted breadth_rank_v1b protocol and the book rules."""
...
from src.breadth_rank_v1b_bars import (
    SCHEMA,
...
from src.breadth_rank_v1b_score import (
    BarView,
    Book,
    advance_book,
    percentile_ranks,
...
def test_counts() -> None:
    ...
    assert LUCK_DENOMINATOR == 239870
...
def test_long_compound_outranks_a_richer_short() -> None:
    from src.breadth_rank_v1b_score import _rank_rows, freeze_payload
...
def test_loader_drops_bars_after_the_fit_cutoff(tmp_path: Path | None = None) -> None:
    folder = tmp_path or Path("/tmp/breadth_rank_v1b_bars")
