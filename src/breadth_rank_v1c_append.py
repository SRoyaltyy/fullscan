"""Append-only guard for breadth_rank_v1c.

Each session is written once under research/breadth_rank_v1c/returns/.
...
RETURNS_DIR = Path("research/breadth_rank_v1c/returns")
