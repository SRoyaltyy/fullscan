"""Append-only guard for breadth_mine_v1c.

Each session is written once under research/breadth_mine_v1c/returns/.
...
RETURNS_DIR = Path("research/breadth_mine_v1c/returns")
