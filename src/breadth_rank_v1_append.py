"""Append-only guard for breadth_rank_v1.

Each session is written once under research/breadth_rank_v1/returns/.
...
RETURNS_DIR = Path("research/breadth_rank_v1/returns")
