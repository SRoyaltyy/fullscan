"""Append-only guard for breadth_mine_v1b.

Each session is written once under research/breadth_mine_v1b/returns/.
...
RETURNS_DIR = Path("research/breadth_mine_v1b/returns")
